...
TIMESTEPS_5DAYS = ("timesteps_5days",)
...
VARIABLES = {
    ...
    "taup1": Variable(
        "Index of next time step", None, "", "Index of next time step", dtype=runtime_settings.int_type, initial=2, write_to_restart=True
    ),
    "taum1": Variable(
        "Index of last time step", None, "", "Index of last time step", dtype=runtime_settings.int_type, initial=0, write_to_restart=True
    ),
    "tau_event": Variable(
    ...
    "itt": Variable(
        "Current iteration", None, "", "Current iteration", dtype=runtime_settings.int_type, initial=0, write_to_restart=True
    ),
    "itt_substep": Variable(
        "Current iteration", None, "", "Current iteration of substep", dtype=runtime_settings.int_type, initial=0, write_to_restart=True
    ),
    "itt_day": Variable(
    ...
    "ptransp_res": Variable(
        "Residual potential transpiration (water limited)",
        CATCH_GRID,
        "mm/dt",
        "Residual potential transpiration (water limited)",
        time_dependent=True,

...
TIMESTEPS_EVENT_P1 = ("timesteps_event_p1",)
...
VARIABLES = {
    ...
    "evap_int_top": Variable(
        "actual evaporation of intercepted water from top surface layer",
        CATCH_GRID,
        "mm/dt",
        "actual evaporation of intercepted water from top surface layer",
        time_dependent=True,
    ...
    "evap_int_ground": Variable(
        "actual evaporation of intercepted water from ground surface layer",
        CATCH_GRID,
        "mm/dt",
        "actual evaporation of intercepted water from ground surface layer",
        time_dependent=True,

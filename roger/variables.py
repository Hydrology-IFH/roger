...
VARIABLES = {
    ...
    "doy_fert1": Variable(
        "Day of year of first fertilizer application",
        CATCH_GRID,
        "",
        "Day of year of first fertilizer application",
        dtype="int32",
    ...
    "doy_fert2": Variable(
        "Day of year of second fertilizer application",
        CATCH_GRID,
        "",
        "Day of year of second fertilizer application",
        dtype="int32",
    ...
    "doy_fert3": Variable(
        "Day of year of third fertilizer application",
        CATCH_GRID,
        "",
        "Day of year of third fertilizer application",
        dtype="int32",
    ...
    "N_fert1": Variable(
        "Nitrogen of first fertilizer application",
        CATCH_GRID,
        "kg N ha-1",
        "Nitrogen of first fertilizer application",
        initial=0,
    ...
    "N_fert2": Variable(
        "Nitrogen of second fertilizer application",
        CATCH_GRID,
        "kg N ha-1",
        "Nitrogen of second fertilizer application",
        initial=0,
    ...
    "N_fert3": Variable(
        "Nitrogen of third fertilizer application",
        CATCH_GRID,
        "kg N ha-1",
        "Nitrogen of third fertilizer application",
        initial=0,

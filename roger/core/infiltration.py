...
def calc_green_ampt_params(state):
    ...
    vs.pi_gr = update(
        vs.pi_gr,
        at[2:-2, 2:-2],
        pi_gr[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.pi_m = update(
        vs.pi_m,
        at[2:-2, 2:-2],
        pi_m[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.t_sat = update(
        vs.t_sat,
        at[2:-2, 2:-2],
        t_sat[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.Fs = update(
        vs.Fs,
        at[2:-2, 2:-2],
        Fs[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
...
def calc_inf_mat(state):
    ...
    a = update(
        a,
        at[2:-2, 2:-2],
        vs.ks[2:-2, 2:-2] * (vs.t_event_csum[2:-2, 2:-2] - vs.t_sat[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    b = update(
        b,
        at[2:-2, 2:-2],
        vs.Fs[2:-2, 2:-2] + 2 * vs.theta_d[2:-2, 2:-2] * vs.wfs[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    l1 = update(
        l1,
        at[2:-2, 2:-2],
        npx.where(
            vs.z0[2:-2, 2:-2, vs.tau] > vs.ks[2:-2, 2:-2] * vs.dt,
            (vs.ks[2:-2, 2:-2] * vs.dt * vs.wfs[2:-2, 2:-2] * vs.theta_d[2:-2, 2:-2])
            / (vs.z0[2:-2, 2:-2, vs.tau] - vs.ks[2:-2, 2:-2] * vs.dt),
            (vs.ks[2:-2, 2:-2] * vs.dt * vs.wfs[2:-2, 2:-2] * vs.theta_d[2:-2, 2:-2]) / (vs.ks[2:-2, 2:-2] * vs.dt),
        )
    ...
    inf_mat_pot_sat = update(
        ...
        npx.where(
            mask3[2:-2, 2:-2],
            vs.z0[2:-2, 2:-2, vs.tau] * (vs.t_sat[2:-2, 2:-2] - (vs.t_event_csum[2:-2, 2:-2] - vs.dt)),
            inf_mat_pot_sat[2:-2, 2:-2],
        )
        * vs.maskCatch[2:-2, 2:-2],
    )
    vs.inf_mat_pot = update(
    ...
    inf_mat_pot = update(
        inf_mat_pot,
        at[2:-2, 2:-2],
        vs.inf_mat_pot[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.inf_mat = update(
        vs.inf_mat,
        at[2:-2, 2:-2],
        npx.where(mask7[2:-2, 2:-2], vs.z0[2:-2, 2:-2, vs.tau], vs.inf_mat[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    vs.inf_mat = update(
        vs.inf_mat,
        at[2:-2, 2:-2],
        npx.where(mask8[2:-2, 2:-2], vs.inf_mat_pot[2:-2, 2:-2], vs.inf_mat[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    # constrain matrix infiltration to available porosity
    vs.inf_mat = update(
        vs.inf_mat,
        at[2:-2, 2:-2],
        npx.where(
            vs.inf_mat[2:-2, 2:-2]
            > ((vs.S_ac_rz[2:-2, 2:-2] + vs.S_ufc_rz[2:-2, 2:-2]) - (vs.S_lp_rz[2:-2, 2:-2] + vs.S_fp_rz[2:-2, 2:-2])),
            (vs.S_ac_rz[2:-2, 2:-2] + vs.S_ufc_rz[2:-2, 2:-2]) - (vs.S_lp_rz[2:-2, 2:-2] + vs.S_fp_rz[2:-2, 2:-2]),
            vs.inf_mat[2:-2, 2:-2],
        )
        * vs.maskCatch[2:-2, 2:-2],
    ...
    vs.inf_mat_event_csum = update_add(
        ...
        at[2:-2, 2:-2],
        vs.inf_mat[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    dz_wf = update(
        dz_wf,
        at[2:-2, 2:-2],
        npx.where(mask11[2:-2, 2:-2], (vs.inf_mat[2:-2, 2:-2] / vs.theta_d_t0[2:-2, 2:-2]), dz_wf[2:-2, 2:-2])
        * vs.maskCatch[2:-2, 2:-2],
    )
    dz_wf = update(
        dz_wf,
        at[2:-2, 2:-2],
        npx.where(mask12[2:-2, 2:-2], vs.inf_mat[2:-2, 2:-2] / vs.theta_d[2:-2, 2:-2], dz_wf[2:-2, 2:-2])
        * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.z_wf_t0 = update_add(
        vs.z_wf_t0,
        at[2:-2, 2:-2, vs.tau],
        npx.where(npx.isfinite(dz_wf[2:-2, 2:-2]), dz_wf[2:-2, 2:-2], 0) * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.z_wf_t0 = update(
        vs.z_wf_t0,
        at[2:-2, 2:-2, vs.tau],
        npx.where(mask13[2:-2, 2:-2], vs.z_soil[2:-2, 2:-2], vs.z_wf_t0[2:-2, 2:-2, vs.tau]) * vs.maskCatch[2:-2, 2:-2],
    )
    mask19 = vs.z_wf_t1[:, :, vs.tau] > vs.z_soil
    vs.z_wf_t1 = update(
        vs.z_wf_t1,
        at[2:-2, 2:-2, vs.tau],
        npx.where(mask19[2:-2, 2:-2], vs.z_soil[2:-2, 2:-2], vs.z_wf_t1[2:-2, 2:-2, vs.tau]) * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.z0 = update(
        vs.z0,
        at[2:-2, 2:-2, vs.tau],
        npx.where(vs.z0[2:-2, 2:-2, vs.tau] < 0, 0, vs.z0[2:-2, 2:-2, vs.tau]) * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    dz_wf_t0 = update(
        ...
        at[2:-2, 2:-2],
        npx.where(
            (vs.z_wf_fc[2:-2, 2:-2] > 0) & (vs.rain_ground[2:-2, 2:-2] <= 0) & (vs.no_wf[2:-2, 2:-2] == 1),
            vs.inf_mat_pot[2:-2, 2:-2] / vs.theta_d_t0[2:-2, 2:-2],
            0,
        )
        * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.z_wf_t0 = update_add(
        vs.z_wf_t0,
        at[2:-2, 2:-2, vs.tau],
        npx.where(npx.isfinite(dz_wf_t0[2:-2, 2:-2]), dz_wf_t0[2:-2, 2:-2], 0) * vs.maskCatch[2:-2, 2:-2],
    )
    mask17 = (vs.z_wf_t0[:, :, vs.tau] > vs.z_wf_fc) & (vs.z_wf_fc > 0)
    vs.z_wf_t0 = update(
        vs.z_wf_t0,
        at[2:-2, 2:-2, vs.tau],
        npx.where(mask17[2:-2, 2:-2], vs.z_wf_fc[2:-2, 2:-2], vs.z_wf_t0[2:-2, 2:-2, vs.tau])
        * vs.maskCatch[2:-2, 2:-2],
    )
    vs.z_wf_t0 = update(
        vs.z_wf_t0,
        at[2:-2, 2:-2, vs.tau],
        npx.where(
            vs.z_wf_t0[2:-2, 2:-2, vs.tau] > vs.z_soil[2:-2, 2:-2],
            vs.z_soil[2:-2, 2:-2],
    ...
    dz_wf_t1 = update(
        ...
        at[2:-2, 2:-2],
        npx.where(
            (vs.z_wf_fc[2:-2, 2:-2] > 0) & (vs.rain_ground[2:-2, 2:-2] <= 0) & (vs.no_wf[2:-2, 2:-2] == 2),
            vs.inf_mat_pot[2:-2, 2:-2] / vs.theta_d[2:-2, 2:-2],
            0,
        )
        * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.z_wf_t1 = update_add(
        vs.z_wf_t1,
        at[2:-2, 2:-2, vs.tau],
        npx.where(npx.isfinite(dz_wf_t1[2:-2, 2:-2]), dz_wf_t1[2:-2, 2:-2], 0) * vs.maskCatch[2:-2, 2:-2],
    )
    mask18 = (vs.z_wf_t1[:, :, vs.tau] > vs.z_wf_fc) & (vs.z_wf_fc > 0)
    vs.z_wf_t1 = update(
        vs.z_wf_t1,
        at[2:-2, 2:-2, vs.tau],
        npx.where(mask18[2:-2, 2:-2], vs.z_wf_fc[2:-2, 2:-2], vs.z_wf_t1[2:-2, 2:-2, vs.tau])
        * vs.maskCatch[2:-2, 2:-2],
    )
    vs.z_wf_t1 = update(
        vs.z_wf_t1,
        at[2:-2, 2:-2, vs.tau],
        npx.where(
            vs.z_wf_t1[2:-2, 2:-2, vs.tau] > vs.z_soil[2:-2, 2:-2],
            vs.z_soil[2:-2, 2:-2],
    ...
    vs.z_wf = update(
        vs.z_wf,
        at[2:-2, 2:-2, vs.tau],
        npx.where(mask14[2:-2, 2:-2], vs.z_wf_t0[2:-2, 2:-2, vs.tau], vs.z_wf[2:-2, 2:-2, vs.tau])
        * vs.maskCatch[2:-2, 2:-2],
    )
    vs.theta_d = update(
        vs.theta_d,
        at[2:-2, 2:-2],
        npx.where(mask14[2:-2, 2:-2], vs.theta_d_t0[2:-2, 2:-2], vs.theta_d[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    vs.theta_d_rel = update(
        vs.theta_d_rel,
        at[2:-2, 2:-2],
        npx.where(mask14[2:-2, 2:-2], vs.theta_d_rel_t0[2:-2, 2:-2], vs.theta_d_rel[2:-2, 2:-2])
        * vs.maskCatch[2:-2, 2:-2],
    )
    vs.z_wf = update(
        vs.z_wf,
        at[2:-2, 2:-2, vs.taum1],
        npx.where(mask15[2:-2, 2:-2], 0, vs.z_wf[2:-2, 2:-2, vs.taum1]) * vs.maskCatch[2:-2, 2:-2],
    )
    vs.z_wf = update(
        vs.z_wf,
        at[2:-2, 2:-2, vs.tau],
        npx.where(mask15[2:-2, 2:-2], vs.z_wf_t1[2:-2, 2:-2, vs.tau], vs.z_wf[2:-2, 2:-2, vs.tau])
        * vs.maskCatch[2:-2, 2:-2],
    )
    vs.no_wf = update(
        vs.no_wf,
        at[2:-2, 2:-2],
        npx.where(mask20[2:-2, 2:-2], 1, vs.no_wf[2:-2, 2:-2]),
    )
    vs.z_wf = update(
        vs.z_wf,
        at[2:-2, 2:-2, vs.tau],
        npx.where(mask20[2:-2, 2:-2], vs.z_wf_t0[2:-2, 2:-2, vs.tau], vs.z_wf[2:-2, 2:-2, vs.tau])
        * vs.maskCatch[2:-2, 2:-2],
    )
    vs.theta_d = update(
        vs.theta_d,
        at[2:-2, 2:-2],
        npx.where(mask20[2:-2, 2:-2], vs.theta_d_t0[2:-2, 2:-2], vs.theta_d[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    vs.theta_d_rel = update(
        vs.theta_d_rel,
        at[2:-2, 2:-2],
        npx.where(mask20[2:-2, 2:-2], vs.theta_d_rel_t0[2:-2, 2:-2], vs.theta_d_rel[2:-2, 2:-2])
        * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.z_wf = update(
        vs.z_wf,
        at[2:-2, 2:-2, vs.tau],
        npx.where(mask16[2:-2, 2:-2], vs.z_soil[2:-2, 2:-2], vs.z_wf[2:-2, 2:-2, vs.tau]) * vs.maskCatch[2:-2, 2:-2],
    )
    mask17 = vs.theta_d_t1 <= 0
    vs.theta_d = update(
        vs.theta_d,
        at[2:-2, 2:-2],
        npx.where(mask17[2:-2, 2:-2], vs.theta_d_t0[2:-2, 2:-2], vs.theta_d[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )

    return KernelOutput(
        inf_mat_pot=vs.inf_mat_pot,
        inf_mat=vs.inf_mat,
        z0=vs.z0,
        z_wf=vs.z_wf,
        z_wf_t0=vs.z_wf_t0,
...
def calc_inf_mp(state):
    ...
    z_wf = update(
        z_wf,
        at[2:-2, 2:-2],
        npx.where(vs.no_wf[2:-2, 2:-2] == 1, 0, vs.z_wf_t0[2:-2, 2:-2, vs.tau]) * vs.maskCatch[2:-2, 2:-2],
    )
    z_wf = update(
        z_wf,
        at[2:-2, 2:-2],
        npx.where(vs.no_wf[2:-2, 2:-2] == 2, 0, vs.z_wf_t1[2:-2, 2:-2, vs.tau]) * vs.maskCatch[2:-2, 2:-2],
    )
    z_wf_m1 = update(
        z_wf,
        at[2:-2, 2:-2],
        npx.where(vs.no_wf[2:-2, 2:-2] == 1, 0, vs.z_wf_t0[2:-2, 2:-2, vs.taum1]) * vs.maskCatch[2:-2, 2:-2],
    )
    z_wf_m1 = update(
        z_wf,
        at[2:-2, 2:-2],
        npx.where(vs.no_wf[2:-2, 2:-2] == 2, 0, vs.z_wf_t1[2:-2, 2:-2, vs.taum1]) * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.lmpv_non_sat = update(
        vs.lmpv_non_sat,
        at[2:-2, 2:-2],
        vs.lmpv[2:-2, 2:-2] - z_wf[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    vs.lmpv_non_sat = update(
        vs.lmpv_non_sat,
        at[2:-2, 2:-2],
        npx.where(vs.lmpv_non_sat[2:-2, 2:-2] < 0, 0, vs.lmpv_non_sat[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    dz_wf = update(
        dz_wf,
        at[2:-2, 2:-2],
        z_wf[2:-2, 2:-2] - z_wf_m1[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    mask1 = z_wf >= vs.lmpv
    dz_wf = update(
        dz_wf,
        at[2:-2, 2:-2],
        npx.where(mask1[2:-2, 2:-2], vs.lmpv_non_sat[2:-2, 2:-2], dz_wf[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    dz_wf = update(
        dz_wf,
        at[2:-2, 2:-2],
        npx.where(vs.lmpv_non_sat[2:-2, 2:-2] <= 0, 0, dz_wf[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    dz_wf = update(
        dz_wf,
        at[2:-2, 2:-2],
        npx.where(dz_wf[2:-2, 2:-2] <= 0, 0, dz_wf[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.lmpv_non_sat = update(
        vs.lmpv_non_sat,
        at[2:-2, 2:-2],
        vs.lmpv[2:-2, 2:-2] - vs.z_wf[2:-2, 2:-2, vs.tau] * vs.maskCatch[2:-2, 2:-2],
    )
    vs.lmpv_non_sat = update(
        vs.lmpv_non_sat,
        at[2:-2, 2:-2],
    ...
    # time step.
    substeps = npx.int32(npx.round(vs.dt / (1 / 5), 0))  # based on hours

    vs.lmpv_non_sat = update(
        vs.lmpv_non_sat,
        at[2:-2, 2:-2],
        npx.where(substeps == 1, vs.lmpv_non_sat[2:-2, 2:-2] + dz_wf[2:-2, 2:-2] / 1.39, vs.lmpv_non_sat[2:-2, 2:-2])
        * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    y2 = update(
        y2,
        at[2:-2, 2:-2],
        (settings.r_mp / 2) * vs.maskCatch[2:-2, 2:-2],
    )
    a = update(
        a,
        at[2:-2, 2:-2],
        vs.theta_d[2:-2, 2:-2] * settings.r_mp**2 * vs.maskCatch[2:-2, 2:-2],
    )
    y = update(
        y,
        at[2:-2, 2:-2],
        vs.y_mp[2:-2, 2:-2, vs.taum1] * vs.maskCatch[2:-2, 2:-2],
    )
    ym1 = update(
        ym1,
        at[2:-2, 2:-2],
    ...
    inf_mp_event_csum = update(
        ym1,
        at[2:-2, 2:-2],
        vs.inf_mp_event_csum[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    def loop_body(i, carry):
        ...
        z0_di = update(
            z0_di,
            at[2:-2, 2:-2],
            vs.z0[2:-2, 2:-2, vs.tau] * (vs.mp_drain_area[2:-2, 2:-2] / substeps) * vs.maskCatch[2:-2, 2:-2],
        )
        t = update_add(
            t,
            at[2:-2, 2:-2],
            (vs.dt / substeps) * vs.maskCatch[2:-2, 2:-2],
        )
        c = update(
            c,
            at[2:-2, 2:-2],
            vs.ks[2:-2, 2:-2] * vs.wfs[2:-2, 2:-2] * t[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
        )
        c = update(
            c,
            at[2:-2, 2:-2],
            npx.where(npx.isnan(c[2:-2, 2:-2]), 0, c[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
        )
        b1 = update(
            b1,
            at[2:-2, 2:-2],
            (6**0.5 * 2 * (c[2:-2, 2:-2] * (6 * c[2:-2, 2:-2] - a[2:-2, 2:-2])) ** 0.5) * vs.maskCatch[2:-2, 2:-2],
        )
        b1 = update(
            b1,
            at[2:-2, 2:-2],
            npx.where(npx.isnan(b1[2:-2, 2:-2]), 0, b1[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
        )
        b2 = update(
            b2,
            at[2:-2, 2:-2],
            (settings.r_mp * vs.theta_d[2:-2, 2:-2] ** 2)
            * (12 * c[2:-2, 2:-2] - a[2:-2, 2:-2] + b1[2:-2, 2:-2])
            * vs.maskCatch[2:-2, 2:-2],
        )
        b2 = update(
            b2,
            at[2:-2, 2:-2],
            npx.where(npx.isnan(b2[2:-2, 2:-2]), 0, b2[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
        )
        b2 = update(
            b2,
            at[2:-2, 2:-2],
            npx.where(b2[2:-2, 2:-2] <= 0, 0, b2[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
        )
        y1 = update(
            y1,
            at[2:-2, 2:-2],
            ((b2[2:-2, 2:-2] ** (1 / 3)) / vs.theta_d[2:-2, 2:-2]) * 0.5 * vs.maskCatch[2:-2, 2:-2],
        )

        y2 = update(
            y2,
            at[2:-2, 2:-2],
            (a[2:-2, 2:-2] / (b2[2:-2, 2:-2] ** (1 / 3))) * 0.5 * vs.maskCatch[2:-2, 2:-2],
        )
        y = update(
            y,
            at[2:-2, 2:-2],
            (y1[2:-2, 2:-2] + y2[2:-2, 2:-2] + ym1[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
        )
        # potential radial length of macropore wetting front
        y = update(
            y,
            at[2:-2, 2:-2],
            npx.where(y[2:-2, 2:-2] < settings.r_mp, settings.r_mp, y[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
        )
        ...
        y = update(
            y,
            at[2:-2, 2:-2],
            npx.where(y[2:-2, 2:-2] < ym1[2:-2, 2:-2], ym1[2:-2, 2:-2], y[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
        )
        ...
        inf_mp_pot_di = update(
            ...
            (
                settings.pi
                * (y[2:-2, 2:-2] ** 2 - ym1[2:-2, 2:-2] ** 2)
                * vs.lmpv_non_sat[2:-2, 2:-2]
                * vs.theta_d[2:-2, 2:-2]
                * vs.dmpv[2:-2, 2:-2]
                * 1e-06
            )
        ...
        inf_mp_pot = update_add(
            inf_mp_pot,
            at[2:-2, 2:-2],
            inf_mp_pot_di[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
        )
        ...
        inf_mp_di = update(
            inf_mp_di,
            at[2:-2, 2:-2],
            npx.where(mask1[2:-2, 2:-2], z0_di[2:-2, 2:-2], inf_mp_pot_di[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
        )
        inf_mp_di = update(
            inf_mp_di,
            at[2:-2, 2:-2],
            npx.where(vs.lmpv_non_sat[2:-2, 2:-2] == 0, 0, inf_mp_di[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
        )
        inf_mp = update_add(
            inf_mp,
            at[2:-2, 2:-2],
            inf_mp_di[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
        )
        ...
        y = update(
            ...
            at[2:-2, 2:-2],
            settings.r_mp
            + ((inf_mp_event_csum[2:-2, 2:-2] / (vs.dmpv[2:-2, 2:-2] * vs.theta_d[2:-2, 2:-2])) / settings.pi) ** 0.5
            * vs.maskCatch[2:-2, 2:-2],
        )
        y = update(
            y,
        ...
        t = update(
            ...
            at[2:-2, 2:-2],
            vs.theta_d[2:-2, 2:-2]
            / (vs.ks[2:-2, 2:-2] * vs.wfs[2:-2, 2:-2] * settings.r_mp)
            * (y[2:-2, 2:-2] ** 3 / 3.0 - y[2:-2, 2:-2] ** 2 * settings.r_mp / 2.0 + settings.r_mp**3 / 6.0)
            * vs.maskCatch[2:-2, 2:-2],
        )
        ...
        inf_mp = update(
            inf_mp,
            at[2:-2, 2:-2],
            npx.where(inf_mp[2:-2, 2:-2] < 0, 0, inf_mp[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
        )

        ym1 = update(
            ym1,
            at[2:-2, 2:-2],
            y[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
        )
    ...
    vs.y_mp = update(
        vs.y_mp,
        at[2:-2, 2:-2, vs.tau],
        npx.where(npx.isnan(vs.y_mp[2:-2, 2:-2, vs.tau]), 0, vs.y_mp[2:-2, 2:-2, vs.tau]) * vs.maskCatch[2:-2, 2:-2],
    )

    vs.inf_mp = update(
        vs.inf_mp,
        at[2:-2, 2:-2],
        inf_mp[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )

    vs.inf_mp = update(
        vs.inf_mp,
        at[2:-2, 2:-2],
        npx.where(npx.isnan(vs.inf_mp[2:-2, 2:-2]), 0, vs.inf_mp[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    rz_share_mp = update(
        ...
        at[2:-2, 2:-2],
        npx.where(
            vs.lmpv_non_sat[2:-2, 2:-2] > 0,
            1.0 - (vs.lmpv[2:-2, 2:-2] - vs.z_root[2:-2, 2:-2, vs.tau]) / vs.lmpv_non_sat[2:-2, 2:-2],
            0,
        )
        * vs.maskCatch[2:-2, 2:-2],
    )
    rz_share_mp = update(
        rz_share_mp,
        at[2:-2, 2:-2],
        npx.where(vs.lmpv[2:-2, 2:-2] <= vs.z_root[2:-2, 2:-2, vs.tau], 1, rz_share_mp[2:-2, 2:-2])
        * vs.maskCatch[2:-2, 2:-2],
    )
    rz_share_mp = update(
        rz_share_mp,
        at[2:-2, 2:-2],
        npx.where(
            z_wf[2:-2, 2:-2] >= vs.z_root[2:-2, 2:-2, vs.tau],
            0,
            rz_share_mp[2:-2, 2:-2],
        )
        * vs.maskCatch[2:-2, 2:-2],
    ...
    vs.inf_mp_rz = update(
        vs.inf_mp_rz,
        at[2:-2, 2:-2],
        vs.inf_mp[2:-2, 2:-2] * rz_share_mp[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    vs.inf_mp_rz = update(
        vs.inf_mp_rz,
        at[2:-2, 2:-2],
        npx.where(
            (
                ...
                > (vs.S_ac_rz[2:-2, 2:-2] + vs.S_ufc_rz[2:-2, 2:-2])
                - (vs.inf_mat_rz[2:-2, 2:-2] + vs.S_lp_rz[2:-2, 2:-2] + vs.S_fp_rz[2:-2, 2:-2])
            )
            & (
                (vs.S_ac_rz[2:-2, 2:-2] + vs.S_ufc_rz[2:-2, 2:-2])
                - (vs.inf_mat_rz[2:-2, 2:-2] + vs.S_lp_rz[2:-2, 2:-2] + vs.S_fp_rz[2:-2, 2:-2])
    ...
    vs.inf_mp_ss = update(
        vs.inf_mp_ss,
        at[2:-2, 2:-2],
        vs.inf_mp[2:-2, 2:-2] * (1 - rz_share_mp[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    vs.inf_mp_ss = update(
        vs.inf_mp_ss,
        at[2:-2, 2:-2],
        npx.where(
            (
                ...
                > (vs.S_ac_ss[2:-2, 2:-2] + vs.S_ufc_ss[2:-2, 2:-2]) - (vs.S_lp_ss[2:-2, 2:-2] + vs.S_fp_ss[2:-2, 2:-2])
            )
            & (
                (vs.S_ac_ss[2:-2, 2:-2] + vs.S_ufc_ss[2:-2, 2:-2]) - (vs.S_lp_ss[2:-2, 2:-2] + vs.S_fp_ss[2:-2, 2:-2])
                > 0
    ...
    vs.inf_ss = update(
        vs.inf_ss,
        at[2:-2, 2:-2],
        vs.inf_mp_ss[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.S_fp_ss = update_add(
        vs.S_fp_ss,
        at[2:-2, 2:-2],
        vs.inf_ss[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.inf_mp_event_csum = update_add(
        ...
        at[2:-2, 2:-2],
        vs.inf_mp[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    if settings.enable_macropore_lower_boundary_condition:
        npx.where(
            (vs.z0[2:-2, 2:-2, vs.tau] > vs.ks[2:-2, 2:-2] * vs.dt * vs.mp_drain_area[2:-2, 2:-2]),
            vs.ks[2:-2, 2:-2] * vs.dt * vs.mp_drain_area[2:-2, 2:-2],
        ...
        vs.inf_mp = update(
            ...
            at[2:-2, 2:-2],
            npx.where(
                (vs.z_wf[2:-2, 2:-2, vs.tau] > vs.z_root[2:-2, 2:-2, vs.tau])
                & (vs.inf_mp[2:-2, 2:-2] > vs.S_ac_ss[2:-2, 2:-2] - vs.S_lp_ss[2:-2, 2:-2])
                & (vs.S_ac_ss[2:-2, 2:-2] - vs.S_lp_ss[2:-2, 2:-2] > 0),
                vs.S_ac_ss[2:-2, 2:-2] - vs.S_lp_ss[2:-2, 2:-2],
                vs.inf_mp[2:-2, 2:-2],
            )
            * vs.maskCatch[2:-2, 2:-2],
        )
...
def calc_inf_sc(state):
    ...
    vs.z_sc_non_sat = update(
        vs.z_sc_non_sat,
        at[2:-2, 2:-2],
        vs.z_sc[2:-2, 2:-2] - z_wf[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    vs.z_sc_non_sat = update(
        vs.z_sc_non_sat,
        at[2:-2, 2:-2],
        npx.where(vs.z_sc_non_sat[2:-2, 2:-2] < 0, 0, vs.z_sc_non_sat[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    dz_wf = update(
        dz_wf,
        at[2:-2, 2:-2],
        npx.where(mask1[2:-2, 2:-2], vs.z_sc_non_sat[2:-2, 2:-2], dz_wf[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    dz_wf = update(
        dz_wf,
        at[2:-2, 2:-2],
        npx.where(vs.z_sc_non_sat[2:-2, 2:-2] <= 0, 0, dz_wf[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    dz_wf = update(
        dz_wf,
        at[2:-2, 2:-2],
    ...
    vs.z_sc_non_sat = update(
        vs.z_sc_non_sat,
        at[2:-2, 2:-2],
        vs.z_sc[2:-2, 2:-2] - vs.z_wf[2:-2, 2:-2, vs.tau] * vs.maskCatch[2:-2, 2:-2],
    )
    vs.z_sc_non_sat = update(
        vs.z_sc_non_sat,
        at[2:-2, 2:-2],
    ...
    vs.z_sc_non_sat = update(
        vs.z_sc_non_sat,
        at[2:-2, 2:-2],
        npx.where(substeps == 1, vs.z_sc_non_sat[2:-2, 2:-2] + dz_wf[2:-2, 2:-2] / 1.39, vs.z_sc_non_sat[2:-2, 2:-2])
        * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    y = update(
        y,
        at[2:-2, 2:-2],
        vs.y_sc[2:-2, 2:-2, vs.taum1] * vs.maskCatch[2:-2, 2:-2],
    )
    ym1 = update(
        ym1,
        at[2:-2, 2:-2],
    ...
    inf_sc_event_csum = update(
        inf_sc_event_csum,
        at[2:-2, 2:-2],
        vs.inf_sc_event_csum[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    def loop_body(i, carry):
        ...
        z0_di = update(
            z0_di,
            at[2:-2, 2:-2],
            (vs.z0[2:-2, 2:-2, vs.tau] / substeps) * vs.maskCatch[2:-2, 2:-2],
        )
        t = update_add(
            t,
            at[2:-2, 2:-2],
        ...
        y = update(
            y,
            at[2:-2, 2:-2],
            (((vs.ks[2:-2, 2:-2] * vs.wfs[2:-2, 2:-2] * t[2:-2, 2:-2] * 2) / vs.theta_d[2:-2, 2:-2]) ** 0.5)
            * vs.maskCatch[2:-2, 2:-2],
        )
        ...
        inf_sc_pot_di = update(
            ...
            at[2:-2, 2:-2],
            (
                (vs.z_sc_non_sat[2:-2, 2:-2] * vs.theta_d[2:-2, 2:-2] * settings.l_sc)
                * (y[2:-2, 2:-2] - ym1[2:-2, 2:-2])
                * 1e-06
            )
            * vs.maskCatch[2:-2, 2:-2],
        )
        inf_sc_pot_di = update(
            inf_sc_pot_di,
            at[2:-2, 2:-2],
            npx.where(inf_sc_pot_di[2:-2, 2:-2] <= 0, 0, inf_sc_pot_di[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
        )
        # actual horizontal shrinkage crack infiltration
        inf_sc_di = update(
            inf_sc_di,
            at[2:-2, 2:-2],
            npx.where(inf_sc_pot_di[2:-2, 2:-2] > z0_di[2:-2, 2:-2], z0_di[2:-2, 2:-2], inf_sc_pot_di[2:-2, 2:-2])
            * vs.maskCatch[2:-2, 2:-2],
        )
        inf_sc_di = update(
            inf_sc_di,
            at[2:-2, 2:-2],
            npx.where(vs.z_sc_non_sat[2:-2, 2:-2] <= 0, 0, inf_sc_di[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
        )
        inf_sc_di = update_add(
            inf_sc_di,
            at[2:-2, 2:-2],
            inf_sc_di[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
        )
        ...
        y = update(
            y,
            at[2:-2, 2:-2],
            (inf_sc_event_csum[2:-2, 2:-2] / settings.l_sc / 2) * vs.maskCatch[2:-2, 2:-2],
        )
        # duration of shrinkage crack infiltration
        t = update(
            t,
            at[2:-2, 2:-2],
            ((ym1[2:-2, 2:-2] ** 2 * vs.theta_d[2:-2, 2:-2]) / (vs.ks[2:-2, 2:-2] * vs.wfs[2:-2, 2:-2] * 2))
            * vs.maskCatch[2:-2, 2:-2],
        )
    ...
    vs.inf_sc = update(
        vs.inf_sc,
        at[2:-2, 2:-2],
        inf_sc[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )

    vs.inf_sc_event_csum = update_add(
        vs.inf_sc_event_csum,
        at[2:-2, 2:-2],
        vs.inf_sc[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    return KernelOutput(
        inf_sc=vs.inf_sc, inf_sc_event_csum=vs.inf_sc_event_csum, y_sc=vs.y_sc, z0=vs.z0, z_sc_non_sat=vs.z_sc_non_sat
    )
...
def calc_inf_rz(state):
    ...
    vs.S_fp_rz = update_add(
        vs.S_fp_rz,
        at[2:-2, 2:-2],
        vs.inf_rz[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
...
def calc_hof_and_sof(state):
    ...
    mask2 = ((vs.S_lp_rz + vs.S_fp_rz) > (vs.S_ac_rz + vs.S_ufc_rz)) & ((vs.S_lp_ss + vs.S_fp_ss) >= (vs.S_ac_ss + vs.S_ufc_ss))
    vs.q_sof = update(
        vs.q_sof,
        at[2:-2, 2:-2],
        npx.where(
    ...
    return KernelOutput(q_hof=vs.q_hof, q_sof=vs.q_sof, S_fp_rz=vs.S_fp_rz, S_lp_rz=vs.S_lp_rz)
...
def calc_inf(state):
    ...
    vs.inf = update(
        vs.inf,
        at[2:-2, 2:-2],
        (vs.inf_rz[2:-2, 2:-2] + vs.inf_ss[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
...
def calc_z_wf_fc(state):
    ...
    z_wf_fc = update(
        ...
        at[2:-2, 2:-2],
        npx.where(
            vs.theta_d_fp[2:-2, 2:-2] > 0,
            vs.inf_mat_event_csum[2:-2, 2:-2] / vs.theta_d_fp[2:-2, 2:-2],
    ...
    z_wf_fc = update(
        z_wf_fc,
        at[2:-2, 2:-2],
        npx.where(z_wf_fc[2:-2, 2:-2] > vs.z_soil[2:-2, 2:-2], vs.z_soil[2:-2, 2:-2], z_wf_fc[2:-2, 2:-2])
        * vs.maskCatch[2:-2, 2:-2],
    )
...
def calc_theta_d(state):
    ...
    theta_d = update(
        theta_d,
        at[2:-2, 2:-2],
        npx.where(vs.z_soil[2:-2, 2:-2] <= 0, 0.01, theta_d[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    theta_d = update(
        theta_d,
        at[2:-2, 2:-2],
        npx.where(theta_d[2:-2, 2:-2] <= 0, 0.01, theta_d[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
...
def calc_theta_d_fp(state):
    ...
    theta_d_fp = update(
        theta_d_fp,
        at[2:-2, 2:-2],
        npx.where(vs.z_soil[2:-2, 2:-2] <= 0, 0.01, theta_d_fp[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    theta_d_fp = update(
        theta_d_fp,
        at[2:-2, 2:-2],
        npx.where(theta_d_fp[2:-2, 2:-2] <= 0, 0.01, theta_d_fp[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
...
def calc_pi_gr(state):
    ...
    pi_gr = update(
        ...
        at[2:-2, 2:-2],
        vs.ks[2:-2, 2:-2]
        * (((vs.theta_d[2:-2, 2:-2] * vs.wfs[2:-2, 2:-2]) / (vs.prec_event_csum[2:-2, 2:-2] + 1)) + 1),
    )
...
def calc_pi_m(state):
    ...
    pi_m = update(
        pi_m,
        at[2:-2, 2:-2],
        vs.ks[2:-2, 2:-2] * vs.theta_d[2:-2, 2:-2] * vs.wfs[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
...
def calc_sat_time(state, pi_m, pi_gr):
    ...
    mask2 = (
        ((vs.prec[:, :, vs.tau] * (1 / vs.dt) - vs.ks) * vs.prec_event_csum > vs.ks * vs.theta_d * vs.wfs)
        & (vs.pi_m <= vs.prec_event_csum)
        & (vs.pi_m <= vs.pi_gr)
        & (vs.t_sat == 0)
    )
    vs.t_sat = update(
        vs.t_sat,
        at[2:-2, 2:-2],
        npx.where(mask1[2:-2, 2:-2], vs.t_event_csum[2:-2, 2:-2] - vs.dt, vs.t_sat[2:-2, 2:-2]),
    )
    vs.t_sat = update(
        vs.t_sat,
        at[2:-2, 2:-2],
        npx.where(
            mask2[2:-2, 2:-2],
            vs.t_event_csum[2:-2, 2:-2]
            + (
                (vs.ks[2:-2, 2:-2] * vs.theta_d[2:-2, 2:-2] * vs.wfs[2:-2, 2:-2])
                / (vs.pi_m[2:-2, 2:-2] * (vs.pi_m[2:-2, 2:-2] * -vs.ks[2:-2, 2:-2]))
            )
            - (vs.dt / vs.pi_m[2:-2, 2:-2]) * vs.prec_event_csum[2:-2, 2:-2],
            vs.t_sat[2:-2, 2:-2],
        ),
    )
...
def calc_Fs(state, pi_m):
    ...
    Fs = update(
        Fs,
        at[2:-2, 2:-2],
        ((vs.ks[2:-2, 2:-2] * vs.theta_d[2:-2, 2:-2] * vs.wfs[2:-2, 2:-2]) / (pi_m[2:-2, 2:-2] - vs.ks[2:-2, 2:-2]))
        * vs.maskCatch[2:-2, 2:-2],
    )
    Fs = update(
        Fs,
        at[2:-2, 2:-2],
        npx.where(pi_m[2:-2, 2:-2] <= vs.ks[2:-2, 2:-2], pi_m[2:-2, 2:-2], Fs[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
...
def calc_depth_shrinkage_cracks(state):
    ...
    vs.z_sc = update(
        ...
        at[2:-2, 2:-2],
        npx.where(
            vs.theta_rz[2:-2, 2:-2, vs.tau] < vs.theta_4[2:-2, 2:-2],
            vs.z_sc_max[2:-2, 2:-2],
            npx.where(
                (vs.theta_rz[2:-2, 2:-2, vs.tau] >= vs.theta_4[2:-2, 2:-2])
                & (vs.theta_rz[2:-2, 2:-2, vs.tau] < vs.theta_27[2:-2, 2:-2]),
                (vs.theta_rz[2:-2, 2:-2, vs.tau] - vs.theta_4[2:-2, 2:-2])
                / (vs.theta_27[2:-2, 2:-2] - vs.theta_4[2:-2, 2:-2]),
                0,
            )
            * vs.z_sc_max[2:-2, 2:-2],
        )
    ...
    vs.z_sc = update(
        ...
        at[2:-2, 2:-2],
        npx.where(
            vs.theta_rz[2:-2, 2:-2, vs.tau] < vs.theta_4[2:-2, 2:-2], vs.z_sc_max[2:-2, 2:-2], vs.z_sc[2:-2, 2:-2]
        )
        * vs.maskCatch[2:-2, 2:-2],
    )
    vs.z_sc = update(
        vs.z_sc,
        at[2:-2, 2:-2],
        npx.where(vs.theta_rz[2:-2, 2:-2, vs.tau] > vs.theta_27[2:-2, 2:-2], 0, vs.z_sc[2:-2, 2:-2])
        * vs.maskCatch[2:-2, 2:-2],
    )
    vs.z_sc = update(
        vs.z_sc,
    ...
    vs.z_sc = update(
        ...
        at[2:-2, 2:-2],
        npx.where(
            vs.z_sc[2:-2, 2:-2] > vs.z_root[2:-2, 2:-2, vs.tau], vs.z_root[2:-2, 2:-2, vs.tau], vs.z_sc[2:-2, 2:-2]
        )
        * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.z_sc = update(
        vs.z_sc,
        at[2:-2, 2:-2],
        npx.where((vs.lu_id[2:-2, 2:-2] == 13), 0, vs.z_sc[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
...
def set_event_vars(state):
    ...
    vs.theta_d = update(
        vs.theta_d,
        at[2:-2, 2:-2],
        theta_d[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    theta_d_rel = calc_theta_d_rel(state)
    vs.theta_d_rel = update(
        vs.theta_d_rel,
        at[2:-2, 2:-2],
        theta_d_rel[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.theta_d_fp = update(
        vs.theta_d_fp,
        at[2:-2, 2:-2],
        theta_d_fp[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
...
def set_event_vars_start_rainfall_pause(state):
    ...
    vs.z_wf_fc = update(
        vs.z_wf_fc,
        at[2:-2, 2:-2],
        npx.where(mask[2:-2, 2:-2], z_wf_fc[2:-2, 2:-2], vs.z_wf_fc[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
...
def set_event_vars_end_rainfall_pause(state):
    ...
    vs.no_wf = update(
        vs.no_wf,
        at[2:-2, 2:-2],
        npx.where(mask[2:-2, 2:-2], 2, vs.no_wf[2:-2, 2:-2]),
    )
    ...
    vs.theta_d = update(
        vs.theta_d,
        at[2:-2, 2:-2],
        npx.where(mask[2:-2, 2:-2], theta_d[2:-2, 2:-2], vs.theta_d[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    theta_d_rel = calc_theta_d_rel(state)
    vs.theta_d_rel = update(
        vs.theta_d_rel,
        at[2:-2, 2:-2],
        npx.where(mask[2:-2, 2:-2], theta_d_rel[2:-2, 2:-2], vs.theta_d_rel[2:-2, 2:-2]) * vs.maskCatch[2:-2, 2:-2],
    )
    # second wetting front
    vs.z_wf_t1 = update(
        vs.z_wf_t1,
        at[2:-2, 2:-2, :],
        npx.where(mask[2:-2, 2:-2, npx.newaxis], 0, vs.z_wf_t1[2:-2, 2:-2, :]),
    )
    ...
    vs.prec_event_csum = update(
        vs.prec_event_csum,
        at[2:-2, 2:-2],
        npx.where(mask[2:-2, 2:-2], 0, vs.prec_event_csum[2:-2, 2:-2]),
    )
    # accumulated time during an event (in mm)
    vs.t_event_csum = update(
        vs.t_event_csum,
        at[2:-2, 2:-2],
        npx.where(mask[2:-2, 2:-2], 0, vs.t_event_csum[2:-2, 2:-2]),
    )
...
def calculate_infiltration(state):
    ...
    cond2 = (
        (vs.prec[2:-2, 2:-2, vs.tau] == 0).any()
        & (vs.prec[2:-2, 2:-2, vs.taum1] != 0).any()
        & (vs.event_id[vs.taum1] >= 1)
    )
    cond3 = (
        (vs.prec[2:-2, 2:-2, vs.tau] != 0).any()
        & (vs.prec[2:-2, 2:-2, vs.taum1] == 0).any()
        & (vs.event_id[vs.taum1] == vs.event_id[vs.tau])
    )
    ...
    vs.update(calc_hof_and_sof(state))
    if not settings.enable_routing_1D:
...
def calc_infiltration_rz_transport_kernel(state):
    ...
    vs.sa_rz = update_add(
        vs.sa_rz,
        at[2:-2, 2:-2, vs.tau, 0],
        vs.inf_mat_rz[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )

    vs.sa_rz = update_add(
        vs.sa_rz,
        at[2:-2, 2:-2, vs.tau, 0],
        vs.inf_pf_rz[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
...
def calc_infiltration_rz_transport_iso_kernel(state):
    ...
    vs.C_inf_mat_rz = update(
        vs.C_inf_mat_rz,
        at[2:-2, 2:-2],
        npx.where(vs.inf_mat_rz[2:-2, 2:-2] > 0, vs.C_in[2:-2, 2:-2], 0) * vs.maskCatch[2:-2, 2:-2],
    )
    vs.C_inf_pf_rz = update(
        vs.C_inf_pf_rz,
        at[2:-2, 2:-2],
        npx.where(vs.inf_pf_rz[2:-2, 2:-2] > 0, vs.C_in[2:-2, 2:-2], 0) * vs.maskCatch[2:-2, 2:-2],
    )
    vs.C_iso_inf_mat_rz = update(
        vs.C_iso_inf_mat_rz,
        at[2:-2, 2:-2],
        transport.conc_to_delta(state, vs.C_inf_mat_rz)[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    vs.C_iso_inf_pf_rz = update(
        vs.C_iso_inf_pf_rz,
        at[2:-2, 2:-2],
        transport.conc_to_delta(state, vs.C_inf_pf_rz)[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    # travel time distribution
    vs.tt_inf_mat_rz = update(
        vs.tt_inf_mat_rz,
        at[2:-2, 2:-2, 0],
        npx.where(vs.inf_mat_rz[2:-2, 2:-2] > 0, 1, 0) * vs.maskCatch[2:-2, 2:-2],
    )
    vs.tt_inf_pf_rz = update(
        vs.tt_inf_pf_rz,
        at[2:-2, 2:-2, 0],
        npx.where(vs.inf_pf_rz[2:-2, 2:-2] > 0, 1, 0) * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    vs.msa_rz = update(
        ...
        at[2:-2, 2:-2, vs.tau, :],
        npx.where(
            vs.inf_mat_rz[2:-2, 2:-2, npx.newaxis] * vs.tt_inf_mat_rz[2:-2, 2:-2, :] + vs.sa_rz[2:-2, 2:-2, vs.tau, :]
            > 0,
            vs.msa_rz[2:-2, 2:-2, vs.tau, :]
            * (
                vs.sa_rz[2:-2, 2:-2, vs.tau, :]
                / (
                    vs.tt_inf_mat_rz[2:-2, 2:-2, :] * vs.inf_mat_rz[2:-2, 2:-2, npx.newaxis]
                    + vs.sa_rz[2:-2, 2:-2, vs.tau, :]
                )
            )
            + vs.mtt_inf_mat_rz[2:-2, 2:-2, :]
            * (
                (vs.tt_inf_mat_rz[2:-2, 2:-2, :] * vs.inf_mat_rz[2:-2, 2:-2, npx.newaxis])
                / (
                    vs.inf_mat_rz[2:-2, 2:-2, npx.newaxis] * vs.tt_inf_mat_rz[2:-2, 2:-2, :]
                    + vs.sa_rz[2:-2, 2:-2, vs.tau, :]
                )
            ),
            vs.msa_rz[2:-2, 2:-2, vs.tau, :],
    ...
    vs.msa_rz = update(
        ...
        at[2:-2, 2:-2, vs.tau, :],
        npx.where(
            vs.inf_pf_rz[2:-2, 2:-2, npx.newaxis] * vs.tt_inf_pf_rz[2:-2, 2:-2, :] + vs.sa_rz[2:-2, 2:-2, vs.tau, :]
            > 0,
            vs.msa_rz[2:-2, 2:-2, vs.tau, :]
            * (
                vs.sa_rz[2:-2, 2:-2, vs.tau, :]
                / (
                    vs.tt_inf_pf_rz[2:-2, 2:-2, :] * vs.inf_pf_rz[2:-2, 2:-2, npx.newaxis]
                    + vs.sa_rz[2:-2, 2:-2, vs.tau, :]
                )
            )
            + vs.mtt_inf_pf_rz[2:-2, 2:-2, :]
            * (
                (vs.tt_inf_pf_rz[2:-2, 2:-2, :] * vs.inf_pf_rz[2:-2, 2:-2, npx.newaxis])
                / (
                    vs.inf_pf_rz[2:-2, 2:-2, npx.newaxis] * vs.tt_inf_pf_rz[2:-2, 2:-2, :]
                    + vs.sa_rz[2:-2, 2:-2, vs.tau, :]
                )
            ),
            vs.msa_rz[2:-2, 2:-2, vs.tau, :],
    ...
    return KernelOutput(
        sa_rz=vs.sa_rz,
        msa_rz=vs.msa_rz,
        C_inf_mat_rz=vs.C_inf_mat_rz,
        C_inf_pf_rz=vs.C_inf_pf_rz,
        C_iso_inf_mat_rz=vs.C_iso_inf_mat_rz,
        C_iso_inf_pf_rz=vs.C_iso_inf_pf_rz,
        tt_inf_mat_rz=vs.tt_inf_mat_rz,
        mtt_inf_mat_rz=vs.mtt_inf_mat_rz,
        tt_inf_pf_rz=vs.tt_inf_pf_rz,
        mtt_inf_pf_rz=vs.mtt_inf_pf_rz,
    )
...
def calc_infiltration_rz_transport_anion_kernel(state):
    ...
    vs.mtt_inf_mat_rz = update(
        vs.mtt_inf_mat_rz,
        at[2:-2, 2:-2, 0],
        vs.inf_mat_rz[2:-2, 2:-2] * vs.C_in[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    vs.mtt_inf_pf_rz = update(
        vs.mtt_inf_pf_rz,
        at[2:-2, 2:-2, 0],
        vs.inf_pf_rz[2:-2, 2:-2] * vs.C_in[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    # solute mass of infiltration
    vs.M_inf_mat_rz = update(
        vs.M_inf_mat_rz,
        at[2:-2, 2:-2],
        vs.C_inf_mat_rz[2:-2, 2:-2] * vs.inf_mat_rz[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    vs.M_inf_pf_rz = update(
        vs.C_inf_pf_rz,
        at[2:-2, 2:-2],
        vs.C_inf_pf_rz[2:-2, 2:-2] * vs.inf_pf_rz[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    vs.sa_rz = update_add(
        vs.sa_rz,
        at[2:-2, 2:-2, vs.tau, 0],
        vs.inf_mat_rz[2:-2, 2:-2] + vs.inf_pf_rz[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    vs.msa_rz = update_add(
        vs.msa_rz,
        at[2:-2, 2:-2, vs.tau, 0],
        vs.M_inf_mat_rz[2:-2, 2:-2] + vs.M_inf_pf_rz[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    ...
    return KernelOutput(
        ...
        C_inf_mat_rz=vs.C_inf_mat_rz,
        C_inf_pf_rz=vs.C_inf_pf_rz,
        M_inf_mat_rz=vs.M_inf_mat_rz,
        M_inf_pf_rz=vs.M_inf_pf_rz,
        tt_inf_mat_rz=vs.tt_inf_mat_rz,
        mtt_inf_mat_rz=vs.mtt_inf_mat_rz,
        tt_inf_pf_rz=vs.tt_inf_pf_rz,
        mtt_inf_pf_rz=vs.mtt_inf_pf_rz,
...
def calc_infiltration_ss_transport_kernel(state):
    ...
    vs.sa_ss = update_add(
        vs.sa_ss,
        at[2:-2, 2:-2, vs.tau, 0],
        vs.inf_mat_ss[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
...
def calc_infiltration_ss_transport_iso_kernel(state):
    ...
    vs.C_inf_pf_ss = update(
        vs.C_inf_pf_ss,
        at[2:-2, 2:-2],
        npx.where(vs.inf_pf_ss[2:-2, 2:-2] > 0, vs.C_in[2:-2, 2:-2], 0) * vs.maskCatch[2:-2, 2:-2],
    )
    vs.C_iso_inf_pf_ss = update(
        vs.C_iso_inf_pf_ss,
        at[2:-2, 2:-2],
        transport.conc_to_delta(state, vs.C_inf_pf_ss)[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    # travel time distribution
    vs.tt_inf_pf_ss = update(
        vs.tt_inf_pf_ss,
        at[2:-2, 2:-2, 0],
        npx.where(vs.inf_pf_ss[2:-2, 2:-2] > 0, 1, 0) * vs.maskCatch[2:-2, 2:-2],
    )
    # isotope travel time distribution
    ...
    vs.msa_ss = update(
        ...
        at[2:-2, 2:-2, vs.tau, :],
        npx.where(
            vs.inf_pf_ss[2:-2, 2:-2, npx.newaxis] * vs.tt_inf_pf_ss[2:-2, 2:-2, :] + vs.sa_ss[2:-2, 2:-2, vs.tau, :]
            > 0,
            vs.msa_ss[2:-2, 2:-2, vs.tau, :]
            * (
                vs.sa_ss[2:-2, 2:-2, vs.tau, :]
                / (
                    vs.tt_inf_pf_ss[2:-2, 2:-2, :] * vs.inf_pf_ss[2:-2, 2:-2, npx.newaxis]
                    + vs.sa_ss[2:-2, 2:-2, vs.tau, :]
                )
            )
            + vs.mtt_inf_pf_ss[2:-2, 2:-2, :]
            * (
                (vs.tt_inf_pf_ss[2:-2, 2:-2, :] * vs.inf_pf_ss[2:-2, 2:-2, npx.newaxis])
                / (
                    vs.inf_pf_ss[2:-2, 2:-2, npx.newaxis] * vs.tt_inf_pf_ss[2:-2, 2:-2, :]
                    + vs.sa_ss[2:-2, 2:-2, vs.tau, :]
                )
            ),
            vs.msa_ss[2:-2, 2:-2, vs.tau, :],
    ...
    vs.sa_ss = update_add(
        vs.sa_ss,
        at[2:-2, 2:-2, vs.tau, 0],
        vs.inf_pf_ss[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )

    return KernelOutput(
        sa_ss=vs.sa_ss,
        msa_ss=vs.msa_ss,
        C_inf_pf_ss=vs.C_inf_pf_ss,
        C_iso_inf_pf_ss=vs.C_iso_inf_pf_ss,
        tt_inf_pf_ss=vs.tt_inf_pf_ss,
        mtt_inf_pf_ss=vs.mtt_inf_pf_ss,
    )
...
def calc_infiltration_ss_transport_anion_kernel(state):
    ...
    vs.mtt_inf_pf_ss = update(
        vs.mtt_inf_pf_ss,
        at[2:-2, 2:-2, 0],
        vs.inf_pf_ss[2:-2, 2:-2] * vs.C_in[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    # solute mass of infiltration
    vs.M_inf_pf_ss = update(
        vs.C_inf_pf_ss,
        at[2:-2, 2:-2],
        vs.C_inf_pf_ss[2:-2, 2:-2] * vs.inf_pf_ss[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )
    # update StorAge
    vs.sa_ss = update_add(
        vs.sa_ss,
    ...
    vs.msa_ss = update_add(
        vs.msa_ss,
        at[2:-2, 2:-2, vs.tau, 0],
        vs.M_inf_pf_ss[2:-2, 2:-2] * vs.maskCatch[2:-2, 2:-2],
    )

...
class DISTGROUNDWATERTRANSPORTSetup(RogerSetup):
    """A distributed transport model including shallow groundwater.
    """
    ...
    def set_settings(self, state):
        ...
        settings.identifier = "DISTGROUNDWATERTRANSPORT"
    ...
    def set_parameters(self, state):
        ...
        if settings.tm_structure == "complete-mixing":
            ...
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 0], 1)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 0], 1)
            vs.sas_params_q_re = update(vs.sas_params_q_re, at[2:-2, 2:-2, 0], 1)
            vs.sas_params_q_gw = update(vs.sas_params_q_gw, at[2:-2, 2:-2, 0], 1)
            vs.sas_params_q_leak = update(vs.sas_params_q_leak, at[2:-2, 2:-2, 0], 1)
            ...
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 0], 22)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 0], 22)
            vs.sas_params_q_re = update(vs.sas_params_q_re, at[2:-2, 2:-2, 0], 22)
            vs.sas_params_q_gw = update(vs.sas_params_q_gw, at[2:-2, 2:-2, 0], 22)
            vs.sas_params_q_leak = update(vs.sas_params_q_leak, at[2:-2, 2:-2, 0], 22)
            ...
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 0], self._read_var_from_nc("sas_function", 'sas_parameters_q_sub_rz.nc'))
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 1], self._read_var_from_nc("a", 'sas_parameters_q_sub_rz.nc'))
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 2], self._read_var_from_nc("b", 'sas_parameters_q_sub_rz.nc'))
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 0], self._read_var_from_nc("sas_function", 'sas_parameters_q_sub_ss.nc'))
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 1], self._read_var_from_nc("a", 'sas_parameters_q_sub_ss.nc'))
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 2], self._read_var_from_nc("b", 'sas_parameters_q_sub_ss.nc'))
            vs.sas_params_q_re = update(vs.sas_params_q_re, at[2:-2, 2:-2, 0], self._read_var_from_nc("sas_function", 'sas_parameters_q_re.nc'))
            vs.sas_params_q_re = update(vs.sas_params_q_re, at[2:-2, 2:-2, 1], self._read_var_from_nc("a", 'sas_parameters_q_re.nc'))
            vs.sas_params_q_re = update(vs.sas_params_q_re, at[2:-2, 2:-2, 2], self._read_var_from_nc("b", 'sas_parameters_q_re.nc'))
            vs.sas_params_q_gw = update(vs.sas_params_q_gw, at[2:-2, 2:-2, 0], self._read_var_from_nc("sas_function", 'sas_parameters_q_gw.nc'))
            vs.sas_params_q_gw = update(vs.sas_params_q_gw, at[2:-2, 2:-2, 1], self._read_var_from_nc("a", 'sas_parameters_q_gw.nc'))
            vs.sas_params_q_gw = update(vs.sas_params_q_gw, at[2:-2, 2:-2, 2], self._read_var_from_nc("b", 'sas_parameters_q_gw.nc'))
            vs.sas_params_q_leak = update(vs.sas_params_q_leak, at[2:-2, 2:-2, 0], self._read_var_from_nc("sas_function", 'sas_parameters_q_leak.nc'))
            vs.sas_params_q_leak = update(vs.sas_params_q_leak, at[2:-2, 2:-2, 1], self._read_var_from_nc("a", 'sas_parameters_q_leak.nc'))
            vs.sas_params_q_leak = update(vs.sas_params_q_leak, at[2:-2, 2:-2, 2], self._read_var_from_nc("b", 'sas_parameters_q_leak.nc'))
            ...
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 0], self._read_var_from_nc("sas_function", 'sas_parameters_q_sub_rz.nc'))
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 3], self._read_var_from_nc("lower_limit", 'sas_parameters_q_sub_rz.nc'))
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 4], self._read_var_from_nc("upper_limit", 'sas_parameters_q_sub_rz.nc'))
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 5], 0)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 6], vs.S_sat_rz - vs.S_pwp_rz)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 0], self._read_var_from_nc("sas_function", 'sas_parameters_q_sub_ss.nc'))
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 3], self._read_var_from_nc("lower_limit", 'sas_parameters_q_sub_ss.nc'))
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 4], self._read_var_from_nc("upper_limit", 'sas_parameters_q_sub_ss.nc'))
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 5], 0)
    ...
    def set_initial_conditions(self, state):
        ...
        vs.SA_vad = update(
            vs.SA_vad,
            at[2:-2, 2:-2, :, 1:], npx.cumsum(vs.sa_vad, axis=3),
        )
        vs.sa_gw = update(
            vs.sa_gw,
        ...
        vs.SA_gw = update(
            vs.SA_gw,
            at[2:-2, 2:-2, :, 1:], npx.cumsum(vs.sa_gw, axis=3),
        )
        ...
        if (settings.enable_bromide | settings.enable_chloride):
            ...
            vs.M_vad = update(
                vs.M_vad,
                at[2:-2, 2:-2, :], npx.sum(vs.msa_vad, axis=-1),
            )
            vs.msa_gw = update(
                vs.msa_gw,
            ...
            vs.M_gw = update(
                vs.M_gw,
                at[2:-2, 2:-2, :], npx.sum(vs.msa_gw, axis=-1),
            )
    ...
    def set_forcing(self, state):
        ...
        if (vs.itt == 0):
            ...
            vs.CPR_RZ = update(vs.CPR_RZ, at[2:-2, 2:-2, :], self._read_var_from_nc("cpr_rz", 'states_hm.nc'))
            vs.CPR_SS = update(vs.CPR_SS, at[2:-2, 2:-2, :], self._read_var_from_nc("cpr_ss", 'states_hm.nc'))
            ...
            vs.Q_SUB_RZ = update(vs.Q_SUB_RZ, at[2:-2, 2:-2, :], self._read_var_from_nc("q_sub_rz", 'states_hm.nc'))
            vs.Q_SUB_SS = update(vs.Q_SUB_SS, at[2:-2, 2:-2, :], self._read_var_from_nc("q_sub_ss", 'states_hm.nc'))
            vs.Q_RE = update(vs.Q_RE, at[2:-2, 2:-2, :], self._read_var_from_nc("q_re", 'states_hm.nc'))
            vs.Q_GW = update(vs.Q_GW, at[2:-2, 2:-2, :], self._read_var_from_nc("q_gw", 'states_hm.nc'))
            vs.Q_LEAK = update(vs.Q_LEAK, at[2:-2, 2:-2, :], self._read_var_from_nc("q_leak", 'states_hm.nc'))
    ...
    def set_diagnostics(self, state):
        ...
        diagnostics["averages"].output_variables = ["C_rz", "C_ss", "C_vad", "C_gw"]
...
def set_states_kernel(state):
    ...
    vs.cpr_ss = update(vs.cpr_ss, at[2:-2, 2:-2], vs.CPR_SS[2:-2, 2:-2, vs.itt])
    vs.q_sub_rz = update(vs.q_sub_rz, at[2:-2, 2:-2], vs.Q_SUB_RZ[2:-2, 2:-2, vs.itt])
    vs.q_sub_ss = update(vs.q_sub_ss, at[2:-2, 2:-2], vs.Q_SUB_SS[2:-2, 2:-2, vs.itt])
    vs.q_re = update(vs.q_re, at[2:-2, 2:-2], vs.Q_RE[2:-2, 2:-2, vs.itt])
    vs.q_gw = update(vs.q_gw, at[2:-2, 2:-2], vs.Q_GW[2:-2, 2:-2, vs.itt])
    vs.q_leak = update(vs.q_leak, at[2:-2, 2:-2], vs.Q_LEAK[2:-2, 2:-2, vs.itt])
    ...
    vs.S_vad = update(vs.S_vad, at[2:-2, 2:-2, vs.tau], vs.S_VAD[2:-2, 2:-2, vs.itt])
    vs.S_gw = update(vs.S_gw, at[2:-2, 2:-2, vs.tau], vs.S_GW[2:-2, 2:-2, vs.itt])
...
def after_timestep_kernel(state):
    ...
    vs.SA_vad = update(
        vs.SA_vad,
        at[2:-2, 2:-2, vs.taum1, :], vs.SA_vad[2:-2, 2:-2, vs.tau, :],
    )
    vs.sa_vad = update(
        vs.sa_vad,
        at[2:-2, 2:-2, vs.taum1, :], vs.sa_vad[2:-2, 2:-2, vs.tau, :],
    ...
    vs.MSA_vad = update(
        vs.MSA_vad,
        at[2:-2, 2:-2, vs.taum1, :], vs.MSA_vad[2:-2, 2:-2, vs.tau, :],
    )
    vs.msa_vad = update(
        vs.msa_vad,
        at[2:-2, 2:-2, vs.taum1, :], vs.msa_vad[2:-2, 2:-2, vs.tau, :],
    ...
    vs.M_vad = update(
        vs.M_vad,
        at[2:-2, 2:-2, vs.taum1], vs.M_vad[2:-2, 2:-2, vs.tau],
    )
    vs.C_vad = update(
        vs.C_vad,
        at[2:-2, 2:-2, vs.taum1], vs.C_vad[2:-2, 2:-2, vs.tau],
    )
    vs.SA_gw = update(
        vs.SA_gw,
        at[2:-2, 2:-2, vs.taum1, :], vs.SA_gw[2:-2, 2:-2, vs.tau, :],
    )
    vs.sa_gw = update(
        vs.sa_gw,
        at[2:-2, 2:-2, vs.taum1, :], vs.sa_gw[2:-2, 2:-2, vs.tau, :],
    ...
    vs.MSA_gw = update(
        vs.MSA_gw,
        at[2:-2, 2:-2, vs.taum1, :], vs.MSA_gw[2:-2, 2:-2, vs.tau, :],
    )
    vs.msa_gw = update(
        vs.msa_gw,
        at[2:-2, 2:-2, vs.taum1, :], vs.msa_gw[2:-2, 2:-2, vs.tau, :],
    ...
    vs.M_gw = update(
        vs.M_gw,
        at[2:-2, 2:-2, vs.taum1], vs.M_gw[2:-2, 2:-2, vs.tau],
    )
    vs.C_gw = update(
        vs.C_gw,
        at[2:-2, 2:-2, vs.taum1], vs.C_gw[2:-2, 2:-2, vs.tau],
    )

...
class ONEDCROPTRANSPORTSetup(RogerSetup):
    ...
    def set_settings(self, state):
        ...
        settings.identifier = "ONEDCROPTRANSPORT"
    ...
    def set_parameters_setup(self, state):
        ...
        if settings.tm_structure == "complete-mixing":
            ...
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 0], 3)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 1], 1)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 2], 3)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 0], 3)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 1], 1)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 2], 2)
            ...
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 0], 3)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 1], 2)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 2], 1)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 0], 3)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 1], 3)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 2], 1)
            ...
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 0], 32)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 3], 1)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 4], 2)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 5], 0)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 6], vs.S_sat_rz[2:-2, 2:-2] - vs.S_pwp_rz[2:-2, 2:-2])
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 0], 32)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 3], 1)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 4], 3)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 5], 0)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 6], vs.S_sat_ss[2:-2, 2:-2] - vs.S_pwp_ss[2:-2, 2:-2])
            ...
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 5], 0)
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 6], vs.S_sat_ss[2:-2, 2:-2] - vs.S_pwp_ss[2:-2, 2:-2])
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 0], 31)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 3], 1)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 4], 3)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 5], 0)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 6], vs.S_sat_rz[2:-2, 2:-2] - vs.S_pwp_rz[2:-2, 2:-2])
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 0], 31)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 3], 1)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 4], 2)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 5], 0)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 6], vs.S_sat_ss[2:-2, 2:-2] - vs.S_pwp_ss[2:-2, 2:-2])
            ...
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 5], 0)
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 6], vs.S_sat_ss[2:-2, 2:-2] - vs.S_pwp_ss[2:-2, 2:-2])
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 0], 35)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 3], 1)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 4], 3)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 5], 0)
            vs.sas_params_q_sub_rz = update(vs.sas_params_q_sub_rz, at[2:-2, 2:-2, 6], vs.S_sat_rz[2:-2, 2:-2] - vs.S_pwp_rz[2:-2, 2:-2])
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 0], 35)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 3], 1)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 4], 2)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 5], 0)
            vs.sas_params_q_sub_ss = update(vs.sas_params_q_sub_ss, at[2:-2, 2:-2, 6], vs.S_sat_ss[2:-2, 2:-2] - vs.S_pwp_ss[2:-2, 2:-2])
    ...
    def set_forcing_setup(self, state):
        ...
        vs.Q_SUB_RZ = update(vs.Q_SUB_RZ, at[2:-2, 2:-2, :], self._read_var_from_nc("q_sub_rz", self._base_path, 'states_hm.nc'))
        vs.Q_SUB_SS = update(vs.Q_SUB_SS, at[2:-2, 2:-2, :], self._read_var_from_nc("q_sub_ss", self._base_path, 'states_hm.nc'))

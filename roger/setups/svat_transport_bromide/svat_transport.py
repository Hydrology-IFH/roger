...
class SVATTRANSPORTSetup(RogerSetup):
    ...
    def set_forcing_setup(self, state):
        ...
        vs.INF_PF_RZ = update(vs.INF_PF_RZ, at[2:-2, 2:-2, :], self._read_var_from_nc("inf_mp_rz", self._base_path, 'states_hm.nc') + self._read_var_from_nc("inf_sc_rz", self._base_path / self._base_path, 'states_hm.nc'))

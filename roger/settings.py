...
SETTINGS = {
    ...
    "ncrops_to_optimize": Setting(1, int, "Number of crops to optimize"),
    ...
    "enable_soil_compaction": Setting(False, bool, "enable soil compaction"),
    "enable_time_variant_macropores": Setting(False, bool, "enable time variant macropores"),

...
SETTINGS = {
    ...
    "hpi": Setting(5, int, "threshold for classification of heavy precipitation event in mm/10min"),
    ...
    "sas_solver_substeps": Setting(3, int, "substeps to solver for StorAge selection numerically"),

...
from roger.tools.filelock import FileLock
from roger import logger, runtime_state


ASSET_DIRECTORY = os.environ.get("ROGER_ASSET_DIR") or os.path.join(os.path.expanduser("~"), ".roger", "assets")
...
def get_assets(asset_id, asset_file, skip_md5=False):
    ...
    By default, assets are stored in ``$HOME/.roger/assets`` (can be overwritten by setting
    ``ROGER_ASSET_DIR`` environment variable to the desired location).
    ...
    Example:
       ...
       >>> assets['forcing']
       "/home/user/.roger/assets/mysetup/mysetup_forcing.h5",
           "initial_conditions": "/home/user/.roger/assets/mysetup/initial.h5"
       }
    ...
    In this case, ``assets.json`` contains::
        ...
        {
            "forcing": {
                "url": "https://mywebsite.com/roger_assets/mysetup_forcing.h5",
                "md5": "ef3be0a58782771c8ee5a6d0206b87f6"
            },

            "initial_conditions": {
                "url": "https://mywebsite.com/roger_assets/initial.h5",

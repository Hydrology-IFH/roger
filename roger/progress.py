...
from roger import logger, time, logs, runtime_settings as rs, runtime_state as rst
...
class FancyProgressBar:
    ...
    def __init__(self, total, start_time=0, start_iteration=0, time_unit="seconds"):
        ...
        self._pbar = _RogerTQDM(file=sys.stdout, bar_format=BAR_FORMAT)

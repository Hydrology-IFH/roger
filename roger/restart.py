...
from roger import logger, runtime_settings, runtime_state
from roger.io_tools import hdf5 as h5tools
from roger.signals import do_not_disturb
from roger.distributed import get_chunk_slices
from roger.variables import get_shape
...
def write_to_h5(dimensions, var_meta, var_data, outfile, groupname, attributes=None):
    ...
    for key, var in var_data.items():
        ...
        gidx, lidx = get_chunk_slices(dimensions["x"], dimensions["y"], var_dims, include_overlap=True)

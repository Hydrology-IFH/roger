...
states_hm_file = base_path / "oneD_distributed" / "states_hm.nc"
...
states_tm_file = base_path / "oneD_oxygen18_distributed" / "states_power.nc"
...
axes[0, 0].set_xticks(onp.arange(-0.5, 11, 5))
axes[0, 0].set_yticks(onp.arange(-0.5, 23, 5))
...
axes[0, 1].set_xticks(onp.arange(-0.5, 11, 5))
axes[0, 1].set_yticks(onp.arange(-0.5, 23, 5))
...
cb1 = mpl.colorbar.ColorbarBase(axl1, cmap=cmap, norm=norm, orientation="vertical", ticks=[0.2, 0.3, 0.4])
...
axes[1, 0].set_xticks(onp.arange(-0.5, 11, 5))
axes[1, 0].set_yticks(onp.arange(-0.5, 23, 5))
...
axes[1, 1].set_xticks(onp.arange(-0.5, 11, 5))
axes[1, 1].set_yticks(onp.arange(-0.5, 23, 5))
...
cb2 = mpl.colorbar.ColorbarBase(axl2, cmap=cmap, norm=norm, orientation="vertical", ticks=[100, 300, 600, 900])
...
axes[1, 2].fill_between(
    date_tm,
    ds_tm["tt25_transp"].isel(x=0, y=0).values,
    ds_tm["tt75_transp"].isel(x=0, y=0).values,
    color="#31a354",
    edgecolor=None,
    alpha=0.2,
)
...
axes[2, 2].fill_between(
    date_tm,
    ds_tm["rt25_s"].isel(x=0, y=0).values,
    ds_tm["rt75_s"].isel(x=0, y=0).values,
    color="brown",
    edgecolor=None,
    alpha=0.2,
)
...
axes[3, 2].fill_between(
    date_tm,
    ds_tm["tt25_q_ss"].isel(x=0, y=0).values,
    ds_tm["tt75_q_ss"].isel(x=0, y=0).values,
    color="grey",
    edgecolor=None,
    alpha=0.2,
)
...
axes[0, 1].hist(
    ds_tm["C_iso_evap_soil"].isel(Time=770).values.flatten(), color="#c2e699", bins=24, range=(-12, -6), align="mid"
)
axes[0, 1].set_xlabel(r"$\delta^{18}$O [‰]")

axes[1, 1].hist(
    ds_tm["C_iso_transp"].isel(Time=770).values.flatten(), color="#31a354", bins=24, range=(-12, -6), align="mid"
)
...
axes[3, 1].hist(
    ds_tm["C_iso_q_ss"].isel(Time=770).values.flatten(), color="grey", bins=24, range=(-12, -6), align="mid"
)
...
axes[1, 2].hist(
    ds_tm["tt50_transp"].isel(Time=770).values.flatten(), color="#31a354", bins=50, range=(0, 600), align="mid"
)
...
fig, axes = plt.subplots(4, 3, figsize=(6, 5))
axes[0, 0].hist(
    ds_hm["evap_soil"].isel(Time=770).values.flatten(), color="#253494", bins=10, range=(0, 1), align="mid", alpha=0.5
)
axes[0, 0].hist(
    ds_hm["evap_soil"].isel(Time=1006).values.flatten(), color="#fd8d3c", bins=10, range=(0, 1), align="mid", alpha=0.5
)
axes[0, 0].set_xlabel(r"$EVAP_{soil}$ [mm/day]")
axes[0, 0].set_ylabel("# grid cells")
axes[0, 0].text(
...
axes[1, 0].hist(
    ds_hm["transp"].isel(Time=770).values.flatten(), color="#253494", bins=40, range=(0, 4), align="mid", alpha=0.5
)
axes[1, 0].hist(
    ds_hm["transp"].isel(Time=1006).values.flatten(), color="#fd8d3c", bins=40, range=(0, 4), align="mid", alpha=0.5
)
axes[1, 0].set_xlabel(r"$TRANSP$ [mm/day]")
axes[1, 0].set_ylabel("# grid cells")
axes[1, 0].text(
...
axes[2, 0].hist(
    ds_hm["theta"].isel(Time=770).values.flatten(), color="#253494", bins=20, range=(0.2, 0.4), align="mid", alpha=0.5
)
axes[2, 0].hist(
    ds_hm["theta"].isel(Time=1006).values.flatten(), color="#fd8d3c", bins=20, range=(0.2, 0.4), align="mid", alpha=0.5
)
axes[2, 0].set_xlabel(r"$\theta$ [-]")
axes[2, 0].set_ylabel("# grid cells")
axes[2, 0].text(
...
axes[3, 0].hist(
    ds_hm["q_ss"].isel(Time=770).values.flatten(), color="#253494", bins=30, range=(0, 15), align="mid", alpha=0.5
)
axes[3, 0].hist(
    ds_hm["q_ss"].isel(Time=1006).values.flatten(), color="#fd8d3c", bins=30, range=(0, 15), align="mid", alpha=0.5
)
axes[3, 0].set_xlabel(r"$PERC$ [mm/day]")
axes[3, 0].set_ylabel("# grid cells")
axes[3, 0].text(
...
axes[0, 1].hist(
    ds_tm["C_iso_evap_soil"].isel(Time=770).values.flatten(),
    color="#253494",
    bins=24,
    range=(-12, -6),
    align="mid",
...
axes[0, 1].hist(
    ds_tm["C_iso_evap_soil"].isel(Time=1006).values.flatten(),
    color="#fd8d3c",
    bins=24,
    range=(-12, -6),
    align="mid",
...
axes[1, 1].hist(
    ds_tm["C_iso_transp"].isel(Time=770).values.flatten(),
    color="#253494",
    bins=24,
    range=(-12, -6),
    align="mid",
...
axes[1, 1].hist(
    ds_tm["C_iso_transp"].isel(Time=1006).values.flatten(),
    color="#fd8d3c",
    bins=24,
    range=(-12, -6),
    align="mid",
...
axes[2, 1].hist(
    ds_tm["C_iso_s"].isel(Time=770).values.flatten(), color="#253494", bins=24, range=(-12, -6), align="mid", alpha=0.5
)
axes[2, 1].hist(
    ds_tm["C_iso_s"].isel(Time=1006).values.flatten(), color="#fd8d3c", bins=24, range=(-12, -6), align="mid", alpha=0.5
)
...
axes[3, 1].hist(
    ds_tm["C_iso_q_ss"].isel(Time=770).values.flatten(),
    color="#253494",
    bins=24,
    range=(-12, -6),
    align="mid",
...
axes[3, 1].hist(
    ds_tm["C_iso_q_ss"].isel(Time=1006).values.flatten(),
    color="#fd8d3c",
    bins=24,
    range=(-12, -6),
    align="mid",
...
axes[1, 2].hist(
    ds_tm["tt50_transp"].isel(Time=770).values.flatten(),
    color="#253494",
    bins=50,
    range=(0, 600),
    align="mid",
    alpha=0.5,
    label=r"wet condtions ($9^{th}$ Dec 2021)",
)
axes[1, 2].hist(
    ds_tm["tt50_transp"].isel(Time=1006).values.flatten(),
    color="#fd8d3c",
    bins=50,
    range=(0, 600),
    align="mid",
    alpha=0.5,
    label=r"dry condtions ($8^{th}$ Aug 2022)",
)
axes[1, 2].set_xlabel(r"$TT_{50-TRANSP}$ [days]")
...
axes[2, 2].hist(
    ds_tm["rt50_s"].isel(Time=770).values.flatten(), color="#253494", bins=50, range=(0, 600), align="mid", alpha=0.5
)
axes[2, 2].hist(
    ds_tm["rt50_s"].isel(Time=1006).values.flatten(), color="#fd8d3c", bins=50, range=(0, 600), align="mid", alpha=0.5
)
axes[2, 2].set_xlabel(r"$RT_{50-\theta}$ [days]")
axes[2, 2].text(
    0.95,
...
axes[3, 2].hist(
    ds_tm["tt50_q_ss"].isel(Time=770).values.flatten(), color="#253494", bins=50, range=(0, 600), align="mid", alpha=0.5
)
axes[3, 2].hist(
    ds_tm["tt50_q_ss"].isel(Time=1006).values.flatten(),
    color="#fd8d3c",
    bins=50,
    range=(0, 600),
    align="mid",
...
fig, axes = plt.subplots(4, 3, figsize=(6, 5))
axes[0, 0].hist(
    ds_hm["evap_soil"].isel(Time=770).values.flatten(),
    color="#253494",
    bins=50,
    range=(0, 1),
    histtype="step",
...
axes[0, 0].hist(
    ds_hm["evap_soil"].isel(Time=340).values.flatten(),
    color="#41b6c4",
    bins=50,
    range=(0, 1),
    histtype="step",
...
axes[0, 0].hist(
    ds_hm["evap_soil"].isel(Time=1006).values.flatten(),
    color="#fd8d3c",
    bins=50,
    range=(0, 1),
    histtype="step",
...
axes[1, 0].hist(
    ds_hm["transp"].isel(Time=770).values.flatten(),
    color="#253494",
    bins=40,
    range=(0, 4),
    histtype="step",
...
axes[1, 0].hist(
    ds_hm["transp"].isel(Time=340).values.flatten(),
    color="#41b6c4",
    bins=40,
    range=(0, 4),
    histtype="step",
...
axes[1, 0].hist(
    ds_hm["transp"].isel(Time=150).values.flatten(),
    color="#fed976",
    bins=40,
    range=(0, 4),
    histtype="step",
...
axes[1, 0].hist(
    ds_hm["transp"].isel(Time=1006).values.flatten(),
    color="#fd8d3c",
    bins=40,
    range=(0, 4),
    histtype="step",
...
axes[2, 0].hist(
    ds_hm["theta"].isel(Time=770).values.flatten(),
    color="#253494",
    bins=40,
    range=(0.2, 0.4),
    histtype="step",
...
axes[2, 0].hist(
    ds_hm["theta"].isel(Time=340).values.flatten(),
    color="#41b6c4",
    bins=40,
    range=(0.2, 0.4),
    histtype="step",
...
axes[2, 0].hist(
    ds_hm["theta"].isel(Time=150).values.flatten(),
    color="#fed976",
    bins=40,
    range=(0.2, 0.4),
    histtype="step",
...
axes[2, 0].hist(
    ds_hm["theta"].isel(Time=1006).values.flatten(),
    color="#fd8d3c",
    bins=40,
    range=(0.2, 0.4),
    histtype="step",
...
axes[3, 0].hist(
    ds_hm["q_ss"].isel(Time=770).values.flatten(),
    color="#253494",
    bins=60,
    range=(0, 15),
    histtype="step",
...
axes[3, 0].hist(
    ds_hm["q_ss"].isel(Time=340).values.flatten(),
    color="#41b6c4",
    bins=60,
    range=(0, 15),
    histtype="step",
...
axes[3, 0].hist(
    ds_hm["q_ss"].isel(Time=150).values.flatten(),
    color="#fed976",
    bins=60,
    range=(0, 15),
    histtype="step",
...
axes[3, 0].hist(
    ds_hm["q_ss"].isel(Time=1006).values.flatten(),
    color="#fd8d3c",
    bins=60,
    range=(0, 15),
    histtype="step",
...
axes[0, 1].hist(
    ds_tm["C_iso_evap_soil"].isel(Time=340).values.flatten(),
    color="#41b6c4",
    bins=60,
    range=(-12, -6),
    histtype="step",
...
axes[1, 1].hist(
    ds_tm["C_iso_transp"].isel(Time=340).values.flatten(),
    color="#41b6c4",
    bins=70,
    range=(-14, -7),
    histtype="step",
...
axes[1, 1].hist(
    ds_tm["C_iso_transp"].isel(Time=150).values.flatten(),
    color="#fed976",
    bins=70,
    range=(-14, -7),
    histtype="step",
...
axes[2, 1].hist(
    ds_tm["C_iso_s"].isel(Time=770).values.flatten(),
    color="#253494",
    bins=40,
    range=(-12, -8),
    histtype="step",
...
axes[2, 1].hist(
    ds_tm["C_iso_s"].isel(Time=340).values.flatten(),
    color="#41b6c4",
    bins=40,
    range=(-12, -8),
    histtype="step",
...
axes[2, 1].hist(
    ds_tm["C_iso_s"].isel(Time=150).values.flatten(),
    color="#fed976",
    bins=40,
    range=(-12, -8),
    histtype="step",
...
axes[2, 1].hist(
    ds_tm["C_iso_s"].isel(Time=1006).values.flatten(),
    color="#fd8d3c",
    bins=40,
    range=(-12, -8),
    histtype="step",
...
axes[3, 1].hist(
    ds_tm["C_iso_q_ss"].isel(Time=340).values.flatten(),
    color="#41b6c4",
    bins=60,
    range=(-12, -6),
    histtype="step",
...
axes[3, 1].hist(
    ds_tm["C_iso_q_ss"].isel(Time=150).values.flatten(),
    color="#fed976",
    bins=60,
    range=(-12, -6),
    histtype="step",
...
axes[1, 2].hist(
    ds_tm["tt50_transp"].isel(Time=340).values.flatten(),
    color="#41b6c4",
    bins=50,
    range=(0, 50),
    histtype="step",
...
axes[1, 2].hist(
    ds_tm["tt50_transp"].isel(Time=150).values.flatten(),
    color="#fed976",
    bins=50,
    range=(0, 50),
    histtype="step",
...
axes[2, 2].hist(
    ds_tm["rt50_s"].isel(Time=770).values.flatten(),
    color="#253494",
    bins=600,
    range=(0, 600),
    histtype="step",
...
axes[2, 2].hist(
    ds_tm["rt50_s"].isel(Time=340).values.flatten(),
    color="#41b6c4",
    bins=600,
    range=(0, 600),
    histtype="step",
...
axes[2, 2].hist(
    ds_tm["rt50_s"].isel(Time=150).values.flatten(),
    color="#fed976",
    bins=600,
    range=(0, 600),
    histtype="step",
...
axes[2, 2].hist(
    ds_tm["rt50_s"].isel(Time=1006).values.flatten(),
    color="#fd8d3c",
    bins=600,
    range=(0, 600),
    histtype="step",
...
axes[3, 2].hist(
    ds_tm["tt50_q_ss"].isel(Time=770).values.flatten(),
    color="#253494",
    bins=800,
    range=(0, 800),
    histtype="step",
...
axes[3, 2].hist(
    ds_tm["tt50_q_ss"].isel(Time=340).values.flatten(),
    color="#41b6c4",
    bins=800,
    range=(0, 800),
    histtype="step",
...
axes[3, 2].hist(
    ds_tm["tt50_q_ss"].isel(Time=150).values.flatten(),
    color="#fed976",
    bins=800,
    range=(0, 800),
    histtype="step",
...
params_file = base_path / "oneD_distributed" / "parameters.nc"
...
axes.set_xticks(onp.arange(-0.5, 11, 5))
axes.set_yticks(onp.arange(-0.5, 23, 5))
...
cb1 = mpl.colorbar.ColorbarBase(axl1, cmap=cmap, norm=norm, orientation="vertical", ticks=[5, 10, 15])
...
cb1 = mpl.colorbar.ColorbarBase(axl1, cmap=cmap, norm=norm, orientation="vertical", ticks=[50, 75, 100])
...
axl1 = fig.add_axes([0.7, 0.2, 0.04, 0.74])
cb1 = mpl.colorbar.ColorbarBase(axl1, cmap=cmap, norm=norm, orientation="vertical", ticks=[200, 350, 500])
...
axl1 = fig.add_axes([0.745, 0.2, 0.04, 0.72])
cb1 = mpl.colorbar.ColorbarBase(axl1, cmap=cmap, norm=norm, orientation="vertical", ticks=[1, 1.1, 1.2])
...
axl1 = fig.add_axes([0.7, 0.2, 0.04, 0.74])
cb1 = mpl.colorbar.ColorbarBase(axl1, cmap=cmap, norm=norm, orientation="vertical", ticks=[0.08, 0.1, 0.12])
...
axl1 = fig.add_axes([0.7, 0.2, 0.04, 0.74])
cb1 = mpl.colorbar.ColorbarBase(axl1, cmap=cmap, norm=norm, orientation="vertical", ticks=[0.18, 0.2, 0.22])

...
axes[0, 0].set_xlabel(r'$EVAP_{soil}$ [mm/day]')
axes[0, 0].set_ylabel('# grid cells')
axes[0, 0].text(0.95, 1.09, '(a)', fontsize=7, horizontalalignment='center',
...
axes[1, 0].set_xlabel(r'$TRANSP$ [mm/day]')
axes[1, 0].set_ylabel('# grid cells')
axes[1, 0].text(0.95, 1.09, '(b)', fontsize=7, horizontalalignment='center',
...
axes[2, 0].set_xlabel(r'$\theta$ [-]')
axes[2, 0].set_ylabel('# grid cells')
axes[2, 0].text(0.95, 1.09, '(c)', fontsize=7, horizontalalignment='center',
...
axes[3, 0].set_xlabel(r'$PERC$ [mm/day]')
axes[3, 0].set_ylabel('# grid cells')
axes[3, 0].text(0.95, 1.09, '(d)', fontsize=7, horizontalalignment='center',
...
axes[0, 1].text(0.95, 1.09, '(e)', fontsize=7, horizontalalignment='center',
...
axes[1, 1].text(0.95, 1.09, '(f)', fontsize=7, horizontalalignment='center',
...
axes[2, 1].text(0.95, 1.09, '(g)', fontsize=7, horizontalalignment='center',
...
axes[3, 1].text(0.95, 1.09, '(h)', fontsize=7, horizontalalignment='center',
...
axes[1, 2].text(0.95, 1.09, '(i)', fontsize=7, horizontalalignment='center',
...
axes[2, 2].set_xlabel(r'$RT_{50-\theta}$ [days]')
axes[2, 2].text(0.95, 1.09, '(j)', fontsize=7, horizontalalignment='center',
...
axes[3, 2].set_xlabel(r'$TT_{50-PERC}$ [days]')
axes[3, 2].text(0.95, 1.09, '(k)', fontsize=7, horizontalalignment='center',
...
axes[1, 2].text(0.95, 1.09, '(i)', fontsize=7, horizontalalignment='center',
                verticalalignment='center', transform=axes[1, 2].transAxes)
axes[1, 2].plot([], [], color='#fed976', label=r'transition to dry condtions ($29^{th}$ Mar 2020)')
axes[1, 2].plot([], [], color='#fd8d3c', label=r'dry condtions ($8^{th}$ Aug 2022)')
axes[1, 2].plot([], [], color='#41b6c4', label=r'transition to wet condtions ($5^{th}$ Oct 2020)')
axes[1, 2].plot([], [], color='#253494', label=r'wet condtions ($9^{th}$ Dec 2021)')
lines, labels = axes[1, 2].get_legend_handles_labels()
fig.legend(lines, labels, loc='upper right', frameon=False, bbox_to_anchor=(1.0, 0.97))
...
inset = fig.add_axes([0.2, 0.135, 0.12, 0.07])

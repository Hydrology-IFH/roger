...
axes[1, 0].imshow(ds_tm['tt50_q_ss'].isel(Time=772).values.T, origin="lower", cmap='Purples_r', vmin=100, vmax=400)
...
axes[1, 1].imshow(ds_tm['tt50_q_ss'].isel(Time=1004).values.T, origin="lower", cmap='Purples_r', vmin=100, vmax=400)

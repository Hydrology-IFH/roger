...
fig, axes = plt.subplots(4, 3, figsize=(6, 5))
axes[0, 0].hist(ds_hm['evap_soil'].isel(Time=770).values.flatten(), color='#253494', bins=50, range=(0, 1), histtype='step', cumulative=True, lw=2.0)
axes[0, 0].hist(ds_hm['evap_soil'].isel(Time=340).values.flatten(), color='#41b6c4', bins=50, range=(0, 1), histtype='step', cumulative=True, lw=1.5, ls='-.')
axes[0, 0].hist(ds_hm['evap_soil'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=50, range=(0, 1), histtype='step', cumulative=True, lw=1.0, ls='--')
...
axes[1, 0].hist(ds_hm['transp'].isel(Time=770).values.flatten(), color='#253494', bins=40, range=(0, 4), histtype='step', cumulative=True, lw=2.0)
axes[1, 0].hist(ds_hm['transp'].isel(Time=340).values.flatten(), color='#41b6c4', bins=40, range=(0, 4), histtype='step', cumulative=True, lw=1.5, ls='-.')
axes[1, 0].hist(ds_hm['transp'].isel(Time=150).values.flatten(), color='#fed976', bins=40, range=(0, 4), histtype='step', cumulative=True, lw=1.0, ls='--')
axes[1, 0].hist(ds_hm['transp'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=40, range=(0, 4), histtype='step', cumulative=True, lw=0.5)
...
axes[2, 0].hist(ds_hm['theta'].isel(Time=770).values.flatten(), color='#253494', bins=40, range=(0.2, 0.4), histtype='step', cumulative=True, lw=2.0)
axes[2, 0].hist(ds_hm['theta'].isel(Time=340).values.flatten(), color='#41b6c4', bins=40, range=(0.2, 0.4), histtype='step', cumulative=True, lw=1.5, ls='-.')
axes[2, 0].hist(ds_hm['theta'].isel(Time=150).values.flatten(), color='#fed976', bins=40, range=(0.2, 0.4), histtype='step', cumulative=True, lw=1.0, ls='--')
axes[2, 0].hist(ds_hm['theta'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=40, range=(0.2, 0.4), histtype='step', cumulative=True, lw=0.5)
...
axes[3, 0].hist(ds_hm['q_ss'].isel(Time=770).values.flatten(), color='#253494', bins=60, range=(0, 15), histtype='step', cumulative=True, lw=2.0)
axes[3, 0].hist(ds_hm['q_ss'].isel(Time=340).values.flatten(), color='#41b6c4', bins=60, range=(0, 15), histtype='step', cumulative=True, lw=1.5, ls='-.')
axes[3, 0].hist(ds_hm['q_ss'].isel(Time=150).values.flatten(), color='#fed976', bins=60, range=(0, 15), histtype='step', cumulative=True, lw=1.0, ls='--')
axes[3, 0].hist(ds_hm['q_ss'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=60, range=(0, 15), histtype='step', cumulative=True, lw=0.5)
...
axes[0, 1].hist(ds_tm['C_iso_evap_soil'].isel(Time=770).values.flatten(), color='#253494', bins=60, range=(-12, -6), histtype='step', cumulative=True, lw=2.0)
axes[0, 1].hist(ds_tm['C_iso_evap_soil'].isel(Time=340).values.flatten(), color='#41b6c4', bins=60, range=(-12, -6), histtype='step', cumulative=True, lw=1.5, ls='-.')
axes[0, 1].hist(ds_tm['C_iso_evap_soil'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=60, range=(-12, -6), histtype='step', cumulative=True, lw=1.0, ls='--')
axes[0, 1].set_xlim(-12, -6)
axes[0, 1].set_xlabel(r'$\delta^{18}$$O_{EVAP_{soil}}$ [‰]')
axes[0, 1].text(0.95, 1.12, '(e)', fontsize=9, horizontalalignment='center',
                verticalalignment='center', transform=axes[0, 1].transAxes)

axes[1, 1].hist(ds_tm['C_iso_transp'].isel(Time=340).values.flatten(), color='#41b6c4', bins=70, range=(-14, -7), histtype='step', cumulative=True, lw=2.0, ls='-.')
axes[1, 1].hist(ds_tm['C_iso_transp'].isel(Time=770).values.flatten(), color='#253494', bins=70, range=(-14, -7), histtype='step', cumulative=True, lw=1.5)
axes[1, 1].hist(ds_tm['C_iso_transp'].isel(Time=150).values.flatten(), color='#fed976', bins=70, range=(-14, -7), histtype='step', cumulative=True, lw=1.0, ls='--')
axes[1, 1].hist(ds_tm['C_iso_transp'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=70, range=(-14, -7), histtype='step', cumulative=True, lw=0.5)
axes[1, 1].set_xlim(-14, -7)
axes[1, 1].set_xlabel(r'$\delta^{18}$$O_{TRANSP}$ [‰]')
axes[1, 1].text(0.95, 1.12, '(f)', fontsize=9, horizontalalignment='center',
                verticalalignment='center', transform=axes[1, 1].transAxes)

axes[2, 1].hist(ds_tm['C_iso_s'].isel(Time=770).values.flatten(), color='#253494', bins=40, range=(-12, -8), histtype='step', cumulative=True, lw=2.0)
axes[2, 1].hist(ds_tm['C_iso_s'].isel(Time=340).values.flatten(), color='#41b6c4', bins=40, range=(-12, -8), histtype='step', cumulative=True, lw=1.5, ls='-.')
axes[2, 1].hist(ds_tm['C_iso_s'].isel(Time=150).values.flatten(), color='#fed976', bins=40, range=(-12, -8), histtype='step', cumulative=True, lw=1.0, ls='--')
axes[2, 1].hist(ds_tm['C_iso_s'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=40, range=(-12, -8), histtype='step', cumulative=True, lw=0.5)
axes[2, 1].set_xlim(-12, -8)
axes[2, 1].set_xlabel(r'$\delta^{18}$$O_{\theta}$ [‰]')
axes[2, 1].text(0.95, 1.12, '(g)', fontsize=9, horizontalalignment='center',
                verticalalignment='center', transform=axes[2, 1].transAxes)

axes[3, 1].hist(ds_tm['C_iso_q_ss'].isel(Time=770).values.flatten(), color='#253494', bins=60, range=(-12, -6), histtype='step', cumulative=True, lw=2.0)
axes[3, 1].hist(ds_tm['C_iso_q_ss'].isel(Time=340).values.flatten(), color='#41b6c4', bins=60, range=(-12, -6), histtype='step', cumulative=True, lw=1.5, ls='-.')
axes[3, 1].hist(ds_tm['C_iso_q_ss'].isel(Time=150).values.flatten(), color='#fed976', bins=60, range=(-12, -6), histtype='step', cumulative=True, lw=1.0, ls='--')
axes[3, 1].hist(ds_tm['C_iso_q_ss'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=60, range=(-12, -6), histtype='step', cumulative=True, lw=0.5)
...
axes[1, 2].hist(ds_tm['tt50_transp'].isel(Time=770).values.flatten(), color='#253494', bins=50, range=(0, 50), histtype='step', cumulative=True, lw=2.0)
axes[1, 2].hist(ds_tm['tt50_transp'].isel(Time=340).values.flatten(), color='#41b6c4', bins=50, range=(0, 50), histtype='step', cumulative=True, lw=1.5, ls='-.')
axes[1, 2].hist(ds_tm['tt50_transp'].isel(Time=150).values.flatten(), color='#fed976', bins=50, range=(0, 50), histtype='step', cumulative=True, lw=1.0, ls='--')
axes[1, 2].hist(ds_tm['tt50_transp'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=50, range=(0, 50), histtype='step', cumulative=True, lw=0.5)
axes[1, 2].set_xlim(0, 50)
axes[1, 2].set_xlabel(r'$TT_{50-TRANSP}$ [days]')
axes[1, 2].text(0.95, 1.12, '(i)', fontsize=9, horizontalalignment='center',
                verticalalignment='center', transform=axes[1, 2].transAxes)
axes[1, 2].plot([], [], color='#fd8d3c', label='dry condtions\n($8^{th}$ Aug 2022)', lw=0.5)
axes[1, 2].plot([], [], color='#fed976', label='transition to dry condtions\n($29^{th}$ Mar 2020)', lw=1.0, ls='--')
axes[1, 2].plot([], [], color='#41b6c4', label='transition to wet condtions\n($5^{th}$ Oct 2020)', lw=1.5, ls='-.')
axes[1, 2].plot([], [], color='#253494', label='wet condtions\n($9^{th}$ Dec 2021)', lw=2.0)
...
axes[2, 2].hist(ds_tm['rt50_s'].isel(Time=770).values.flatten(), color='#253494', bins=600, range=(0, 600), histtype='step', cumulative=True, lw=2.0)
axes[2, 2].hist(ds_tm['rt50_s'].isel(Time=340).values.flatten(), color='#41b6c4', bins=600, range=(0, 600), histtype='step', cumulative=True, lw=1.5, ls='-.')
axes[2, 2].hist(ds_tm['rt50_s'].isel(Time=150).values.flatten(), color='#fed976', bins=600, range=(0, 600), histtype='step', cumulative=True, lw=1.0, ls='--')
axes[2, 2].hist(ds_tm['rt50_s'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=600, range=(0, 600), histtype='step', cumulative=True, lw=0.5)
axes[2, 2].set_xlim(100, 600)
axes[2, 2].set_xlabel(r'$RT_{50-\theta}$ [days]')
axes[2, 2].text(0.95, 1.12, '(j)', fontsize=9, horizontalalignment='center',
                verticalalignment='center', transform=axes[2, 2].transAxes)

axes[3, 2].hist(ds_tm['tt50_q_ss'].isel(Time=770).values.flatten(), color='#253494', bins=800, range=(0, 800), histtype='step', cumulative=True, lw=2.0)
axes[3, 2].hist(ds_tm['tt50_q_ss'].isel(Time=340).values.flatten(), color='#41b6c4', bins=800, range=(0, 800), histtype='step', cumulative=True, lw=1.5, ls='-.')
axes[3, 2].hist(ds_tm['tt50_q_ss'].isel(Time=150).values.flatten(), color='#fed976', bins=800, range=(0, 800), histtype='step', cumulative=True, lw=1.0, ls='--')
axes[3, 2].hist(ds_tm['tt50_q_ss'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=800, range=(0, 800), histtype='step', cumulative=True, lw=0.5)
...
inset.hist(ds_hm['q_ss'].isel(Time=770).values.flatten(), color='#253494', bins=40, range=(0, 0.4), histtype='step', cumulative=True, lw=2.0)
inset.hist(ds_hm['q_ss'].isel(Time=340).values.flatten(), color='#41b6c4', bins=40, range=(0, 0.4), histtype='step', cumulative=True, lw=1.5, ls='-.')
inset.hist(ds_hm['q_ss'].isel(Time=150).values.flatten(), color='#fed976', bins=40, range=(0, 0.4), histtype='step', cumulative=True, lw=1.0, ls='--')
inset.hist(ds_hm['q_ss'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=40, range=(0, 0.4), histtype='step', cumulative=True, lw=0.5)
...
axes.hist(ds_hm['q_ss'].isel(Time=770).values.flatten(), color='#253494', bins=50, range=(0, 0.5), histtype='step', cumulative=True, lw=2.0)
axes.hist(ds_hm['q_ss'].isel(Time=340).values.flatten(), color='#41b6c4', bins=50, range=(0, 0.5), histtype='step', cumulative=True, lw=1.5, ls='-.')
axes.hist(ds_hm['q_ss'].isel(Time=150).values.flatten(), color='#fed976', bins=50, range=(0, 0.5), histtype='step', cumulative=True, lw=1.0, ls='--')
axes.hist(ds_hm['q_ss'].isel(Time=1006).values.flatten(), color='#fd8d3c', bins=50, range=(0, 0.5), histtype='step', cumulative=True, lw=0.5)
axes.set_xlim(0, 0.5)

...
NX = 12  # number of rows
NY = 24  # number of columns
_UNITS = {'z_soil': 'mm',  # units for netcdf file
          'dmpv': '1/m2',
          'lmpv': 'mm',
          'theta_ac': '-',
          'theta_ufc': '-',
...
# parameter boundaries for random parameter sampling
file_param_bounds = base_path / "param_bounds.yml"
with open(file_param_bounds, 'r') as file:
    bounds = yaml.safe_load(file)
RNG = onp.random.default_rng(42)  # random number generator to sample parameters

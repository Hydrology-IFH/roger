...
#SBATCH --output=svat_crop_nitrate_5-3_4262994_1_freiburg_winter-wheat_silage-corn_yellow-mustard_low_Nfert_N.out
#SBATCH --error=svat_crop_nitrate_5-3_4262994_1_freiburg_winter-wheat_silage-corn_yellow-mustard_low_Nfert_N_err.out
#SBATCH --export=ALL
...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_nitrate.py -b jax -d cpu -n 32 1 --float-type float64 --row 36 --id 5-3_4262994_1 --location freiburg --crop-rotation-scenario winter-wheat_silage-corn_yellow-mustard --fertilization-intensity low -td "${TMPDIR}"

...
#SBATCH --job-name=write_shapefiles_eppingen-elsenz
#SBATCH --output=write_shapefiles_eppingen-elsenz.out
#SBATCH --error=write_shapefiles_eppingen-elsenz_err.out
#SBATCH --export=ALL
...
mv "${TMPDIR}"/nitrate_leaching_eppingen-elsenz.gpkg /pfs/work7/workspace/scratch/fr_rs1092-workspace1/roger/examples/plot_scale/boadkh/output

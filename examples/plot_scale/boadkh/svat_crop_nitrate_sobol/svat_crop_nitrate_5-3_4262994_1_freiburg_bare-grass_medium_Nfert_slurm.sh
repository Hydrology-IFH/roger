...
#SBATCH --job-name=svat_crop_nitrate_5-3_4262994_1_freiburg_bare-grass_medium_Nfert
#SBATCH --output=svat_crop_nitrate_5-3_4262994_1_freiburg_bare-grass_medium_Nfert.out
#SBATCH --error=svat_crop_nitrate_5-3_4262994_1_freiburg_bare-grass_medium_Nfert_err.out
#SBATCH --export=ALL
...
python svat_crop_nitrate_.py -b jax -d cpu --float-type float64 --row 36 --id 5-3_4262994_1 --location freiburg --crop-rotation-scenario bare-grass --fertilization-intensity medium -td "${TMPDIR}"

...
#SBATCH --job-name=svat_crop_gottmadingen_bare-grass
#SBATCH --output=svat_crop_gottmadingen_bare-grass.out
#SBATCH --error=svat_crop_gottmadingen_bare-grass_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location gottmadingen --crop-rotation-scenario bare-grass -td "${TMPDIR}"

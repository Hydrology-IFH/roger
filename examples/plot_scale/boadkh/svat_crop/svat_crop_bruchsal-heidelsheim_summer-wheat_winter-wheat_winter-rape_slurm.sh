...
#SBATCH --job-name=svat_crop_bruchsal-heidelsheim_summer-wheat_winter-wheat_winter-rape
#SBATCH --output=svat_crop_bruchsal-heidelsheim_summer-wheat_winter-wheat_winter-rape.out
#SBATCH --error=svat_crop_bruchsal-heidelsheim_summer-wheat_winter-wheat_winter-rape_err.out
#SBATCH --export=ALL

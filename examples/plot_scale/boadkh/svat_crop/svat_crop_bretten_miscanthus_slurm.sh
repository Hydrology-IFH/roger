...
#SBATCH --job-name=svat_crop_bretten_miscanthus
#SBATCH --output=svat_crop_bretten_miscanthus.out
#SBATCH --error=svat_crop_bretten_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location bretten --crop-rotation-scenario miscanthus -td "${TMPDIR}"

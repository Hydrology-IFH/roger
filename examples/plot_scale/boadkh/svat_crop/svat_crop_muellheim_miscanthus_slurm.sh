...
#SBATCH --job-name=svat_crop_muellheim_miscanthus
#SBATCH --output=svat_crop_muellheim_miscanthus.out
#SBATCH --error=svat_crop_muellheim_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location muellheim --crop-rotation-scenario miscanthus -td "${TMPDIR}"

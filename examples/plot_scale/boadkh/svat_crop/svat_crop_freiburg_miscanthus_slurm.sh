...
#SBATCH --job-name=svat_crop_freiburg_miscanthus
#SBATCH --output=svat_crop_freiburg_miscanthus.out
#SBATCH --error=svat_crop_freiburg_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location freiburg --crop-rotation-scenario miscanthus -td "${TMPDIR}"

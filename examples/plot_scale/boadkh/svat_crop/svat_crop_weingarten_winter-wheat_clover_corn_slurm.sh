...
#SBATCH --job-name=svat_crop_weingarten_winter-wheat_clover_corn
#SBATCH --output=svat_crop_weingarten_winter-wheat_clover_corn.out
#SBATCH --error=svat_crop_weingarten_winter-wheat_clover_corn_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location weingarten --crop-rotation-scenario winter-wheat_clover_corn -td "${TMPDIR}"

...
#SBATCH --job-name=svat_crop_hayingen_winter-wheat_soybean_winter-rape
#SBATCH --output=svat_crop_hayingen_winter-wheat_soybean_winter-rape.out
#SBATCH --error=svat_crop_hayingen_winter-wheat_soybean_winter-rape_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location hayingen --crop-rotation-scenario winter-wheat_soybean_winter-rape -td "${TMPDIR}"

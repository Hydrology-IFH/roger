...
#SBATCH --job-name=svat_crop_weingarten_sugar-beet_winter-wheat_winter-barley
#SBATCH --output=svat_crop_weingarten_sugar-beet_winter-wheat_winter-barley.out
#SBATCH --error=svat_crop_weingarten_sugar-beet_winter-wheat_winter-barley_err.out
#SBATCH --export=ALL

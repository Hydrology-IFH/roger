...
#SBATCH --job-name=svat_crop_gottmadingen_miscanthus
#SBATCH --output=svat_crop_gottmadingen_miscanthus.out
#SBATCH --error=svat_crop_gottmadingen_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location gottmadingen --crop-rotation-scenario miscanthus -td "${TMPDIR}"

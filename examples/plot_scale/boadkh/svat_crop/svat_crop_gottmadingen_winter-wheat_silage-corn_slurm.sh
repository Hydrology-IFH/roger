...
#SBATCH --job-name=svat_crop_gottmadingen_winter-wheat_silage-corn
#SBATCH --output=svat_crop_gottmadingen_winter-wheat_silage-corn.out
#SBATCH --error=svat_crop_gottmadingen_winter-wheat_silage-corn_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location gottmadingen --crop-rotation-scenario winter-wheat_silage-corn -td "${TMPDIR}"

...
#SBATCH --job-name=svat_crop_muellheim_winter-wheat_soybean_winter-rape
#SBATCH --output=svat_crop_muellheim_winter-wheat_soybean_winter-rape.out
#SBATCH --error=svat_crop_muellheim_winter-wheat_soybean_winter-rape_err.out
#SBATCH --export=ALL

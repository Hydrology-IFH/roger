...
#SBATCH --job-name=svat_crop_lahr_miscanthus
#SBATCH --output=svat_crop_lahr_miscanthus.out
#SBATCH --error=svat_crop_lahr_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location lahr --crop-rotation-scenario miscanthus -td "${TMPDIR}"

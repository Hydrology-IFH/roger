...
#SBATCH --job-name=svat_crop_oehringen_miscanthus
#SBATCH --output=svat_crop_oehringen_miscanthus.out
#SBATCH --error=svat_crop_oehringen_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location oehringen --crop-rotation-scenario miscanthus -td "${TMPDIR}"

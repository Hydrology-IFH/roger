...
#SBATCH --job-name=svat_crop_weingarten_miscanthus
#SBATCH --output=svat_crop_weingarten_miscanthus.out
#SBATCH --error=svat_crop_weingarten_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location weingarten --crop-rotation-scenario miscanthus -td "${TMPDIR}"

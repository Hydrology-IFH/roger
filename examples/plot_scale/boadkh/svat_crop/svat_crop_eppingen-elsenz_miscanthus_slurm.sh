...
#SBATCH --job-name=svat_crop_eppingen-elsenz_miscanthus
#SBATCH --output=svat_crop_eppingen-elsenz_miscanthus.out
#SBATCH --error=svat_crop_eppingen-elsenz_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location eppingen-elsenz --crop-rotation-scenario miscanthus -td "${TMPDIR}"

...
#SBATCH --job-name=svat_crop_vellberg-kleinaltdorf_miscanthus
#SBATCH --output=svat_crop_vellberg-kleinaltdorf_miscanthus.out
#SBATCH --error=svat_crop_vellberg-kleinaltdorf_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location vellberg-kleinaltdorf --crop-rotation-scenario miscanthus -td "${TMPDIR}"

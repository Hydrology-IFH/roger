...
#SBATCH --job-name=svat_crop_stockach_miscanthus
#SBATCH --output=svat_crop_stockach_miscanthus.out
#SBATCH --error=svat_crop_stockach_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location stockach --crop-rotation-scenario miscanthus -td "${TMPDIR}"

...
#SBATCH --job-name=svat_crop_zaberfeld_summer-wheat_winter-wheat
#SBATCH --output=svat_crop_zaberfeld_summer-wheat_winter-wheat.out
#SBATCH --error=svat_crop_zaberfeld_summer-wheat_winter-wheat_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location zaberfeld --crop-rotation-scenario summer-wheat_winter-wheat -td "${TMPDIR}"

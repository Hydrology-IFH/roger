...
#SBATCH --job-name=svat_crop_stockach_summer-wheat_winter-wheat_silage-corn_yellow-mustard
#SBATCH --output=svat_crop_stockach_summer-wheat_winter-wheat_silage-corn_yellow-mustard.out
#SBATCH --error=svat_crop_stockach_summer-wheat_winter-wheat_silage-corn_yellow-mustard_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location stockach --crop-rotation-scenario summer-wheat_winter-wheat_silage-corn_yellow-mustard -td "${TMPDIR}"

...
#SBATCH --job-name=svat_crop_lahr_winter-wheat_silage-corn
#SBATCH --output=svat_crop_lahr_winter-wheat_silage-corn.out
#SBATCH --error=svat_crop_lahr_winter-wheat_silage-corn_err.out
#SBATCH --export=ALL

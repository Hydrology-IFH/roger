...
#SBATCH --job-name=svat_crop_bruchsal-heidelsheim_summer-wheat_winter-wheat_yellow-mustard
#SBATCH --output=svat_crop_bruchsal-heidelsheim_summer-wheat_winter-wheat_yellow-mustard.out
#SBATCH --error=svat_crop_bruchsal-heidelsheim_summer-wheat_winter-wheat_yellow-mustard_err.out
#SBATCH --export=ALL

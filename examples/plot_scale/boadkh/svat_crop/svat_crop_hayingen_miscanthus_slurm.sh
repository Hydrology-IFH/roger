...
#SBATCH --job-name=svat_crop_hayingen_miscanthus
#SBATCH --output=svat_crop_hayingen_miscanthus.out
#SBATCH --error=svat_crop_hayingen_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location hayingen --crop-rotation-scenario miscanthus -td "${TMPDIR}"

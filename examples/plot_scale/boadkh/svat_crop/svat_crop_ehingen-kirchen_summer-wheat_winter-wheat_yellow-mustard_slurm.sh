...
#SBATCH --job-name=svat_crop_ehingen-kirchen_summer-wheat_winter-wheat_yellow-mustard
#SBATCH --output=svat_crop_ehingen-kirchen_summer-wheat_winter-wheat_yellow-mustard.out
#SBATCH --error=svat_crop_ehingen-kirchen_summer-wheat_winter-wheat_yellow-mustard_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location ehingen-kirchen --crop-rotation-scenario summer-wheat_winter-wheat_yellow-mustard -td "${TMPDIR}"

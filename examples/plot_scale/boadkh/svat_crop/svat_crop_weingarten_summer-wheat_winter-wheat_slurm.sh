...
#SBATCH --job-name=svat_crop_weingarten_summer-wheat_winter-wheat
#SBATCH --output=svat_crop_weingarten_summer-wheat_winter-wheat.out
#SBATCH --error=svat_crop_weingarten_summer-wheat_winter-wheat_err.out
#SBATCH --export=ALL

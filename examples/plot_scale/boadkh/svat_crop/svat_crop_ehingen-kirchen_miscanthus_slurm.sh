...
#SBATCH --job-name=svat_crop_ehingen-kirchen_miscanthus
#SBATCH --output=svat_crop_ehingen-kirchen_miscanthus.out
#SBATCH --error=svat_crop_ehingen-kirchen_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location ehingen-kirchen --crop-rotation-scenario miscanthus -td "${TMPDIR}"

...
#SBATCH --job-name=svat_crop_lahr_grain-corn_winter-wheat_winter-rape_yellow-mustard
#SBATCH --output=svat_crop_lahr_grain-corn_winter-wheat_winter-rape_yellow-mustard.out
#SBATCH --error=svat_crop_lahr_grain-corn_winter-wheat_winter-rape_yellow-mustard_err.out
#SBATCH --export=ALL

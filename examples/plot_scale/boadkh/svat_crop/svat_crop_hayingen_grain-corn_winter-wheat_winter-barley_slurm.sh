...
#SBATCH --job-name=svat_crop_hayingen_grain-corn_winter-wheat_winter-barley
#SBATCH --output=svat_crop_hayingen_grain-corn_winter-wheat_winter-barley.out
#SBATCH --error=svat_crop_hayingen_grain-corn_winter-wheat_winter-barley_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location hayingen --crop-rotation-scenario grain-corn_winter-wheat_winter-barley -td "${TMPDIR}"

...
#SBATCH --job-name=svat_crop_eppingen-elsenz_bare-grass
#SBATCH --output=svat_crop_eppingen-elsenz_bare-grass.out
#SBATCH --error=svat_crop_eppingen-elsenz_bare-grass_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location eppingen-elsenz --crop-rotation-scenario bare-grass -td "${TMPDIR}"

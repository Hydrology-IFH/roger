...
#SBATCH --job-name=svat_crop_oehringen_summer-wheat_winter-wheat_winter-rape_yellow-mustard
#SBATCH --output=svat_crop_oehringen_summer-wheat_winter-wheat_winter-rape_yellow-mustard.out
#SBATCH --error=svat_crop_oehringen_summer-wheat_winter-wheat_winter-rape_yellow-mustard_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location oehringen --crop-rotation-scenario summer-wheat_winter-wheat_winter-rape_yellow-mustard -td "${TMPDIR}"

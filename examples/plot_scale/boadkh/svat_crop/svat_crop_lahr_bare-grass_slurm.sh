...
#SBATCH --job-name=svat_crop_lahr_bare-grass
#SBATCH --output=svat_crop_lahr_bare-grass.out
#SBATCH --error=svat_crop_lahr_bare-grass_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location lahr --crop-rotation-scenario bare-grass -td "${TMPDIR}"

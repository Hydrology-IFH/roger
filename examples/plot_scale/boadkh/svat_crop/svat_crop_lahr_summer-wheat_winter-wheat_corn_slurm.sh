...
#SBATCH --job-name=svat_crop_lahr_summer-wheat_winter-wheat_corn
#SBATCH --output=svat_crop_lahr_summer-wheat_winter-wheat_corn.out
#SBATCH --error=svat_crop_lahr_summer-wheat_winter-wheat_corn_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location lahr --crop-rotation-scenario summer-wheat_winter-wheat_corn -td "${TMPDIR}"

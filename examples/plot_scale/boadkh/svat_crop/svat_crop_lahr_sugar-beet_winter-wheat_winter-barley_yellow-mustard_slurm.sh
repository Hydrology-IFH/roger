...
#SBATCH --job-name=svat_crop_lahr_sugar-beet_winter-wheat_winter-barley_yellow-mustard
#SBATCH --output=svat_crop_lahr_sugar-beet_winter-wheat_winter-barley_yellow-mustard.out
#SBATCH --error=svat_crop_lahr_sugar-beet_winter-wheat_winter-barley_yellow-mustard_err.out
#SBATCH --export=ALL

...
#SBATCH --job-name=svat_crop_kupferzell_miscanthus
#SBATCH --output=svat_crop_kupferzell_miscanthus.out
#SBATCH --error=svat_crop_kupferzell_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location kupferzell --crop-rotation-scenario miscanthus -td "${TMPDIR}"

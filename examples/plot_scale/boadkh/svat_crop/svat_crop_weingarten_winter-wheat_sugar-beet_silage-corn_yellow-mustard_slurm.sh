...
#SBATCH --job-name=svat_crop_weingarten_winter-wheat_sugar-beet_silage-corn_yellow-mustard
#SBATCH --output=svat_crop_weingarten_winter-wheat_sugar-beet_silage-corn_yellow-mustard.out
#SBATCH --error=svat_crop_weingarten_winter-wheat_sugar-beet_silage-corn_yellow-mustard_err.out
#SBATCH --export=ALL

...
#SBATCH --job-name=svat_crop_vellberg-kleinaltdorf_sugar-beet_winter-wheat_winter-barley
#SBATCH --output=svat_crop_vellberg-kleinaltdorf_sugar-beet_winter-wheat_winter-barley.out
#SBATCH --error=svat_crop_vellberg-kleinaltdorf_sugar-beet_winter-wheat_winter-barley_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location vellberg-kleinaltdorf --crop-rotation-scenario sugar-beet_winter-wheat_winter-barley -td "${TMPDIR}"

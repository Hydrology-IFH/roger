...
#SBATCH --job-name=svat_crop_zaberfeld_winter-wheat_clover
#SBATCH --output=svat_crop_zaberfeld_winter-wheat_clover.out
#SBATCH --error=svat_crop_zaberfeld_winter-wheat_clover_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location zaberfeld --crop-rotation-scenario winter-wheat_clover -td "${TMPDIR}"

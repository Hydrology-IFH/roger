...
#SBATCH --job-name=svat_crop_merklingen_miscanthus
#SBATCH --output=svat_crop_merklingen_miscanthus.out
#SBATCH --error=svat_crop_merklingen_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location merklingen --crop-rotation-scenario miscanthus -td "${TMPDIR}"

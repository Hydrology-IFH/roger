...
#SBATCH --job-name=svat_crop_hayingen_winter-wheat_sugar-beet_corn
#SBATCH --output=svat_crop_hayingen_winter-wheat_sugar-beet_corn.out
#SBATCH --error=svat_crop_hayingen_winter-wheat_sugar-beet_corn_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location hayingen --crop-rotation-scenario winter-wheat_sugar-beet_corn -td "${TMPDIR}"

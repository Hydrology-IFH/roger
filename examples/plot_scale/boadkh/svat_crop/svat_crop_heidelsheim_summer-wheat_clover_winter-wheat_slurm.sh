...
#SBATCH --job-name=svat_crop_heidelsheim_summer-wheat_clover_winter-wheat
#SBATCH --output=svat_crop_heidelsheim_summer-wheat_clover_winter-wheat.out
#SBATCH --error=svat_crop_heidelsheim_summer-wheat_clover_winter-wheat_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location heidelsheim --crop-rotation-scenario summer-wheat_clover_winter-wheat -td "${TMPDIR}"

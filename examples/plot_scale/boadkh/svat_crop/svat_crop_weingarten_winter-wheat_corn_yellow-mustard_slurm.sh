...
#SBATCH --job-name=svat_crop_weingarten_winter-wheat_corn_yellow-mustard
#SBATCH --output=svat_crop_weingarten_winter-wheat_corn_yellow-mustard.out
#SBATCH --error=svat_crop_weingarten_winter-wheat_corn_yellow-mustard_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location weingarten --crop-rotation-scenario winter-wheat_corn_yellow-mustard -td "${TMPDIR}"

...
#SBATCH --job-name=svat_crop_bruchsal-heidelsheim_miscanthus
#SBATCH --output=svat_crop_bruchsal-heidelsheim_miscanthus.out
#SBATCH --error=svat_crop_bruchsal-heidelsheim_miscanthus_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location bruchsal-heidelsheim --crop-rotation-scenario miscanthus -td "${TMPDIR}"

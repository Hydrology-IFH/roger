...
#SBATCH --job-name=svat_crop_altheim_winter-wheat_clover
#SBATCH --output=svat_crop_altheim_winter-wheat_clover.out
#SBATCH --error=svat_crop_altheim_winter-wheat_clover_err.out
#SBATCH --export=ALL

...
#SBATCH --job-name=svat_crop_weingarten_winter-wheat_sugar-beet_silage-corn
#SBATCH --output=svat_crop_weingarten_winter-wheat_sugar-beet_silage-corn.out
#SBATCH --error=svat_crop_weingarten_winter-wheat_sugar-beet_silage-corn_err.out
#SBATCH --export=ALL

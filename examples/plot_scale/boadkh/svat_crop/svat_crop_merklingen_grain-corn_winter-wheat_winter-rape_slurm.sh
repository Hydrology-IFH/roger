...
#SBATCH --job-name=svat_crop_merklingen_grain-corn_winter-wheat_winter-rape
#SBATCH --output=svat_crop_merklingen_grain-corn_winter-wheat_winter-rape.out
#SBATCH --error=svat_crop_merklingen_grain-corn_winter-wheat_winter-rape_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location merklingen --crop-rotation-scenario grain-corn_winter-wheat_winter-rape -td "${TMPDIR}"

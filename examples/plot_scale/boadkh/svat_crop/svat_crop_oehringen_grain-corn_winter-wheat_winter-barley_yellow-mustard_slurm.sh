...
#SBATCH --job-name=svat_crop_oehringen_grain-corn_winter-wheat_winter-barley_yellow-mustard
#SBATCH --output=svat_crop_oehringen_grain-corn_winter-wheat_winter-barley_yellow-mustard.out
#SBATCH --error=svat_crop_oehringen_grain-corn_winter-wheat_winter-barley_yellow-mustard_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location oehringen --crop-rotation-scenario grain-corn_winter-wheat_winter-barley_yellow-mustard -td "${TMPDIR}"

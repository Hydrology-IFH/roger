...
#SBATCH --job-name=svat_crop_hayingen_winter-wheat_sugar-beet_silage-corn_yellow-mustard
#SBATCH --output=svat_crop_hayingen_winter-wheat_sugar-beet_silage-corn_yellow-mustard.out
#SBATCH --error=svat_crop_hayingen_winter-wheat_sugar-beet_silage-corn_yellow-mustard_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location hayingen --crop-rotation-scenario winter-wheat_sugar-beet_silage-corn_yellow-mustard -td "${TMPDIR}"

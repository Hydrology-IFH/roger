...
#SBATCH --job-name=svat_crop_lahr_grain-corn_winter-wheat_clover
#SBATCH --output=svat_crop_lahr_grain-corn_winter-wheat_clover.out
#SBATCH --error=svat_crop_lahr_grain-corn_winter-wheat_clover_err.out
#SBATCH --export=ALL

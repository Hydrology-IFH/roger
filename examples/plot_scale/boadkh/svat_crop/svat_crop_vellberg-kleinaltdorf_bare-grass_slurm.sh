...
#SBATCH --job-name=svat_crop_vellberg-kleinaltdorf_bare-grass
#SBATCH --output=svat_crop_vellberg-kleinaltdorf_bare-grass.out
#SBATCH --error=svat_crop_vellberg-kleinaltdorf_bare-grass_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location vellberg-kleinaltdorf --crop-rotation-scenario bare-grass -td "${TMPDIR}"

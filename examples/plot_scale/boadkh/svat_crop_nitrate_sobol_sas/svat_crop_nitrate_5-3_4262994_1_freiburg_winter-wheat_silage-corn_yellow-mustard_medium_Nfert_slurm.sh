...
python svat_crop_nitrate.py -b jax -d cpu -n 8 1 --float-type float64 --row 36 --id 5-3_4262994_1 --location freiburg --crop-rotation-scenario winter-wheat_silage-corn_yellow-mustard --fertilization-intensity medium -td "${TMPDIR}"

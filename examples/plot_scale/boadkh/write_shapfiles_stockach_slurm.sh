...
#SBATCH --job-name=write_shapfiles_stockach
#SBATCH --output=write_shapfiles_stockach.out
#SBATCH --error=write_shapfiles_stockach_err.out
#SBATCH --export=ALL
...
mv "${TMPDIR}"/nitrate_leaching_stockach.gpkg /pfs/work7/workspace/scratch/fr_rs1092-workspace/roger/examples/plot_scale/boadkh/output

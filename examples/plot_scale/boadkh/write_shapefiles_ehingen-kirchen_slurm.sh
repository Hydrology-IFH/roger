...
#SBATCH --job-name=write_shapefiles_ehingen-kirchen
#SBATCH --output=write_shapefiles_ehingen-kirchen.out
#SBATCH --error=write_shapefiles_ehingen-kirchen_err.out
#SBATCH --export=ALL
...
mv "${TMPDIR}"/nitrate_leaching_ehingen-kirchen.gpkg /pfs/work7/workspace/scratch/fr_rs1092-workspace1/roger/examples/plot_scale/boadkh/output

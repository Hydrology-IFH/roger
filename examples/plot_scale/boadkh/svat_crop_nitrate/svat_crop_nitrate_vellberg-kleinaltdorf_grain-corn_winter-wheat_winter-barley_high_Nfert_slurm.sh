...
python svat_crop_nitrate.py -d cpu --float-type float64 --location vellberg-kleinaltdorf --crop-rotation-scenario grain-corn_winter-wheat_winter-barley --fertilization-intensity high -td "${TMPDIR}"

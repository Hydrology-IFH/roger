...
python svat_crop_nitrate.py -d cpu --float-type float64 --location lahr --crop-rotation-scenario summer-wheat_winter-wheat_winter-rape_yellow-mustard --fertilization-intensity high -td "${TMPDIR}"

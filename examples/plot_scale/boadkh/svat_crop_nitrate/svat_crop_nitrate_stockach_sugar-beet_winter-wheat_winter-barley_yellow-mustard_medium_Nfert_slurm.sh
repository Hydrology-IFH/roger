...
#SBATCH --job-name=svat_crop_nitrate_stockach_sugar-beet_winter-wheat_winter-barley_yellow-mustard_medium_Nfert
#SBATCH --output=svat_crop_nitrate_stockach_sugar-beet_winter-wheat_winter-barley_yellow-mustard_medium_Nfert.out
#SBATCH --error=svat_crop_nitrate_stockach_sugar-beet_winter-wheat_winter-barley_yellow-mustard_medium_Nfert_err.out
#SBATCH --export=ALL

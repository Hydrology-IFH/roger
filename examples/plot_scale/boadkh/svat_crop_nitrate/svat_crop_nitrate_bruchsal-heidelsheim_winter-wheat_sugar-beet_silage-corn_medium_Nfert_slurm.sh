...
python svat_crop_nitrate.py -d cpu --float-type float64 --location bruchsal-heidelsheim --crop-rotation-scenario winter-wheat_sugar-beet_silage-corn --fertilization-intensity medium -td "${TMPDIR}"

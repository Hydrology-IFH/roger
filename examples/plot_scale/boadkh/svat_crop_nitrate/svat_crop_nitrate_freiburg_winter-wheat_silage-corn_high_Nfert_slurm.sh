...
python svat_crop_nitrate.py -d cpu --float-type float64 --location freiburg --crop-rotation-scenario winter-wheat_silage-corn --fertilization-intensity high -td "${TMPDIR}"

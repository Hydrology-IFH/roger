...
#SBATCH --job-name=svat_crop_nitrate_bretten_grain-corn_winter-wheat_clover_low_Nfert
#SBATCH --output=svat_crop_nitrate_bretten_grain-corn_winter-wheat_clover_low_Nfert.out
#SBATCH --error=svat_crop_nitrate_bretten_grain-corn_winter-wheat_clover_low_Nfert_err.out
#SBATCH --export=ALL

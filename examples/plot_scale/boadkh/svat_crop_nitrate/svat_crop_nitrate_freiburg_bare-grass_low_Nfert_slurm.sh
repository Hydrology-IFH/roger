...
#SBATCH --job-name=svat_crop_nitrate_freiburg_bare-grass_low_Nfert
#SBATCH --output=svat_crop_nitrate_freiburg_bare-grass_low_Nfert.out
#SBATCH --error=svat_crop_nitrate_freiburg_bare-grass_low_Nfert_err.out
#SBATCH --export=ALL
...
python svat_crop_nitrate.py -b jax -d cpu --float-type float64 --location freiburg --crop-rotation-scenario bare-grass --fertilization-intensity low -td "${TMPDIR}"

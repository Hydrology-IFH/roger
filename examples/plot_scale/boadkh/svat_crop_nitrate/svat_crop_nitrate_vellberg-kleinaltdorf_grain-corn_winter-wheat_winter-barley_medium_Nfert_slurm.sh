...
#SBATCH --job-name=svat_crop_nitrate_vellberg-kleinaltdorf_grain-corn_winter-wheat_winter-barley_medium_Nfert
#SBATCH --output=svat_crop_nitrate_vellberg-kleinaltdorf_grain-corn_winter-wheat_winter-barley_medium_Nfert.out

...
python svat_crop_nitrate.py -d cpu --float-type float64 --location freiburg --crop-rotation-scenario grain-corn_winter-wheat_clover --fertilization-intensity low -td "${TMPDIR}"

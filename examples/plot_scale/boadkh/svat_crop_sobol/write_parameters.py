...
def main(nsamples):
    ...
    df_params = df_params.loc[:, ["z_soil", "dmpv", "c_lmpv", "theta_ac", "theta_ufc", "theta_pwp", "ks", "kf", "c_canopy_growth", "c_root_growth"]]

    # write parameters to csv
    df_params.columns = [
        ["[mm]", "[1/m2]", "[-]", "[-]", "[-]", "[-]", "[mm/hour]", "[mm/hour]", "[-]", "[-]"],
        ["z_soil", "dmpv", "c_lmpv", "theta_ac", "theta_ufc", "theta_pwp", "ks", "kf", "c_canopy_growth", "c_root_growth"],
    ]

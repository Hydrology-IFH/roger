...
#SBATCH --job-name=svat_crop_notzingen_summer-barley_no-irrigation
#SBATCH --output=svat_crop_notzingen_summer-barley_no-irrigation.out
#SBATCH --error=svat_crop_notzingen_summer-barley_no-irrigation_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location notzingen --crop-rotation-scenario summer-barley -td "${TMPDIR}"

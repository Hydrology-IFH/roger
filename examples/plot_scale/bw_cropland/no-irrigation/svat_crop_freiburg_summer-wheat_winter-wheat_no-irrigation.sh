...
#SBATCH --job-name=svat_crop_freiburg_summer-wheat_winter-wheat_no-irrigation
#SBATCH --output=svat_crop_freiburg_summer-wheat_winter-wheat_no-irrigation.out
#SBATCH --error=svat_crop_freiburg_summer-wheat_winter-wheat_no-irrigation_err.out
#SBATCH --export=ALL

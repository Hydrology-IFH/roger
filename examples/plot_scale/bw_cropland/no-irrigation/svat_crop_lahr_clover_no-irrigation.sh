...
#SBATCH --job-name=svat_crop_lahr_clover_no-irrigation
#SBATCH --output=svat_crop_lahr_clover_no-irrigation.out
#SBATCH --error=svat_crop_lahr_clover_no-irrigation_err.out
#SBATCH --export=ALL

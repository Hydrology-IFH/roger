...
#SBATCH --job-name=svat_crop_freiburg_grain-corn_no-irrigation
#SBATCH --output=svat_crop_freiburg_grain-corn_no-irrigation.out
#SBATCH --error=svat_crop_freiburg_grain-corn_no-irrigation_err.out
#SBATCH --export=ALL

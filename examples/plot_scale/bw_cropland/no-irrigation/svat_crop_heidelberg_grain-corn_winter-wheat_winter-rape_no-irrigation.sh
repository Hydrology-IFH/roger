...
#SBATCH --job-name=svat_crop_heidelberg_grain-corn_winter-wheat_winter-rape_no-irrigation
#SBATCH --output=svat_crop_heidelberg_grain-corn_winter-wheat_winter-rape_no-irrigation.out
#SBATCH --error=svat_crop_heidelberg_grain-corn_winter-wheat_winter-rape_no-irrigation_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location heidelberg --crop-rotation-scenario grain-corn_winter-wheat_winter-rape -td "${TMPDIR}"

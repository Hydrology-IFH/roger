...
#SBATCH --job-name=svat_crop_lahr_grain-corn_yellow-mustard_no-irrigation
#SBATCH --output=svat_crop_lahr_grain-corn_yellow-mustard_no-irrigation.out
#SBATCH --error=svat_crop_lahr_grain-corn_yellow-mustard_no-irrigation_err.out
#SBATCH --export=ALL

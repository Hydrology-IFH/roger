...
#SBATCH --job-name=svat_crop_mergentheim_potato-early_no-irrigation
#SBATCH --output=svat_crop_mergentheim_potato-early_no-irrigation.out
#SBATCH --error=svat_crop_mergentheim_potato-early_no-irrigation_err.out
#SBATCH --export=ALL

...
#SBATCH --job-name=svat_crop_klippeneck_sugar-beet_no-irrigation
#SBATCH --output=svat_crop_klippeneck_sugar-beet_no-irrigation.out
#SBATCH --error=svat_crop_klippeneck_sugar-beet_no-irrigation_err.out
#SBATCH --export=ALL

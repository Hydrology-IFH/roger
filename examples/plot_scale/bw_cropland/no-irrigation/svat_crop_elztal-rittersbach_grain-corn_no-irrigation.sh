...
#SBATCH --job-name=svat_crop_elztal-rittersbach_grain-corn_no-irrigation
#SBATCH --output=svat_crop_elztal-rittersbach_grain-corn_no-irrigation.out
#SBATCH --error=svat_crop_elztal-rittersbach_grain-corn_no-irrigation_err.out
#SBATCH --export=ALL

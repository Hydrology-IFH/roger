...
#SBATCH --job-name=svat_crop_grosserlach-mannenweiler_potato_no-irrigation
#SBATCH --output=svat_crop_grosserlach-mannenweiler_potato_no-irrigation.out
#SBATCH --error=svat_crop_grosserlach-mannenweiler_potato_no-irrigation_err.out
#SBATCH --export=ALL

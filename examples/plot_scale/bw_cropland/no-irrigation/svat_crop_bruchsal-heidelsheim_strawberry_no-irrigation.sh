...
#SBATCH --job-name=svat_crop_bruchsal-heidelsheim_strawberry_no-irrigation
#SBATCH --output=svat_crop_bruchsal-heidelsheim_strawberry_no-irrigation.out
#SBATCH --error=svat_crop_bruchsal-heidelsheim_strawberry_no-irrigation_err.out
#SBATCH --export=ALL

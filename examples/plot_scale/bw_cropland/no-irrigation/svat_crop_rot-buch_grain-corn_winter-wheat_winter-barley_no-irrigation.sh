...
#SBATCH --job-name=svat_crop_rot-buch_grain-corn_winter-wheat_winter-barley_no-irrigation
#SBATCH --output=svat_crop_rot-buch_grain-corn_winter-wheat_winter-barley_no-irrigation.out
#SBATCH --error=svat_crop_rot-buch_grain-corn_winter-wheat_winter-barley_no-irrigation_err.out
#SBATCH --export=ALL

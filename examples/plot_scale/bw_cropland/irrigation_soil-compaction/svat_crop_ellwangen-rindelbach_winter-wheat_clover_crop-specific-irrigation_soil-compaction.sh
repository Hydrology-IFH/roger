...
#SBATCH --job-name=svat_crop_ellwangen-rindelbach_winter-wheat_clover_crop-specific-irrigation_soil-compaction
#SBATCH --output=svat_crop_ellwangen-rindelbach_winter-wheat_clover_crop-specific-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_ellwangen-rindelbach_winter-wheat_clover_crop-specific-irrigation_soil-compaction_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location ellwangen-rindelbach --irrigation-scenario crop-specific --crop-rotation-scenario winter-wheat_clover -td "${TMPDIR}"

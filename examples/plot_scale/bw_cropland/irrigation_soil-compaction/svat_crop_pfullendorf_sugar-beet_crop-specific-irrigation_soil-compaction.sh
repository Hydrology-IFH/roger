...
#SBATCH --job-name=svat_crop_pfullendorf_sugar-beet_crop-specific-irrigation_soil-compaction
#SBATCH --output=svat_crop_pfullendorf_sugar-beet_crop-specific-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_pfullendorf_sugar-beet_crop-specific-irrigation_soil-compaction_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location pfullendorf --irrigation-scenario crop-specific --crop-rotation-scenario sugar-beet -td "${TMPDIR}"

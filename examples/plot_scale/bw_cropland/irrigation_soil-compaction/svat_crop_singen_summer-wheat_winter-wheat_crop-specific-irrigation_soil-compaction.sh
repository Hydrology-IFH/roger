...
#SBATCH --job-name=svat_crop_singen_summer-wheat_winter-wheat_crop-specific-irrigation_soil-compaction
#SBATCH --output=svat_crop_singen_summer-wheat_winter-wheat_crop-specific-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_singen_summer-wheat_winter-wheat_crop-specific-irrigation_soil-compaction_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location singen --irrigation-scenario crop-specific --crop-rotation-scenario summer-wheat_winter-wheat -td "${TMPDIR}"

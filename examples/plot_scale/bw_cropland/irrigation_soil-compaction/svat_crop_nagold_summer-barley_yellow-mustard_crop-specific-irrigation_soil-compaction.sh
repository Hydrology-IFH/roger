...
#SBATCH --job-name=svat_crop_nagold_summer-barley_yellow-mustard_crop-specific-irrigation_soil-compaction
#SBATCH --output=svat_crop_nagold_summer-barley_yellow-mustard_crop-specific-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_nagold_summer-barley_yellow-mustard_crop-specific-irrigation_soil-compaction_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location nagold --irrigation-scenario crop-specific --crop-rotation-scenario summer-barley_yellow-mustard -td "${TMPDIR}"

...
#SBATCH --job-name=svat_crop_nagold_sugar-beet_crop-specific-irrigation
#SBATCH --output=svat_crop_nagold_sugar-beet_crop-specific-irrigation.out
#SBATCH --error=svat_crop_nagold_sugar-beet_crop-specific-irrigation_err.out
#SBATCH --export=ALL

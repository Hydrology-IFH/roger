...
#SBATCH --job-name=svat_crop_lahr_faba-bean_crop-specific-irrigation
#SBATCH --output=svat_crop_lahr_faba-bean_crop-specific-irrigation.out
#SBATCH --error=svat_crop_lahr_faba-bean_crop-specific-irrigation_err.out
#SBATCH --export=ALL

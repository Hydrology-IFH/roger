...
#SBATCH --output=svat_crop_elztal-rittersbach_grain-corn_winter-wheat_winter-barley_yellow-mustard_crop-specific-irrigation.out
#SBATCH --error=svat_crop_elztal-rittersbach_grain-corn_winter-wheat_winter-barley_yellow-mustard_crop-specific-irrigation_err.out
#SBATCH --export=ALL

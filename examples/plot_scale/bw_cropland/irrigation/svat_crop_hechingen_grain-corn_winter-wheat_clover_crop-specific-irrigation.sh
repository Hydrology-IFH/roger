...
#SBATCH --job-name=svat_crop_hechingen_grain-corn_winter-wheat_clover_crop-specific-irrigation
#SBATCH --output=svat_crop_hechingen_grain-corn_winter-wheat_clover_crop-specific-irrigation.out
#SBATCH --error=svat_crop_hechingen_grain-corn_winter-wheat_clover_crop-specific-irrigation_err.out
#SBATCH --export=ALL

...
#SBATCH --job-name=write_simulations_to_csv_irrigation
#SBATCH --output=write_simulations_to_csv_irrigation.out
#SBATCH --error=write_simulations_to_csv_irrigation_err.out
#SBATCH --export=ALL

...
#SBATCH --job-name=svat_crop_singen_strawberry_crop-specific-irrigation
#SBATCH --output=svat_crop_singen_strawberry_crop-specific-irrigation.out
#SBATCH --error=svat_crop_singen_strawberry_crop-specific-irrigation_err.out
#SBATCH --export=ALL

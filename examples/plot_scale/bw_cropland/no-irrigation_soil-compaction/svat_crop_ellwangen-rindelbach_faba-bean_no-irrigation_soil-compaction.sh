...
#SBATCH --job-name=svat_crop_ellwangen-rindelbach_faba-bean_no-irrigation_soil-compaction
#SBATCH --output=svat_crop_ellwangen-rindelbach_faba-bean_no-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_ellwangen-rindelbach_faba-bean_no-irrigation_soil-compaction_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location ellwangen-rindelbach --crop-rotation-scenario faba-bean -td "${TMPDIR}"

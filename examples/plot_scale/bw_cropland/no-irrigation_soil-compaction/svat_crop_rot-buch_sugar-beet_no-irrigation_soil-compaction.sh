...
#SBATCH --job-name=svat_crop_rot-buch_sugar-beet_no-irrigation_soil-compaction
#SBATCH --output=svat_crop_rot-buch_sugar-beet_no-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_rot-buch_sugar-beet_no-irrigation_soil-compaction_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location rot-buch --crop-rotation-scenario sugar-beet -td "${TMPDIR}"

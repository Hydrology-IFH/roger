...
#SBATCH --job-name=svat_crop_sachsenheim_winter-wheat_clover_no-irrigation_soil-compaction
#SBATCH --output=svat_crop_sachsenheim_winter-wheat_clover_no-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_sachsenheim_winter-wheat_clover_no-irrigation_soil-compaction_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location sachsenheim --crop-rotation-scenario winter-wheat_clover -td "${TMPDIR}"

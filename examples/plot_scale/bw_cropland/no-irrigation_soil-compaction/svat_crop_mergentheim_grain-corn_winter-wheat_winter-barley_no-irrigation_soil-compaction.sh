...
#SBATCH --job-name=svat_crop_mergentheim_grain-corn_winter-wheat_winter-barley_no-irrigation_soil-compaction
#SBATCH --output=svat_crop_mergentheim_grain-corn_winter-wheat_winter-barley_no-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_mergentheim_grain-corn_winter-wheat_winter-barley_no-irrigation_soil-compaction_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location mergentheim --crop-rotation-scenario grain-corn_winter-wheat_winter-barley -td "${TMPDIR}"

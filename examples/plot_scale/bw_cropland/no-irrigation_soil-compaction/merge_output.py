...
def main():
    ...
    for location in locations:
        for crop_rotation_scenario in crop_rotation_scenarios:
            ...
            path = str(base_path / "output" / dir_name / f"SVATCROP_{location}_{crop_rotation_scenario}.*.nc")
            output_hm_file = base_path / "output" / dir_name / f"SVATCROP_{location}_{crop_rotation_scenario}.nc"

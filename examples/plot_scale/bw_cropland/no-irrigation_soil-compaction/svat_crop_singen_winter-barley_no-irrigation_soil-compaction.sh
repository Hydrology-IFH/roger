...
#SBATCH --job-name=svat_crop_singen_winter-barley_no-irrigation_soil-compaction
#SBATCH --output=svat_crop_singen_winter-barley_no-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_singen_winter-barley_no-irrigation_soil-compaction_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location singen --crop-rotation-scenario winter-barley -td "${TMPDIR}"

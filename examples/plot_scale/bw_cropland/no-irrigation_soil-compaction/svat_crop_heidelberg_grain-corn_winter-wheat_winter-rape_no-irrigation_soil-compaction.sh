...
#SBATCH --job-name=svat_crop_heidelberg_grain-corn_winter-wheat_winter-rape_no-irrigation_soil-compaction
#SBATCH --output=svat_crop_heidelberg_grain-corn_winter-wheat_winter-rape_no-irrigation_soil-compaction.out

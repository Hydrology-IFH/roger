...
#SBATCH --job-name=svat_crop_stoetten_summer-wheat_winter-wheat_silage-corn_no-irrigation_soil-compaction
#SBATCH --output=svat_crop_stoetten_summer-wheat_winter-wheat_silage-corn_no-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_stoetten_summer-wheat_winter-wheat_silage-corn_no-irrigation_soil-compaction_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location stoetten --crop-rotation-scenario summer-wheat_winter-wheat_silage-corn -td "${TMPDIR}"

...
#SBATCH --job-name=svat_crop_hechingen_summer-barley_no-irrigation_soil-compaction
#SBATCH --output=svat_crop_hechingen_summer-barley_no-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_hechingen_summer-barley_no-irrigation_soil-compaction_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location hechingen --crop-rotation-scenario summer-barley -td "${TMPDIR}"

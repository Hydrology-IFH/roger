...
#SBATCH --job-name=svat_crop_freiburg_winter-barley_no-irrigation_soil-compaction
#SBATCH --output=svat_crop_freiburg_winter-barley_no-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_freiburg_winter-barley_no-irrigation_soil-compaction_err.out
#SBATCH --export=ALL

...
#SBATCH --job-name=svat_crop_lahr_summer-wheat_winter-wheat_no-irrigation_soil-compaction
#SBATCH --output=svat_crop_lahr_summer-wheat_winter-wheat_no-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_lahr_summer-wheat_winter-wheat_no-irrigation_soil-compaction_err.out
#SBATCH --export=ALL

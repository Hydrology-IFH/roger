...
#SBATCH --job-name=svat_crop_notzingen_summer-barley_no-irrigation_soil-compaction
#SBATCH --output=svat_crop_notzingen_summer-barley_no-irrigation_soil-compaction.out

...
#SBATCH --job-name=svat_crop_weingarten_potato-early_no-irrigation_soil-compaction
#SBATCH --output=svat_crop_weingarten_potato-early_no-irrigation_soil-compaction.out
#SBATCH --error=svat_crop_weingarten_potato-early_no-irrigation_soil-compaction_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location weingarten --crop-rotation-scenario potato-early -td "${TMPDIR}"

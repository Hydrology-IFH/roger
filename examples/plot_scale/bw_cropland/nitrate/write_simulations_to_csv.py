                    ...
                    for crop_rotation_scenario in crop_rotation_scenarios:
                        ...
                        if os.path.exists(roger_file):
                            ...
                            if irrigation_scenario == "no-irrigation":
                                ...
                                dir_csv_files = base_path / "output" / dir_name / f"{irrigation_scenario}{_soil_compaction_scenario}" / "crop-specific" / crop_rotation_scenario / location
                            ...
                            for x, soil_type in enumerate(soil_types):
                                if irrigation_scenario == "no-irrigation":
                                    ...
                                    dir_csv_files = base_path / "output" / dir_name / f"{irrigation_scenario}{_soil_compaction_scenario}" / "crop-specific" / crop_rotation_scenario / location / soil_type
                                if not os.path.exists(dir_csv_files):
                                    os.makedirs(dir_csv_files)
                            ...
                            if irrigation_scenario == "no-irrigation":
                                ...
                                dir_csv_files = base_path / "output" / dir_name / f"{irrigation_scenario}{_soil_compaction_scenario}" / "crop-specific" / crop_rotation_scenario / location / "area_weighted"
                            if not os.path.exists(dir_csv_files):
                                os.makedirs(dir_csv_files)
                            df_simulation.to_csv(
                                    dir_csv_files / "simulation.csv", sep=";"

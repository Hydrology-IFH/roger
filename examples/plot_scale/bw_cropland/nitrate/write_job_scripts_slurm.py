    ...
    for location in locations:# --- jobs to calculate fluxes and states for each irrigation scenario -------------------------
        for crop_rotation_scenario in crop_rotation_scenarios:
            for irrigation_scenario in irrigation_scenarios:
                ...
                script_name = f"svat_crop_{location}_{irrigation_scenario}_{crop_rotation_scenario}_soil-compaction"
            ...
            script_name = f"svat_crop_{location}_{crop_rotation_scenario}_soil-compaction"

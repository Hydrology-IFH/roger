            ...
            if os.path.exists(str(base_path / "output" / dir_name / scenario)):
                for crop_rotation_scenario in crop_rotation_scenarios:
                    ...
                    if scenario == "no-irrigation":
                        path = str(base_path / "output" / dir_name / scenario / f"SVATCROPNITRATE_{location}_{crop_rotation_scenario}_no-irrigation.*.nc")
                        output_file = base_path / "output" / dir_name / scenario / f"SVATCROPNITRATE_{location}_{crop_rotation_scenario}.nc"
                    elif scenario == "no-irrigation_soil-compaction":
                        path = str(base_path / "output" / dir_name / scenario / f"SVATCROPNITRATE_{location}_{crop_rotation_scenario}_no-irrigation_soil-compaction.*.nc")
                        output_file = base_path / "output" / dir_name / scenario / f"SVATCROPNITRATE_{location}_{crop_rotation_scenario}.nc"
                    elif scenario == "irrigation_soil-compaction":
                        path = str(base_path / "output" / dir_name / scenario / "crop-specific" / f"SVATCROPNITRATE_{location}_{crop_rotation_scenario}_crop-specific-irrigation_soil-compaction.*.nc")
                        output_file = base_path / "output" / dir_name / scenario / "crop-specific" / f"SVATCROPNITRATE_{location}_{crop_rotation_scenario}.nc"
                    elif scenario == "irrigation":
                        path = str(base_path / "output" / dir_name / scenario / "crop-specific" / f"SVATCROPNITRATE_{location}_{crop_rotation_scenario}_crop-specific-irrigation.*.nc")
                        output_file = base_path / "output" / dir_name / scenario / "crop-specific" / f"SVATCROPNITRATE_{location}_{crop_rotation_scenario}.nc"

...
path = str(base_path / "DISTEVENT.*.nc")
...
# assign date
days = ds_sim['Time'].values * 24
seconds = onp.around(days.astype('timedelta64[s]').astype(float), 1)
hours_sim = seconds / (60 * 60)

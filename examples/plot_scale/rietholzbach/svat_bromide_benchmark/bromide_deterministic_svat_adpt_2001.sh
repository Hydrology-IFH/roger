...
#PBS -l pmem=4000mb
#PBS -N bromide_deterministic_svat_adpt_2001
...
python svat_transport.py -b jax -d cpu -tms time-variant_advection-dispersion-power -td "${TMPDIR}" -ss deterministic -y 2001

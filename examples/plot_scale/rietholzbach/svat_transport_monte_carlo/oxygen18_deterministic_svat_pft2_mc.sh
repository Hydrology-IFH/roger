...
mpirun --bind-to core --map-by core -report-bindings python svat_transport.py --log-all-processes -b jax -d cpu -n 20 1 -ns 5000 -tms time-variant_preferential2 -td "${TMPDIR}" -ss deterministic

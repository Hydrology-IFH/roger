...
MPI4JAX_USE_CUDA_MPI=1 mpirun --bind-to core --map-by core -report-bindings python svat_transport.py --log-all-processes -b jax -d gpu -n 2 1 -ns 400 -tms time-variant_preferential1 -td "${TMPDIR}" -ss deterministic

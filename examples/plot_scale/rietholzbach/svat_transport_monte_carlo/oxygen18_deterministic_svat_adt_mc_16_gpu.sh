...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adt_mc_16
#PBS -m bea
...
python svat_transport.py --log-all-processes --id 16 -b jax -d gpu -ns 500 -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss deterministic

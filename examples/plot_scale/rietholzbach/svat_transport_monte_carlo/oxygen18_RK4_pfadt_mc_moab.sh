...
mpirun --bind-to core --map-by core -report-bindings python svat_transport.py --log-all-processes -b numpy -d cpu -n 20 1 -ns 2000 -tms time-variant_preferential_+_advection-dispersion -td "${TMPDIR}" -ss RK4

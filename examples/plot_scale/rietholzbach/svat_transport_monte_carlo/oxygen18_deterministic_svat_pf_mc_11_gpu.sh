...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_pf_mc_11
#PBS -m bea
...
python svat_transport.py --log-all-processes --id 11 -b jax -d gpu -ns 500 -tms preferential -td "${TMPDIR}" -ss deterministic

...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_ad_mc_15
#PBS -m bea
...
python svat_transport.py --log-all-processes --id 15 -b jax -d gpu -ns 500 -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

...
for tm in transport_models:
    ...
    lines.append('#SBATCH --ntasks-per-node=10\n')
    lines.append('#SBATCH --mem=60000\n')
    ...
    lines.append(f'mpirun --bind-to core --map-by core -report-bindings python svat_transport.py -b jax -d cpu -n 50 1 -ns 10000 -tms {tms}\n')

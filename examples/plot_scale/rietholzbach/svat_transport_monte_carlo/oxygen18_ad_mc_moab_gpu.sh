...
mpirun --bind-to core --map-by core -report-bindings python svat_transport.py -b jax -d gpu -n 100 1 -tms advection-dispersion -td /beegfs/work/workspace/ws/fr_rs1092-workspace-0/rietholzbach/svat_transport_monte_carlo

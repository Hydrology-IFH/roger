...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_tv_mc_1
#PBS -m bea
...
python svat_transport.py --log-all-processes --id 1 -b jax -d gpu -ns 1000 -tms time-variant -td "${TMPDIR}" -ss deterministic

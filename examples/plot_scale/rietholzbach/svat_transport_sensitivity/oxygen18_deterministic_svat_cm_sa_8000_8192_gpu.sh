...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_cm_sa_8000_8192
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 8000 --x2 8192 -b jax -d gpu -tms complete-mixing -td "${TMPDIR}" -dd /beegfs/work/workspace/ws/fr_rs1092-workspace-0/rietholzbach/svat_transport_sensitivity -ss deterministic

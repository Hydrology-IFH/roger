...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_ad_sa_9000_10000
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 9000 --x2 10000 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -dd /beegfs/work/workspace/ws/fr_rs1092-workspace-0/rietholzbach/svat_transport_sensitivity -ss deterministic

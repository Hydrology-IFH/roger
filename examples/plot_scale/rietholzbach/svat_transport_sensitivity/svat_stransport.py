...
class SVATTRANSPORTSetup(RogerSetup):
    ...
    def set_parameters(self, state):
        ...
        if settings.tm_structure == "complete-mixing":
            ...
            vs.sas_params_transp = update(vs.sas_params_transp, at[:2, :, 2], 3)  # fill ghosts
            vs.sas_params_transp = update(vs.sas_params_transp, at[-2:, :, 2], 3)
            vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[:, :, 0], 3)
            vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[:, :, 1], 1)
            vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[:, :, 2], npx.repeat(self._params[:, 1, npx.newaxis], vs.sas_params_q_rz.shape[1], axis=-1))
            vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[:2, :, 2], 3)  # fill ghosts
            vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[-2:, :, 2], 3)
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[:, :, 0], 3)
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[:, :, 1], 1)
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[:, :, 2], npx.repeat(self._params[:, 2, npx.newaxis], vs.sas_params_q_ss.shape[1], axis=-1))
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[:2, :, 2], 3)  # fill ghosts
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[-2:, :, 2], 3)
        elif settings.tm_structure == "advection-dispersion":
            vs.sas_params_evap_soil = update(vs.sas_params_evap_soil, at[:, :, 0], 21)
            vs.sas_params_cpr_rz = update(vs.sas_params_cpr_rz, at[:, :, 0], 21)
            vs.sas_params_transp = update(vs.sas_params_transp, at[:, :, 0], 3)
            vs.sas_params_transp = update(vs.sas_params_transp, at[:, :, 1], 1)
            vs.sas_params_transp = update(vs.sas_params_transp, at[:, :, 2], npx.repeat(self._params[:, 0, npx.newaxis], vs.sas_params_transp.shape[1], axis=-1))
            vs.sas_params_transp = update(vs.sas_params_transp, at[:2, :, 2], 3)  # fill ghosts
            vs.sas_params_transp = update(vs.sas_params_transp, at[-2:, :, 2], 3)
            vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[:, :, 0], 3)
            ...
            vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[:2, :, 1], 3)  # fill ghosts
            vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[-2:, :, 1], 3)
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[:, :, 0], 3)
            ...
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[:2, :, 1], 3)  # fill ghosts
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[-2:, :, 1], 3)
            ...
            vs.sas_params_transp = update(vs.sas_params_transp, at[:, :, 4], npx.repeat(self._params[:, 0, npx.newaxis], vs.sas_params_transp.shape[1], axis=-1))
            vs.sas_params_transp = update(vs.sas_params_transp, at[:2, :, 4], 3)  # fill ghosts
            vs.sas_params_transp = update(vs.sas_params_transp, at[-2:, :, 4], 3)
            ...
            vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[:2, :, 4], 3)  # fill ghosts
            vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[-2:, :, 4], 3)
            ...
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[:2, :, 4], 3)  # fill ghosts
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[-2:, :, 4], 3)
...
for tm_structure in tm_structures:
    ...
    # generate sobol sequence for parameters
    model._make_params(2**4)
    model.setup()
    model.warmup()
    model.run()

...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_ad_mc_2000_2500
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 2000 --x2 2500 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

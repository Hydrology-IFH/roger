...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adt_sa_12000_13000
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 12000 --x2 13000 -b jax -d gpu -tms time-variant_advection-dispersion -td "${TMPDIR}" -dd /beegfs/work/workspace/ws/fr_rs1092-workspace-0/rietholzbach/svat_transport_sensitivity -ss deterministic

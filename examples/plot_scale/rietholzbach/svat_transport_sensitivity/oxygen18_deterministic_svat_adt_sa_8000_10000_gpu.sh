...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_adt_sa_8000_10000
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 8000 --x2 10000 -b jax -d gpu -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss deterministic

...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_pi_sa_4000_8000
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 4000 --x2 8000 -b jax -d gpu -tms piston -td "${TMPDIR}" -ss deterministic

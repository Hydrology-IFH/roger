...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_pi_sa_6000_7000
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 6000 --x2 7000 -b jax -d gpu -tms piston -td "${TMPDIR}" -dd /beegfs/work/workspace/ws/fr_rs1092-workspace-0/rietholzbach/svat_transport_sensitivity -ss deterministic

...
@click.option("-tms", "--transport-model-structure", type=click.Choice(['power', 'time-variant_power']), default='power')
...
def main(nsamples, transport_model_structure, sas_solver, tmp_dir):
    ...
    class SVATTRANSPORTSetup(RogerSetup):
        ...
        def set_diagnostics(self, state, base_path=tmp_dir):
            ...
            diagnostics["collect"].output_variables = ["TT_transp", "TT_q_ss", "SA_s"]

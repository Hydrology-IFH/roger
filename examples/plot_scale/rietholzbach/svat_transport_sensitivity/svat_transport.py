...
@click.option("-tms", "--transport-model-structure", type=click.Choice(['complete-mixing', 'piston', 'preferential', 'complete-mixing_+_advection-dispersion', 'advection-dispersion', 'time-variant_preferential', 'complete-mixing_+_time-variant_advection-dispersion', 'time-variant_advection-dispersion', 'time-variant']), default='advection-dispersion')

...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_cm_sa_4000_8000
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 4000 --x2 8000 -b jax -d gpu -tms complete-mixing -td "${TMPDIR}" -ss deterministic

...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adt_mc_2500_3000
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 2500 --x2 3000 -b jax -d gpu -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss deterministic

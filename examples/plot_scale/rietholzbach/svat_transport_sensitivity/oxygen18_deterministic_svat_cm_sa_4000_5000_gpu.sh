...
python svat_transport.py --log-all-processes --x1 4000 --x2 5000 -b jax -d gpu -tms complete-mixing -td "${TMPDIR}" -dd /beegfs/work/workspace/ws/fr_rs1092-workspace-0/rietholzbach/svat_transport_sensitivity -ss deterministic

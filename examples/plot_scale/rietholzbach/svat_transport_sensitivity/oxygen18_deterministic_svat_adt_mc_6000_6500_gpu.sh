...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adt_mc_6000_6500
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 6000 --x2 6500 -b jax -d gpu -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss deterministic

...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_pi_sa_2000_4000
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 2000 --x2 4000 -b jax -d gpu -tms piston -td "${TMPDIR}" -ss deterministic

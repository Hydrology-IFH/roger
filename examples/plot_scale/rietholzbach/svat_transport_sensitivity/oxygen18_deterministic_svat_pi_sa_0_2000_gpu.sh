...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_pi_sa_0_2000
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 0 --x2 2000 -b jax -d gpu -tms piston -td "${TMPDIR}" -ss deterministic

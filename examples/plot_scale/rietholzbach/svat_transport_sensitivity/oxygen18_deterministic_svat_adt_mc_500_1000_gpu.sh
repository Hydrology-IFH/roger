...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adt_mc_500_1000
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 500 --x2 1000 -b jax -d gpu -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss deterministic

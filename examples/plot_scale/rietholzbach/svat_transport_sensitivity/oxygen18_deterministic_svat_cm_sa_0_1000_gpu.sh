...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_cm_sa_0_1000
#PBS -m bea
...
python svat_transport.py --log-all-processes --x1 0 --x2 1000 -b jax -d gpu -tms complete-mixing -td "${TMPDIR}" -dd /beegfs/work/workspace/ws/fr_rs1092-workspace-0/rietholzbach/svat_transport_sensitivity -ss deterministic

    ...
    class SVATTRANSPORTSetup(RogerSetup):
        ...
        def set_parameters_setup(self, state):
            ...
            if settings.tm_structure == "complete-mixing":
                ...
                vs.sas_params_cpr_rz = update(vs.sas_params_cpr_rz, at[2:-2, 2:-2, 2], 100)
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 0], 3)
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 1], self._read_var_from_nc("a_transp", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 2], self._read_var_from_nc("b_transp", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 0], 3)
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 1], self._read_var_from_nc("a_q_rz", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 2], self._read_var_from_nc("b_q_rz", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 0], 3)
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 1], self._read_var_from_nc("a_q_ss", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 2], self._read_var_from_nc("b_q_ss", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                ...
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 1], self._read_var_from_nc("a_transp", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 3], self._read_var_from_nc("c1_transp", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 4], self._read_var_from_nc("c2_transp", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                ...
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 2], self._read_var_from_nc("b_q_rz", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 3], self._read_var_from_nc("c1_q_rz", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 4], self._read_var_from_nc("c2_q_rz", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                ...
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 2], self._read_var_from_nc("b_q_ss", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 3], self._read_var_from_nc("c1_q_ss", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 4], self._read_var_from_nc("c2_q_ss", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                ...
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 1], self._read_var_from_nc("k_transp", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 0], 6)
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 1], self._read_var_from_nc("k_q_rz", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 0], 6)
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 1], self._read_var_from_nc("k_q_ss", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                ...
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 3], self._read_var_from_nc("c1_q_rz", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 4], self._read_var_from_nc("c2_q_rz", self._base_path, 'params_saltelli.nc', group=settings.tm_structure)[x1:x2, :])
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 5], 0)
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 6], vs.S_sat_ss[2:-2, 2:-2] - vs.S_fc_ss[2:-2, 2:-2])
        ...
        def set_initial_conditions_setup(self, state):
            ...
            vs.S_snow = update(vs.S_snow, at[2:-2, 2:-2, :vs.taup1], self._read_var_from_nc("S_snow", self._base_path, f'states_hm_saltelli_for_{transport_model_structure}.nc')[x1:x2, :, vs.itt, npx.newaxis])
            vs.S_rz = update(vs.S_rz, at[2:-2, 2:-2, :vs.taup1], self._read_var_from_nc("S_rz", self._base_path, f'states_hm_saltelli_for_{transport_model_structure}.nc')[x1:x2, :, vs.itt, npx.newaxis] - vs.S_pwp_rz[2:-2, 2:-2, npx.newaxis])
            vs.S_ss = update(vs.S_ss, at[2:-2, 2:-2, :vs.taup1], self._read_var_from_nc("S_ss", self._base_path, f'states_hm_saltelli_for_{transport_model_structure}.nc')[x1:x2, :, vs.itt, npx.newaxis] - vs.S_pwp_ss[2:-2, 2:-2, npx.newaxis])

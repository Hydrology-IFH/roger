...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_ad_sa_5000_5500
#PBS -m bea
...
python svat_transport.py --x1 5000 --x2 5500 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

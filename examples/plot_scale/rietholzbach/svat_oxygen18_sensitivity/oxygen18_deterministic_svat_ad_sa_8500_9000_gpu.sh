...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_ad_sa_8500_9000
#PBS -m bea
...
python svat_transport.py --x1 8500 --x2 9000 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

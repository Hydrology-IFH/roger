...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_adt_sa_10000_10500
#PBS -m bea
...
python svat_transport.py --x1 10000 --x2 10500 -b jax -d gpu -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss deterministic

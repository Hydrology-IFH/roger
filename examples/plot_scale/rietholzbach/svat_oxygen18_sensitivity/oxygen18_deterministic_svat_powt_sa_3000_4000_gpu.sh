...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_powt_sa_3000_4000
#PBS -m bea
...
python svat_transport.py --x1 3000 --x2 4000 -b jax -d gpu -tms time-variant_power -td "${TMPDIR}" -ss deterministic

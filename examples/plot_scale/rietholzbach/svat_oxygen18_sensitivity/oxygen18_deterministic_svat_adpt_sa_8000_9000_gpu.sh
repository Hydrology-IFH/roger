...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adpt_sa_8000_9000
#PBS -m bea
...
python svat_transport.py --x1 8000 --x2 9000 -b jax -d gpu -tms time-variant_advection-dispersion-power -td "${TMPDIR}" -ss deterministic

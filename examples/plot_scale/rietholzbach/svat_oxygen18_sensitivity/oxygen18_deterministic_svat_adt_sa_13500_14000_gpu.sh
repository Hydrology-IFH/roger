...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_adt_sa_13500_14000
#PBS -m bea
...
python svat_transport.py --x1 13500 --x2 14000 -b jax -d gpu -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss deterministic

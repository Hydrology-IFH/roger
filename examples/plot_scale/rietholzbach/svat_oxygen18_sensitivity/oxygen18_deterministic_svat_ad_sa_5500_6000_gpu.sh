...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_ad_sa_5500_6000
#PBS -m bea
...
python svat_transport.py --x1 5500 --x2 6000 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

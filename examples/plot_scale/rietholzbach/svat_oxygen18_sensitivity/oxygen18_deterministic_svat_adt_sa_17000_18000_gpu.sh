...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_adt_sa_17000_18000
#PBS -m bea
...
python svat_transport.py --x1 17000 --x2 18000 -b jax -d gpu -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss deterministic

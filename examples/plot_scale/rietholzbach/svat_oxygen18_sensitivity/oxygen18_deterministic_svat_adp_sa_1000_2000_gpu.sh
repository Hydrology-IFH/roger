...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adp_sa_1000_2000
#PBS -m bea
...
python svat_transport.py --x1 1000 --x2 2000 -b jax -d gpu -tms advection-dispersion-power -td "${TMPDIR}" -ss deterministic

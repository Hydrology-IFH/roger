...
#SBATCH --output=svat18O_cm_sa.out
#SBATCH --error=svat18O_cm_sa_err.out
#SBATCH --export=ALL
...
mpirun --bind-to core --map-by core -report-bindings python svat_oxygen18.py -b jax -d cpu -n 20 1 --float-type float64 -ns 10240 -tms complete-mixing -td "${TMPDIR}"

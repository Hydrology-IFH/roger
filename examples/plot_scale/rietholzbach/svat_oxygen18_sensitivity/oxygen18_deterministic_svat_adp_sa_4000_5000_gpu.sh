...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adp_sa_4000_5000
#PBS -m bea
...
python svat_transport.py --x1 4000 --x2 5000 -b jax -d gpu -tms advection-dispersion-power -td "${TMPDIR}" -ss deterministic

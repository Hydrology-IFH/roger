...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_ad_sa_16000_16384
#PBS -m bea
...
python svat_transport.py --x1 16000 --x2 16384 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

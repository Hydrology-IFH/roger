...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_adt_sa_12000_12500
#PBS -m bea
...
python svat_transport.py --x1 12000 --x2 12500 -b jax -d gpu -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss deterministic

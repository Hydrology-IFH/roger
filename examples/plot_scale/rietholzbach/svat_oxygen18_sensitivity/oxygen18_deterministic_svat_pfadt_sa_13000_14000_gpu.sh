...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_pfadt_sa_13000_14000
#PBS -m bea
...
python svat_transport.py --x1 13000 --x2 14000 -b jax -d gpu -tms time-variant_preferential_+_advection-dispersion -td "${TMPDIR}" -ss deterministic

...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_cm_sa_10000_10240
#PBS -m bea
...
python svat_transport.py --x1 10000 --x2 10240 -b jax -d gpu -tms complete-mixing -td "${TMPDIR}" -ss deterministic

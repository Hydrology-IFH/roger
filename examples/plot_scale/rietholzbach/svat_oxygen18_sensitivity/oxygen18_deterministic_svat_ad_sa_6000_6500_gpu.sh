...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_ad_sa_6000_6500
#PBS -m bea
...
python svat_transport.py --x1 6000 --x2 6500 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

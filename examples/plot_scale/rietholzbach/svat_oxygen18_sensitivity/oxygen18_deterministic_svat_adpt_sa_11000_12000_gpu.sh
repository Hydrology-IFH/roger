...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adpt_sa_11000_12000
#PBS -m bea
...
python svat_transport.py --x1 11000 --x2 12000 -b jax -d gpu -tms time-variant_advection-dispersion-power -td "${TMPDIR}" -ss deterministic

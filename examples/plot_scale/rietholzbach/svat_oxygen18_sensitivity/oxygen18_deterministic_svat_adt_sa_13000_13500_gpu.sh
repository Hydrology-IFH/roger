...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_adt_sa_13000_13500
#PBS -m bea
...
python svat_transport.py --x1 13000 --x2 13500 -b jax -d gpu -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss deterministic

...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_powt_sa_16000_16384
#PBS -m bea
...
python svat_transport.py --x1 16000 --x2 16384 -b jax -d gpu -tms time-variant_power -td "${TMPDIR}" -ss deterministic

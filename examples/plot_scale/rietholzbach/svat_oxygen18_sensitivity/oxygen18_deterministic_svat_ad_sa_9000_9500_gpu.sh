...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_ad_sa_9000_9500
#PBS -m bea
...
python svat_transport.py --x1 9000 --x2 9500 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

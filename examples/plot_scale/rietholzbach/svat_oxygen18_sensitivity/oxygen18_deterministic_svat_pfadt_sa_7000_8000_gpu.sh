...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_pfadt_sa_7000_8000
#PBS -m bea
...
python svat_transport.py --x1 7000 --x2 8000 -b jax -d gpu -tms time-variant_preferential_+_advection-dispersion -td "${TMPDIR}" -ss deterministic

...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_adt_sa_10500_11000
#PBS -m bea
...
python svat_transport.py --x1 10500 --x2 11000 -b jax -d gpu -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss deterministic

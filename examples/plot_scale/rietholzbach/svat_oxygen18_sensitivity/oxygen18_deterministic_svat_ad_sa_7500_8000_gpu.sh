...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_ad_sa_7500_8000
#PBS -m bea
...
python svat_transport.py --x1 7500 --x2 8000 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

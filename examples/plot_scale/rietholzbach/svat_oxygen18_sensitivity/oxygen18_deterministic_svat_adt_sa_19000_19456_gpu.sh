...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adt_sa_19000_19456
#PBS -m bea
...
python svat_transport.py --x1 19000 --x2 19456 -b jax -d gpu -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss deterministic

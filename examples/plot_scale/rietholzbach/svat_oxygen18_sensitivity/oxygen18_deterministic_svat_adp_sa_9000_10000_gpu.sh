...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adp_sa_9000_10000
#PBS -m bea
...
python svat_transport.py --x1 9000 --x2 10000 -b jax -d gpu -tms advection-dispersion-power -td "${TMPDIR}" -ss deterministic

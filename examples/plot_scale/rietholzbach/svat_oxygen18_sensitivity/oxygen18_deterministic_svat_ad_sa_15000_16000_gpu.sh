...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_ad_sa_15000_16000
#PBS -m bea
...
python svat_transport.py --x1 15000 --x2 16000 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

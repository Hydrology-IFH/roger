...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_ad_sa_6500_7000
#PBS -m bea
...
python svat_transport.py --x1 6500 --x2 7000 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

...
#PBS -l pmem=24000mb
#PBS -N oxygen18_deterministic_svat_ad_sa_7000_7500
#PBS -m bea
...
python svat_transport.py --x1 7000 --x2 7500 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

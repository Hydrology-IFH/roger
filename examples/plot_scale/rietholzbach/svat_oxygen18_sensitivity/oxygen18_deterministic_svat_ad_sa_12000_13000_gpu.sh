...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_ad_sa_12000_13000
#PBS -m bea
...
python svat_transport.py --x1 12000 --x2 13000 -b jax -d gpu -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

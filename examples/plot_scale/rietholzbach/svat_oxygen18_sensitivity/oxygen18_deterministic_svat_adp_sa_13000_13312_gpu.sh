...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adp_sa_13000_13312
#PBS -m bea
...
python svat_transport.py --x1 13000 --x2 13312 -b jax -d gpu -tms advection-dispersion-power -td "${TMPDIR}" -ss deterministic

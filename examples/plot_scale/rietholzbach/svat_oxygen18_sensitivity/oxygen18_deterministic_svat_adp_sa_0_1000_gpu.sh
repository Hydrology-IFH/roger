...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adp_sa_0_1000
#PBS -m bea
...
python svat_transport.py --x1 0 --x2 1000 -b jax -d gpu -tms advection-dispersion-power -td "${TMPDIR}" -ss deterministic

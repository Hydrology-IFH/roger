...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_powt_sa_5000_6000
#PBS -m bea
...
python svat_transport.py --x1 5000 --x2 6000 -b jax -d gpu -tms time-variant_power -td "${TMPDIR}" -ss deterministic

...
def main(tmp_dir):
    ...
    states_hm1_file = base_path / "svat_monte_carlo" / f"optimized_with_{metric_for_opt}" / "states_hm1.nc"
    ds_sim_hm1 = xr.open_dataset(states_hm1_file, engine="h5netcdf")
    # assign date
    days_sim_hm1 = (ds_sim_hm1['Time'].values / onp.timedelta64(24 * 60 * 60, "s"))
    date_sim_hm1 = num2date(days_sim_hm1, units=f"days since {ds_sim_hm1['Time'].attrs['time_origin']}", calendar='standard', only_use_cftime_datetimes=False)
    ds_sim_hm1 = ds_sim_hm1.assign_coords(Time=("Time", date_sim_hm1))
    # load best 10 monte carlo simulations
    states_hm10_file = base_path / "svat_monte_carlo" / f"optimized_with_{metric_for_opt}" / "states_hm10.nc"
    ...
    states_hm_for_tm_file = base_path / "svat_oxygen18_monte_carlo" / "deterministic" / "age_max_1500_days" / f"optimized_with_{metric_for_opt}_hm100" / "states_hm_best_for_advection-dispersion-power.nc"
    ...
    axs[1].plot(df_obs.index, df_obs.loc[:, 'd18O_perc'].fillna(method='bfill'),
                '-', color='grey')
    axs[1].scatter(df_obs.index, df_obs.loc[:, 'd18O_perc'],
                   color='grey', s=1)
    ...
    fig.tight_layout()
    fig.text(0.12, 0.92, "(a)", ha="center", va="center", fontsize=8)
    ...
    axes[0, 0].plot(dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index, dict_obs['PREC_corr'].loc['1997-01-07':'1999', 'obs'].cumsum(), lw=1, color='blue', ls='-', alpha=1)
    axes[0, 0].set_ylabel('PRECIP\n[mm]')
    axes[0, 0].set_xlim((dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index[0], dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index[-1]))
    axes[0, 0].set_ylim(0,)
    axes[0, 0].invert_yaxis()
    ax2 = axes[0, 0].twinx()
    ax2.plot(dict_obs_sim['AET'].loc['1997-01-07':'1999', :].index, dict_obs_sim['AET'].loc['1997-01-07':'1999', 'obs'].cumsum(),
              lw=1, color='blue', ls='-', alpha=0.5)
    ax2.plot(dict_obs_sim['AET'].loc['1997-01-07':'1999', :].index, dict_obs_sim['AET'].loc['1997-01-07':'1999', 'sim'].cumsum(),
              lw=1, color='red', ls='-.')
    ax2.plot(dict_obs_sim_hydrus['AET'].loc['1997-01-07':'1999', :].index, dict_obs_sim_hydrus['AET'].loc['1997-01-07':'1999', 'sim'].cumsum(),
              lw=1, color='gray', ls='-.')
    ax2.set_ylim(0,)
    ax2.set_ylabel('ET\n[mm]')
    ...
    ax2.set_ylim(0,)
    ax2.set_ylabel('ET\n[mm]')
    axes[1, 0].plot(dict_obs_sim['dWEIGHT'].loc['1997-01-07':'1999', :].index, dict_obs_sim['dWEIGHT'].loc['1997-01-07':'1999', 'sim'].cumsum(),
                  lw=1, color='red', ls='-.')
    axes[1, 0].plot(dict_obs_sim_hydrus['dWEIGHT'].loc['1997-01-07':'1999', :].index, dict_obs_sim_hydrus['dWEIGHT'].loc['1997-01-07':'1999', 'sim'].cumsum(),
                  lw=1, color='gray', ls='-.')
    axes[1, 0].set_ylabel('cum. $\Delta$S\n[mm]')
    axes[1, 0].set_xlim((dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index[0], dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index[-1]))
    ...
    axes[2, 0].plot(dict_obs_sim['PERC'].loc['1997-01-07':'1999', :].index, dict_obs_sim['PERC'].loc['1997-01-07':'1999', 'obs'].cumsum(),
                  lw=1, color='blue', ls='-', alpha=0.5)
    axes[2, 0].plot(dict_obs_sim['PERC'].loc['1997-01-07':'1999', :].index, dict_obs_sim['PERC'].loc['1997-01-07':'1999', 'sim'].cumsum(),
                  lw=1, color='red', ls='-.')
    axes[2, 0].plot(dict_obs_sim_hydrus['PERC'].loc['1997-01-07':'1999', :].index, dict_obs_sim_hydrus['PERC'].loc['1997-01-07':'1999', 'sim'].cumsum(),
                  lw=1, color='gray', ls='-.')
    axes[2, 0].set_ylim(0,)
    axes[2, 0].xaxis.set_major_formatter(mdates.DateFormatter('%y-%m'))
    axes[2, 0].tick_params(axis='x', rotation=33)
    axes[2, 0].invert_yaxis()
    axes[2, 0].set_xlim((dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index[0], dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index[-1]))
    ...
    fig, axes = plt.subplots(3, 2, sharex='col', figsize=(6, 3))
    axes[0, 0].plot(dict_obs['PREC'].loc['1997-01-07':'1999', :].index, dict_obs['PREC'].loc['1997-01-07':'1999', 'obs'].cumsum(), lw=1, color='blue', ls='-', alpha=1)
    axes[0, 0].set_ylabel('PRECIP\n[mm]')
    axes[0, 0].set_xlim((dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index[0], dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index[-1]))
    axes[0, 0].set_ylim(0,)
    axes[0, 0].invert_yaxis()
    ...
    for nrow in range(nx):
        ax2.plot(dict_obs_sim100['AET'].loc['1997-01-07':'1999', :].index, dict_obs_sim100['AET'].loc['1997-01-07':'1999', f'sim{nrow}'].cumsum(),
                  lw=1, color='red', ls='-', alpha=.8)
    ax2.plot(dict_obs_sim100['AET'].loc['1997-01-07':'1999', :].index, dict_obs_sim100['AET'].loc['1997-01-07':'1999', 'obs'].cumsum(),
    ...
    ax2.set_ylabel('ET\n[mm]')
    for nrow in range(nx):
        axes[1, 0].plot(dict_obs_sim100['dWEIGHT'].loc['1997-01-07':'1999', :].index, dict_obs_sim100['dWEIGHT'].loc['1997-01-07':'1999', f'sim{nrow}'].cumsum(),
                  lw=1, color='red', ls='-')
    axes[1, 0].plot(dict_obs_sim_hydrus['dWEIGHT'].loc['1997-01-07':'1999', :].index, dict_obs_sim_hydrus['dWEIGHT'].loc['1997-01-07':'1999', 'sim'].cumsum(),
    ...
    axes[1, 1].set_xlim((dict_obs['PREC_corr'].loc['2006':, :].index[0], dict_obs['PREC_corr'].loc['2006':, :].index[-1]))
    for nrow in range(nx):
        axes[2, 0].plot(dict_obs_sim100['PERC'].loc['1997-01-07':'1999', :].index, dict_obs_sim100['PERC'].loc['1997-01-07':'1999', f'sim{nrow}'].cumsum(),
                  lw=1, color='red', ls='-', alpha=.8)
    axes[2, 0].plot(dict_obs_sim['PERC'].loc['1997-01-07':'1999', :].index, dict_obs_sim['PERC'].loc['1997-01-07':'1999', 'obs'].cumsum(),
                  lw=1, color='blue', ls='-', alpha=1)
    axes[2, 0].plot(dict_obs_sim_hydrus['PERC'].loc['1997-01-07':'1999', :].index, dict_obs_sim_hydrus['PERC'].loc['1997-01-07':'1999', 'sim'].cumsum(),
    ...
    ax2 = axes[0, 0].twinx()
    for nrow in range(nx):
        ax2.plot(dict_obs_sim10['AET'].loc['1997-01-07':'1999', :].index, dict_obs_sim10['AET'].loc['1997-01-07':'1999', f'sim{nrow}'].cumsum(),
                  lw=1, color='red', ls='-', alpha=.8)
    ax2.plot(dict_obs_sim10['AET'].loc['1997-01-07':'1999', :].index, dict_obs_sim10['AET'].loc['1997-01-07':'1999', 'obs'].cumsum(),
              lw=1, color='blue', ls='-', alpha=1)
    ax2.plot(dict_obs_sim_hydrus['AET'].loc['1997-01-07':'1999', :].index, dict_obs_sim_hydrus['AET'].loc['1997-01-07':'1999', 'sim'].cumsum(),
              lw=1, color='gray', ls='-.')
    ax2.set_ylim(0,)
    ...
    ax2 = axes[0, 1].twinx()
    for nrow in range(nx):
        ax2.plot(dict_obs_sim10['AET'].loc['2006':, :].index, dict_obs_sim10['AET'].loc['2006':, f'sim{nrow}'].cumsum(),
                  lw=1, color='red', ls='-', alpha=.8)
    ax2.plot(dict_obs_sim10['AET'].loc['2006':, :].index, dict_obs_sim10['AET'].loc['2006':, 'obs'].cumsum(),
              lw=1, color='blue', ls='-', alpha=1)
    ax2.plot(dict_obs_sim_hydrus['AET'].loc['2006':, :].index, dict_obs_sim_hydrus['AET'].loc['2006':, 'sim'].cumsum(),
              lw=1, color='gray', ls='-.')
    ax2.set_ylim(0,)
    ax2.set_ylabel('ET\n[mm]')
    for nrow in range(nx):
        axes[1, 0].plot(dict_obs_sim10['dWEIGHT'].loc['1997-01-07':'1999', :].index, dict_obs_sim10['dWEIGHT'].loc['1997-01-07':'1999', f'sim{nrow}'].cumsum(),
                  lw=1, color='red', ls='-')
    axes[1, 0].plot(dict_obs_sim_hydrus['dWEIGHT'].loc['1997-01-07':'1999', :].index, dict_obs_sim_hydrus['dWEIGHT'].loc['1997-01-07':'1999', 'sim'].cumsum(),
                  lw=1, color='gray', ls='-.', alpha=.8)
    axes[1, 0].set_ylabel('cum. $\Delta$S\n[mm]')
    axes[1, 0].set_xlim((dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index[0], dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index[-1]))
    for nrow in range(nx):
        axes[1, 1].plot(dict_obs_sim10['dWEIGHT'].loc['2006':, :].index, dict_obs_sim10['dWEIGHT'].loc['2006':, f'sim{nrow}'].cumsum(),
                  lw=1, color='red', ls='-')
    axes[1, 1].plot(dict_obs_sim10['dWEIGHT'].loc['2006':, :].index, dict_obs_sim10['dWEIGHT'].loc['2006':, 'obs'].cumsum(),
                  lw=1, color='blue', ls='-', alpha=1)
    axes[1, 1].plot(dict_obs_sim_hydrus['dWEIGHT'].loc['2006':, :].index, dict_obs_sim_hydrus['dWEIGHT'].loc['2006':, 'sim'].cumsum(),
                  lw=1, color='gray', ls='-.', alpha=.8)
    axes[1, 1].set_ylabel('cum. $\Delta$S\n[mm]')
    axes[1, 1].set_xlim((dict_obs['PREC_corr'].loc['2006':, :].index[0], dict_obs['PREC_corr'].loc['2006':, :].index[-1]))
    for nrow in range(nx):
        axes[2, 0].plot(dict_obs_sim10['PERC'].loc['1997-01-07':'1999', :].index, dict_obs_sim10['PERC'].loc['1997-01-07':'1999', f'sim{nrow}'].cumsum(),
                  lw=1, color='red', ls='-', alpha=.8)
    axes[2, 0].plot(dict_obs_sim['PERC'].loc['1997-01-07':'1999', :].index, dict_obs_sim['PERC'].loc['1997-01-07':'1999', 'obs'].cumsum(),
                  lw=1, color='blue', ls='-', alpha=1)
    axes[2, 0].plot(dict_obs_sim_hydrus['PERC'].loc['1997-01-07':'1999', :].index, dict_obs_sim_hydrus['PERC'].loc['1997-01-07':'1999', 'sim'].cumsum(),
    ...
    axes[2, 0].tick_params(axis='x', rotation=33)
    for nrow in range(nx):
        axes[2, 1].plot(dict_obs_sim10['PERC'].loc['2006':, :].index, dict_obs_sim10['PERC'].loc['2006':, f'sim{nrow}'].cumsum(),
                  lw=1, color='red', ls='-', alpha=.8)
    axes[2, 1].plot(dict_obs_sim['PERC'].loc['2006':, :].index, dict_obs_sim['PERC'].loc['2006':, 'obs'].cumsum(),
                  lw=1, color='blue', ls='-', alpha=1)
    # axes[2, 1].plot(dict_obs_sim_hydrus['PERC'].loc['2006':, :].index, dict_obs_sim_hydrus['PERC'].loc['2006':, 'sim'].cumsum(),
    ...
    for year in years:
        ...
        axes[0].bar(dict_obs['PREC_corr'].loc[f'{year}', :].index, dict_obs['PREC_corr'].loc[f'{year}', 'obs'], width=.1, color='blue', align='edge', edgecolor='blue')
        ...
        axes[1].plot(dict_obs_sim_hydrus['AET'].loc[f'{year}', :].index, dict_obs_sim_hydrus['AET'].loc[f'{year}', 'sim'], lw=1, color='grey', ls='-.', alpha=1)
        ...
        axes[2].plot(dict_obs_sim_hydrus['dWEIGHT'].loc[f'{year}', :].index, dict_obs_sim_hydrus['dWEIGHT'].loc[f'{year}', 'sim'], lw=1, color='grey', ls='-.', alpha=1)
        ...
        axes[3].plot(dict_obs_sim_hydrus['PERC'].loc[f'{year}', :].index, dict_obs_sim_hydrus['PERC'].loc[f'{year}', 'sim'], lw=1, color='grey', ls='-.', alpha=1)
    ...
    for year in years:
        ...
        axes[0].set_xlim((dict_obs['PREC'].loc[f'{year}', :].index[0], dict_obs['PREC'].loc[f'{year}', :].index[-1]))
        axes[0].set_ylim(0,)
        axes[1].plot(dict_obs_sim['AET'].loc[f'{year}', :].index, dict_obs_sim_for_tm['AET'].loc[f'{year}', 'sim'], lw=1, color='red', ls='-.', alpha=1)
        axes[1].plot(dict_obs_sim['AET'].loc[f'{year}', :].index, dict_obs_sim_for_tm['AET'].loc[f'{year}', 'obs'], lw=1, color='blue', ls='-', alpha=0.5)
        axes[1].set_ylabel('ET\n[mm/day]')
        axes[1].set_xlim((dict_obs['PREC'].loc[f'{year}', :].index[0], dict_obs['PREC'].loc[f'{year}', :].index[-1]))
        axes[1].set_ylim(0,)
        axes[2].plot(dict_obs_sim['dWEIGHT'].loc[f'{year}', :].index, dict_obs_sim_for_tm['dWEIGHT'].loc[f'{year}', 'sim'], lw=1, color='red', ls='-.', alpha=1)
        axes[2].plot(dict_obs_sim['dWEIGHT'].loc[f'{year}', :].index, dict_obs_sim_for_tm['dWEIGHT'].loc[f'{year}', 'obs'], lw=1, color='blue', ls='-', alpha=0.5)
        axes[2].set_ylabel('$\Delta$S\n[mm/day]')
        axes[2].set_xlim((dict_obs['PREC'].loc[f'{year}', :].index[0], dict_obs['PREC'].loc[f'{year}', :].index[-1]))
        axes[3].plot(dict_obs_sim['PERC'].loc[f'{year}', :].index, dict_obs_sim_for_tm['PERC'].loc[f'{year}', 'sim'], lw=1, color='red', ls='-.', alpha=1)
        axes[3].plot(dict_obs_sim['PERC'].loc[f'{year}', :].index, dict_obs_sim_for_tm['PERC'].loc[f'{year}', 'obs'], lw=1, color='blue', ls='-', alpha=0.5)
        axes[3].set_ylabel('PERC\n[mm/day]')
        axes[3].set_xlim((dict_obs['PREC'].loc[f'{year}', :].index[0], dict_obs['PREC'].loc[f'{year}', :].index[-1]))
        axes[3].set_ylim(0,)
        axes[3].set_xlabel(r'Time [year-month]')
    ...
    axes[0, 0].invert_yaxis()
    ax2 = axes[0, 0].twinx()
    ax2.plot(dict_obs_sim_for_tm['AET'].loc['1997-01-07':'1999', :].index, dict_obs_sim_for_tm['AET'].loc['1997-01-07':'1999', 'obs'].cumsum(),
              lw=1, color='blue', ls='-', alpha=0.5)
    ax2.plot(dict_obs_sim_for_tm['AET'].loc['1997-01-07':'1999', :].index, dict_obs_sim_for_tm['AET'].loc['1997-01-07':'1999', 'sim'].cumsum(),
              lw=1, color='red', ls='-.')
    ax2.plot(dict_obs_sim_hydrus['AET'].loc['1997-01-07':'1999', :].index, dict_obs_sim_hydrus['AET'].loc['1997-01-07':'1999', 'sim'].cumsum(),
              lw=1, color='gray', ls='-.')
    ax2.set_ylim(0,)
    ...
    axes[0, 1].invert_yaxis()
    ax2 = axes[0, 1].twinx()
    ax2.plot(dict_obs_sim_for_tm['AET'].loc['2006':, :].index, dict_obs_sim_for_tm['AET'].loc['2006':, 'obs'].cumsum(),
              lw=1, color='blue', ls='-', alpha=0.5)
    ax2.plot(dict_obs_sim_for_tm['AET'].loc['2006':, :].index, dict_obs_sim_for_tm['AET'].loc['2006':, 'sim'].cumsum(),
              lw=1, color='red', ls='-.')
    ax2.plot(dict_obs_sim_hydrus['AET'].loc['2006':, :].index, dict_obs_sim_hydrus['AET'].loc['2006':, 'sim'].cumsum(),
              lw=1, color='gray', ls='-.')
    ax2.set_ylim(0,)
    ax2.set_ylabel('ET\n[mm]')
    axes[1, 0].plot(dict_obs_sim_for_tm['dWEIGHT'].loc['1997-01-07':'1999', :].index, dict_obs_sim_for_tm['dWEIGHT'].loc['1997-01-07':'1999', 'sim'].cumsum(),
                  lw=1, color='red', ls='-.')
    axes[1, 0].plot(dict_obs_sim_hydrus['dWEIGHT'].loc['1997-01-07':'1999', :].index, dict_obs_sim_hydrus['dWEIGHT'].loc['1997-01-07':'1999', 'sim'].cumsum(),
                  lw=1, color='gray', ls='-.')
    axes[1, 0].set_ylabel('cum. $\Delta$S\n[mm]')
    axes[1, 0].set_xlim((dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index[0], dict_obs['PREC_corr'].loc['1997-01-07':'1999', :].index[-1]))
    axes[1, 1].plot(dict_obs_sim_for_tm['dWEIGHT'].loc['2006':, :].index, dict_obs_sim_for_tm['dWEIGHT'].loc['2006':, 'obs'].cumsum(),
                  lw=1, color='blue', ls='-', alpha=0.5)
    axes[1, 1].plot(dict_obs_sim_for_tm['dWEIGHT'].loc['2006':, :].index, dict_obs_sim_for_tm['dWEIGHT'].loc['2006':, 'sim'].cumsum(),
                  lw=1, color='red', ls='-.')
    axes[1, 1].plot(dict_obs_sim_hydrus['dWEIGHT'].loc['2006':, :].index, dict_obs_sim_hydrus['dWEIGHT'].loc['2006':, 'sim'].cumsum(),
                  lw=1, color='gray', ls='-.')
    axes[1, 1].set_ylabel('cum. $\Delta$S\n[mm]')
    axes[1, 1].set_xlim((dict_obs['PREC_corr'].loc['2006':, :].index[0], dict_obs['PREC_corr'].loc['2006':, :].index[-1]))
    axes[2, 0].plot(dict_obs_sim_for_tm['PERC'].loc['1997-01-07':'1999', :].index, dict_obs_sim_for_tm['PERC'].loc['1997-01-07':'1999', 'obs'].cumsum(),
                  lw=1, color='blue', ls='-', alpha=0.5)
    axes[2, 0].plot(dict_obs_sim_for_tm['PERC'].loc['1997-01-07':'1999', :].index, dict_obs_sim_for_tm['PERC'].loc['1997-01-07':'1999', 'sim'].cumsum(),
                  lw=1, color='red', ls='-.')
    axes[2, 0].plot(dict_obs_sim_hydrus['PERC'].loc['1997-01-07':'1999', :].index, dict_obs_sim_hydrus['PERC'].loc['1997-01-07':'1999', 'sim'].cumsum(),
                  lw=1, color='gray', ls='-.')
    axes[2, 0].set_ylim(0,)
    ...
    axes[2, 0].set_ylabel('PERC\n[mm]')
    axes[2, 0].set_xlabel(r'Time [year-month]')
    axes[2, 1].plot(dict_obs_sim_for_tm['PERC'].loc['2006':, :].index, dict_obs_sim_for_tm['PERC'].loc['2006':, 'obs'].cumsum(),
                  lw=1, color='blue', ls='-', alpha=0.5)
    axes[2, 1].plot(dict_obs_sim_for_tm['PERC'].loc['2006':, :].index, dict_obs_sim_for_tm['PERC'].loc['2006':, 'sim'].cumsum(),
                  lw=1, color='red', ls='-.')
    axes[2, 1].plot(dict_obs_sim_hydrus['PERC'].loc['2006':, :].index, dict_obs_sim_hydrus['PERC'].loc['2006':, 'sim'].cumsum(),
                  lw=1, color='gray', ls='-.')
    axes[2, 1].set_ylim(0,)
    ...
    for x in range(100):
        inf_tot = ds_sim_hm100['inf_mat_rz'].isel(x=x, y=0).values + ds_sim_hm100['inf_mp_rz'].isel(x=x, y=0).values + ds_sim_hm100['inf_sc_rz'].isel(x=x, y=0).values + ds_sim_hm100['inf_ss'].isel(x=x, y=0).values
    ...
    for x in range(100):
        ...
        axes.plot(df_params_mp_100.loc[df_params_mp_100.index[x], 'ks'], df_params_mp_100.loc[df_params_mp_100.index[x], 'inf_mp_share'], 'o', markersize=1+norm_dmpv(dmpv)*7, color=cmap(norm_lmpv(lmpv)))
    axes.plot(xpred, res.intercept + res.slope*xpred, 'black')
    rlab = r"$R^2$: %s" % (f'{res.rvalue**2:.2f}')
    axes.text(0.1, 0.93, rlab, fontsize=8, horizontalalignment='center',
                  verticalalignment='center', transform=axes.transAxes)
    axes.set_ylim(0,)
    axes.set_ylabel(r'$INF_{mp}$ [%]')
    axes.set_xlabel(r'$k_s$ [mm $h^{-1}$]')
    axl = fig.add_axes([0.8, 0.15, 0.02, 0.5])
    cb1 = mpl.colorbar.ColorbarBase(axl, cmap=cmap, norm=norm_lmpv,
                                    orientation='vertical',
                                    ticks=[10, 500, 1000, 1500])
    ...
    axes.legend([l1, l2, l3, l4], labels, ncol=1, frameon=False,
    handlelength=2, borderpad = 1.8,
    handletextpad=1, title=r'$\rho_{mpv}$ [$m^{-2}$]', scatterpoints = 1, loc='upper right', bbox_to_anchor=(1.33, 1.1))
    ...
    for x in range(100):
        sim_vals = ds_sim_hm100['inf_mat_rz'].isel(x=x, y=0).values + ds_sim_hm100['inf_mp_rz'].isel(x=x, y=0).values + ds_sim_hm100['inf_sc_rz'].isel(x=x, y=0).values + ds_sim_hm100['inf_ss'].isel(x=x, y=0).values
    ...
    axes.plot(ds_sim_hm100['Time'].values, sim_vals_cum, lw=1, color='red', ls='-', alpha=0.8, label='Total infiltration')
    axes.plot(ds_sim_hm100['Time'].values, sim_vals_cum, lw=1, color='red', ls=':', alpha=1, label='Macropore infiltration')
    axes.set_ylabel(r'[mm]')
    axes.set_xlim((ds_sim_hm100['Time'].values[0], ds_sim_hm100['Time'].values[-1]))
    axes.set_ylim(0,)
    axes.set_xlabel(r'Time [year]')
    axes.legend(frameon=False, loc='upper left', fontsize=6)
    fig.tight_layout()
    ...
    prec = ds_sim_hm100['prec'].isel(x=0, y=0).values
    axes.plot(ds_sim_hm100['Time'].values, prec, lw=1, color='blue', ls='-', label='Precipitation')
    sim_vals = ds_sim_hm100['inf_mat_rz'].isel(y=0).values + ds_sim_hm100['inf_mp_rz'].isel(y=0).values + ds_sim_hm100['inf_sc_rz'].isel(y=0).values + ds_sim_hm100['inf_ss'].isel(y=0).values
    ...
    axes.fill_between(ds_sim_hm100['Time'].values, sim_vals_5, sim_vals_95, color='red',
    ...
    axes.fill_between(ds_sim_hm100['Time'].values, sim_vals_5, sim_vals_95, color='orange',
                                    edgecolor=None, alpha=0.2)
    axes.set_ylabel(r'[mm/day]')
    axes.set_xlim((ds_sim_hm100['Time'].values[0], ds_sim_hm100['Time'].values[-1]))
    axes.set_ylim(0,)
    ...
    axes.fill_between(ds_sim_hm100['Time'].values, sim_vals_cum_5, sim_vals_cum_95, color='red',
                                    edgecolor=None, alpha=0.2)
    sim_vals = ds_sim_hm100['inf_mp_rz'].isel(y=0).values + ds_sim_hm100['inf_ss'].isel(y=0).values
    sim_vals_cum = onp.cumsum(sim_vals, axis=1)
    sim_vals_cum_5 = onp.nanquantile(sim_vals_cum, 0.05, axis=0)
    sim_vals_cum_50 = onp.nanmedian(sim_vals_cum, axis=0)
    sim_vals_cum_95 = onp.nanquantile(sim_vals_cum, 0.95, axis=0)
    axes.plot(ds_sim_hm100['Time'].values, sim_vals_cum_50, lw=1, color='orange', ls='-', label='Macropore infiltration')
    axes.fill_between(ds_sim_hm100['Time'].values, sim_vals_cum_5, sim_vals_cum_95, color='orange',
                                    edgecolor=None, alpha=0.2)
    axes.set_ylabel(r'[mm]')
    axes.set_xlim((ds_sim_hm100['Time'].values[0], ds_sim_hm100['Time'].values[-1]))
    axes.set_ylim(0,)
    ...
    prec_cum = onp.cumsum(prec)
    axes.plot(ds_sim_hm100['Time'].values, prec_cum, lw=1, color='blue', ls='-', label='Precipitation')
    sim_vals = ds_sim_hm100['inf_mat_rz'].isel(y=0).values + ds_sim_hm100['inf_mp_rz'].isel(x=0, y=0).values + ds_sim_hm100['inf_sc_rz'].isel(x=0, y=0).values + ds_sim_hm100['inf_ss'].isel(x=0, y=0).values
    sim_vals_cum = onp.cumsum(sim_vals, axis=1)
    sim_vals_cum_5 = onp.nanquantile(sim_vals_cum, 0.05, axis=0)
    sim_vals_cum_50 = onp.nanmedian(sim_vals_cum, axis=0)
    sim_vals_cum_95 = onp.nanquantile(sim_vals_cum, 0.95, axis=0)
    ...
    for tm_structure in ['complete-mixing', 'piston', 'advection-dispersion-power',
                          'time-variant advection-dispersion-power', 'preferential-power', 'older-preference-power',
                          'advection-dispersion-kumaraswamy', 'time-variant advection-dispersion-kumaraswamy']:
    ...
    fig, axes = plt.subplots(6, 2, sharey=True, figsize=(3, 6))
    ...
    ax.flatten()[0].scatter(df_obs.index,
                    df_obs.loc[:, 'd18O_prec'],
                    color='blue', s=1)
    ax.flatten()[0].set_ylabel(r'$\delta^{18}$$O_{PREC}$ [‰]')
    ...
    for i, tm_structure in enumerate(tm_structures):
        ...
        states_tm_file = base_path / "svat_oxygen18_monte_carlo" / "deterministic" / "age_max_1500_days" / "optimized_with_KGE_multi_hm100" / f"states_{tms}_monte_carlo.nc"
    ...
    for year in years:
        ...
        for i, tm_structure in enumerate(tm_structures):
            ...
            ax.flatten()[i+1].plot(ds_sim_tm_year['Time'].values, ds_sim_tm_year['C_iso_q_ss'].isel(x=idx_best, y=0).values, color='red', lw=1)
            ax.flatten()[i+1].plot(ds_hydrus_18O_year['Time'].values, ds_hydrus_18O_year['d18O_perc'].values, color='grey', lw=1)
            ax.flatten()[i+1].scatter(df_obs.index, df_obs.iloc[:, 0], color='blue', s=1)
            ax[i+1].set_ylabel('%s\n$\delta^{18}$$O_{PERC}$ [‰]' % (_LABS_TM[tm_structure]))
            if tm_structure in ['piston']:
                ax.flatten()[i+1].set_ylim((-20, -4))
    ...
    ax[0].set_ylabel(r'$\delta^{18}$$O_{PERC}$ [‰]', fontsize=6)
    ax[0].set_xlabel('Exceedence probabilty [-]', fontsize=6)
    ax[1].set_xlabel('Exceedence probabilty [-]', fontsize=6)
    ax[2].set_xlabel('Exceedence probabilty [-]', fontsize=6)
    ax[3].set_xlabel('Exceedence probabilty [-]', fontsize=6)
    fig.tight_layout()
    ...
    for year in years:
        ...
        axes[0].plot(dict_obs_sim['AET'].loc[f'{year}', :].index, dict_obs_sim['AET'].loc[f'{year}', 'obs'], lw=1, color='blue', ls='-', alpha=0.5)
        ...
        axes[1].plot(dict_obs_sim['dWEIGHT'].loc[f'{year}', :].index, dict_obs_sim['dWEIGHT'].loc[f'{year}', 'obs'], lw=1, color='blue', ls='-', alpha=0.5)
        ...
        axes[2].plot(dict_obs_sim['PERC'].loc[f'{year}', :].index, dict_obs_sim['PERC'].loc[f'{year}', 'obs'], lw=1, color='blue', ls='-', alpha=0.5)
        ...
        axes[3].plot(ds_sim_tm_year['Time'].values, ds_sim_tm_year['C_iso_q_ss'].isel(x=idx_best, y=0).values, color='red', lw=1)
    ...
    for alpha in alphas:
        ...
        for i, tm_structure in enumerate(tm_structures):
            ...
            # add St. Gallen
            if alpha in [0.8]:
                if tm_structure in ['complete-mixing', 'advection-dispersion-power',
                                    'time-variant advection-dispersion-power']:
                    df_sim_br_conc = pd.DataFrame(index=df_obs_br.index)
                    states_br_file = base_path / "svat_bromide_benchmark" / "deterministic" / f"states_{tms}_bromide_benchmark_stgallen.nc"
                    ...
                    axes.flatten()[i].plot(df_sim_br_conc.dropna().index, df_sim_br_conc.dropna()[f"1991"], ls=':', color='red', lw=1, alpha=0.8, label=f'1991')
            df_sim_br_conc = pd.DataFrame(index=df_obs_br.index)
            df_sim_br_mass = pd.DataFrame(index=df_obs_br.index)
            for year in years:
                states_br_file = base_path / "svat_bromide_benchmark" / "deterministic" / f"states_{tms}_bromide_benchmark.nc"
        ...
        fig.legend(lines1, labels1, loc='upper right', fontsize=6, frameon=False, bbox_to_anchor=(0.965, 0.66))
    ...
    for i, tm_structure in enumerate(tm_structures):
        ...
        with xr.open_dataset(states_tm_file, engine="h5netcdf") as ds_sim_tm:
            ...
            for j, var_sim in enumerate(['TT_transp', 'TT_q_ss']):
                ...
                axes[j, i].text(0.5, 0.1, r'$\overline{TT}_{50}$=%s' % (avgTT50), size=6, horizontalalignment='left',
                verticalalignment='center', transform=axes[j, i].transAxes)
    ...
    for j, var_sim in enumerate(['bTT_transp', 'bTT_perc']):
        ...
        axes[j, -1].text(0.5, 0.1, r'$\overline{TT}_{50}$=%s' % (avgTT50), size=6, horizontalalignment='left', 
                        verticalalignment='center', transform=axes[j, -1].transAxes)
    ...
    for i, tm_structure in enumerate(tm_structures):
        ...
        for sc in ['', 'dry', 'normal', 'wet']:
            ...
            df_kge_tm.loc[sc, df_kge_tm.columns[i]] = df_params_metrics.loc[df_params_metrics.index[idx_best], f'KGE_C_iso_q_ss{sc}']
    ...
    _LABS_TITLE = {'KGE_C_iso_q_ss': '$KGE_{\delta^{18}O}$',
    ...
    for metric_tt in metrics_tt:
        ...
        ax[-1, -1].legend(["First-order", "Total"], frameon=False, loc='upper left', fontsize=6, bbox_to_anchor=(0.05, 1.0))
        ...
        for j, tm_structure in enumerate(['advection-dispersion-power', 'time-variant advection-dispersion-power']):
            ...
            for i, name in enumerate(metrics_sa):
                ...
                ax[j, i].legend().set_visible(False)
        ax[-1, -1].legend().set_visible(True)
        ax[-1, -1].legend(["First-order", "Total"], frameon=False, loc='upper left', fontsize=6, bbox_to_anchor=(0.45, 1.0))
        ax[0, 0].set_ylabel('AD\nSobol index [-]')
        ax[1, 0].set_ylabel('AD-TV\nSobol index [-]')
        fig.subplots_adjust(bottom=0.2, right=0.95, hspace=0.65)
    ...
    for j, tm_structure in enumerate(['advection-dispersion-power', 'time-variant advection-dispersion-power']):
        ...
        for i, name in enumerate(metrics_sa):
            ...
            ax[j].legend().set_visible(False)
    ax[-1].legend().set_visible(True)
    ax[-1].legend(["First-order", "Total"], frameon=False, loc='upper right', fontsize=6, bbox_to_anchor=(1.6, 1.0))
    ax[0].set_title('AD')
    ...
    sns.set_style("ticks")
    sns.plotting_context("talk", font_scale=1, rc={'font.size': 8.0,
                                                    'axes.labelsize': 9.0,
                                                    'axes.titlesize': 8.0,
                                                    'xtick.labelsize': 8.0,
                                                    'ytick.labelsize': 8.0,
    ...
    tm_structures1 = ['complete-mixing',
                      'advection-dispersion-power']
    ...
    axs[0].plot(df_obs1.index,
                df_obs1.loc[:, 'd18O_prec'].fillna(method='bfill'),
                '-', color='blue')
    axs[0].scatter(df_obs1.index,
                   df_obs1.loc[:, 'd18O_prec'],
                   color='blue', s=1)
    axs[0].set_ylabel(r'$\delta^{18}$O [‰]')
    axs[0].set_ylim([-20, 0])
    axs[0].set_xlim(df_obs1.index[0], df_obs1.index[-1])
    axs[1].plot(df_obs1.index, df_obs1.loc[:, 'd18O_perc'].fillna(method='bfill'),
                '-', color='grey')
    axs[1].scatter(df_obs1.index, df_obs1.loc[:, 'd18O_perc'],
                   color='grey', s=1)
    axs[1].set_ylabel(r'$\delta^{18}$O [‰]')
    axs[1].set_xlabel('Time [year]')
    axs[1].set_ylim([-20, 0])
    ...
    fig.text(0.52, 0.905, r"$\overline{\delta^{18}O}_{prec}$: %s" % (d18O_prec_mean), ha="center", va="center", fontsize=8)
    fig.text(0.52, 0.45, r"$\overline{\delta^{18}O}_{perc}$: %s" % (d18O_perc_mean), ha="center", va="center", fontsize=8)

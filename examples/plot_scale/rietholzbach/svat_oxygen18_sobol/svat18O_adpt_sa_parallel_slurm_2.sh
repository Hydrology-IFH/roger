...
mpirun --bind-to core --map-by core -report-bindings python svat_oxygen18.py -b jax -d cpu -n 32 1 --float-type float64 -ns 16384 -tms time-variant_advection-dispersion-power_2 -td "${TMPDIR}"

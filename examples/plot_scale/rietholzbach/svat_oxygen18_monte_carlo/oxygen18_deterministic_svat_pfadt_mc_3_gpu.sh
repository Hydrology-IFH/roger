...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_pfadt_mc_3
#PBS -m bea
...
python svat_transport.py --id 3 -b jax -d gpu -ns 1000 -tms time-variant_preferential_+_advection-dispersion -td "${TMPDIR}" -ss deterministic

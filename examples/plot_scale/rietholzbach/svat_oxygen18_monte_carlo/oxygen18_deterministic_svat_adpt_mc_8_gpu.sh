...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adpt_mc_8
#PBS -m bea
...
python svat_transport.py --id 8 -b jax -d gpu -ns 1000 -tms time-variant_advection-dispersion-power -td "${TMPDIR}" -ss deterministic

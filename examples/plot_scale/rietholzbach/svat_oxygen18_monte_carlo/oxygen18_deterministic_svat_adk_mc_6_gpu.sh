...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_adk_mc_6
#PBS -m bea
...
python svat_transport.py --id 6 -b jax -d gpu -ns 1000 -tms advection-dispersion-kumaraswamy -td "${TMPDIR}" -ss deterministic

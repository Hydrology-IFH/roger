...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_pfad_mc_1
#PBS -m bea
...
python svat_transport.py --id 1 -b jax -d gpu -ns 1000 -tms preferential_+_advection-dispersion -td "${TMPDIR}" -ss deterministic

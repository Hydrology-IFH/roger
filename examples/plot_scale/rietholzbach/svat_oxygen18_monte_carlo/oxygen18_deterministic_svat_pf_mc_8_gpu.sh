...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_pf_mc_8
#PBS -m bea
...
python svat_transport.py --log-all-processes --id 8 -b jax -d gpu -ns 1000 -tms preferential -td "${TMPDIR}" -ss deterministic

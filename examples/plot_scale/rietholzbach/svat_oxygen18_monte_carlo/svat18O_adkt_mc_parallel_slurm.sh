...
mpirun --bind-to core --map-by core -report-bindings python svat_oxygen18.py -b jax -d cpu -n 25 1 -ns 10000 -tms time-variant_advection-dispersion-kumaraswamy -td "${TMPDIR}"

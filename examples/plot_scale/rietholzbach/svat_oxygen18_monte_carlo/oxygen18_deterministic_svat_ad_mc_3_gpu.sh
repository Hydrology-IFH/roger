...
#PBS -l pmem=4000mb
#PBS -N oxygen18_deterministic_svat_ad_mc_3
#PBS -m bea
...
python svat_transport.py --log-all-processes --id 3 -b jax -d gpu -ns 1000 -tms advection-dispersion -td "${TMPDIR}" -ss deterministic

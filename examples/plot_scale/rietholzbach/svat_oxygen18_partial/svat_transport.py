...
@click.option("-tms", "--transport-model-structure", type=click.Choice(['preferential', 'advection-dispersion', 'time-variant advection-dispersion', 'power', 'older-preference', 'preferential_+_advection-dispersion', 'time-variant_preferential_+_advection-dispersion', 'time-variant', 'time-variant-transp']), default='advection-dispersion')
...
def main(transport_model_structure, sas_solver, tmp_dir):
    ...
    class SVATTRANSPORTSetup(RogerSetup):
        ...
        def set_settings(self, state):
            ...
            settings.nx, settings.ny = len(self._read_var_from_nc("x", self._base_path, 'parameters.nc', group=self._tm_structure)), 1
        ...
        def set_parameters_setup(self, state):
            ...
            if settings.tm_structure == "preferential":
                ...
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 2], 8)
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 3], 5)
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 4], 10)
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 0], 36)
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 1], self._read_var_from_nc("b_q_ss", self._base_path, 'parameters.nc', group=self._tm_structure))
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 3], self._read_var_from_nc("c1_q_ss", self._base_path, 'parameters.nc', group=self._tm_structure))
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 4], self._read_var_from_nc("c2_q_ss", self._base_path, 'parameters.nc', group=self._tm_structure))
                ...
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 1], 1.5)
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 3], 2.5)
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 4], 2.5)
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 0], 36)
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 1], self._read_var_from_nc("b_q_ss", self._base_path, 'parameters.nc', group=self._tm_structure))
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 3], self._read_var_from_nc("c1_q_ss", self._base_path, 'parameters.nc', group=self._tm_structure))
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 4], self._read_var_from_nc("c2_q_ss", self._base_path, 'parameters.nc', group=self._tm_structure))
                ...
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 4], self._read_var_from_nc("c_transp", self._base_path, 'parameters.nc', group=self._tm_structure))
                ...
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 4], self._read_var_from_nc("c_q_rz", self._base_path, 'parameters.nc', group=self._tm_structure))
        ...
        def set_diagnostics(self, state, base_path=tmp_dir):
            ...
            diagnostics["average"].output_variables = ["C_iso_rz", "C_iso_ss", "C_iso_s",
                                                       "C_iso_in", "C_iso_evap_soil",
                                                       "C_iso_transp", "C_iso_cpr_rz",
                                                       "C_iso_q_rz", "C_iso_q_ss"]

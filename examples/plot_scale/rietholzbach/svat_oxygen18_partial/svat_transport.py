...
@click.option("-tms", "--transport-model-structure", type=click.Choice(['preferential', 'advection-dispersion', 'time-variant advection-dispersion', 'power', 'older-preference', 'preferential_+_advection-dispersion', 'time-variant', 'time-variant-transp']), default='advection-dispersion')
    ...
    class SVATTRANSPORTSetup(RogerSetup):
        ...
        def set_parameters_setup(self, state):
            ...
            if settings.tm_structure == "preferential":
                ...
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 2], 20)
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 0], 3)
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 1], 5)

...
@click.option("-tms", "--transport-model-structure", type=click.Choice(['preferential-power', 'advection-dispersion-power', 'time-variant advection-dispersion-power', 'older-preference-power']), default='advection-dispersion-power')
...
def main(transport_model_structure, sas_solver, tmp_dir):
    ...
    class SVATTRANSPORTSetup(RogerSetup):
        ...
        def set_parameters_setup(self, state):
            ...
            if settings.tm_structure == "preferential-power":
                ...
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 4], 0.5)

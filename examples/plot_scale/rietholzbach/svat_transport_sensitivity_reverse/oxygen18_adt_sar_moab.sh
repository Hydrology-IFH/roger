...
mpirun --bind-to core --map-by core -report-bindings python svat_transport.py --log-all-processes -b numpy -d cpu -n 16 1 -ns 512 -tms time-variant_advection-dispersion -td "${TMPDIR}" -ss Euler

...
for station_id in station_ids:
    ...
    for cm in cms:
        ...
        data_1985_2099 = data_1985_2099.join(data_hist_future)
        ...
        dict_bc_meteo_daily[station_id][cm]["1985-2100"] = data_1985_2099
        ...
        for period in periods:
            ...
            if period == "hist":
                ...
                dict_bc_meteo_daily[station_id][cm]["1985-2014"] = data_1985_2014
            elif period == "future":
                ...
                dict_bc_meteo_daily[station_id][cm]["2030-2059"] = data_2030_2059
                dict_bc_meteo_daily[station_id][cm]["2070-2099"] = data_2070_2099
    ...
    for cm in cms:
        ...
        for period in periods:
            ...
            if period == "hist":
                ...
                dict_meteo_ann[station_id][cm]["1985-2014"] = data_ann_1985_2014
                ...
                dict_meteo_ann[station_id][cm]["2030-2059"] = data_ann_2030_2059
                dict_meteo_ann[station_id][cm]["2070-2099"] = data_ann_2070_2099
...
for station_id in station_ids:
    ...
    for cm in cms:
        ...
        for period in periods:
            ...
            if period == "hist":
                data_seas_1985_2014 = pd.DataFrame(index=idx_seasonally_1985_2014)
                data_seas_1985_2014 = data_seas_1985_2014.join(data_seas)
                dict_meteo_seas[station_id][cm]["1985-2014"] = data_seas_1985_2014

            elif period == "future":
                data_seas_2030_2059 = pd.DataFrame(index=idx_seasonally_2030_2059)
                data_seas_2030_2059 = data_seas_2030_2059.join(data_seas)
                data_seas_2070_2099 = pd.DataFrame(index=idx_seasonally_2070_2099)
                data_seas_2070_2099 = data_seas_2070_2099.join(data_seas)
                dict_meteo_seas[station_id][cm]["2030-2059"] = data_seas_2030_2059
                dict_meteo_seas[station_id][cm]["2070-2099"] = data_seas_2070_2099
...
for station_id in station_ids:
    for cm in ["MPI-M-MPI-ESM-LR_RCA4", "CCCma-CanESM2_CCLM4-8-17"]:
        ...
        data_1985_2099.loc[:, "TA"] = data_1985_2099["TA"].interpolate()
        data_1985_2099.loc[:, "RS"] = data_1985_2099["RS"].interpolate()
        data1 = data1.join(data_1985_2099.loc[:, "TA"].to_frame())
        data = pd.DataFrame(index=idx_daily_1985_2099)
        data = data.join(data1)
        ...
        data.loc[:, "scale"] = (
            dict_bc_meteo_daily[station_id][cm]["1985-2100"].loc[:, "TA"] - data_1985_2099.loc[:, "TA"]
        )
...
for station_id in station_ids:
    ...
    dict_precip_10mins[station_id][cm]["1985-2014"] = data_1985_2014
    ...
    dict_precip_10mins[station_id][cm]["2030-2059"] = data_2030_2059
    dict_precip_10mins[station_id][cm]["2070-2099"] = data_2070_2099
...
for station_id in station_ids:
    ...
    for cm in ["MPI-M-MPI-ESM-LR_RCA4", "CCCma-CanESM2_CCLM4-8-17"]:
        ...
        data_1985_2014 = pd.DataFrame(index=idx_10mins_1985_2014)
        data_1985_2014 = data_1985_2014.join(data_10mins)
        dict_bc_precip_10mins[station_id][cm]["1985-2014"] = data_1985_2014
        data_2030_2059 = pd.DataFrame(index=idx_10mins_2030_2059)
        data_2030_2059 = data_2030_2059.join(data_10mins)
        data_2070_2099 = pd.DataFrame(index=idx_10mins_2070_2099)
        data_2070_2099 = data_2070_2099.join(data_10mins)
        dict_bc_precip_10mins[station_id][cm]["2030-2059"] = data_2030_2059
        dict_bc_precip_10mins[station_id][cm]["2070-2099"] = data_2070_2099
...
for station_id in station_ids:
    ...
    for cm in cms:
        ...
        data_ref = dict_meteo_ann[station_id][cm]["1985-2014"]
        data_nf = dict_meteo_ann[station_id][cm]["2030-2059"]
        data_ff = dict_meteo_ann[station_id][cm]["2070-2099"]
...
for station_id in station_ids:
    ...
    for cm in cms:
        ...
        data_ref = dict_meteo_seas[station_id][cm]["1985-2014"]
        data_nf = dict_meteo_seas[station_id][cm]["2030-2059"]
        data_ff = dict_meteo_seas[station_id][cm]["2070-2099"]

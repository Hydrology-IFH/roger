...
python svat_crop_transport.py -b jax -d gpu --location altheim --land-cover-scenario crop_rotation --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 1985-2014 -td "${TMPDIR}"

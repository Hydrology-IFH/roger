...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_transport.py -b numpy -d cpu -n 4 1 --location freiburg --land-cover-scenario crop_rotation --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2016-2021 -td "${TMPDIR}"

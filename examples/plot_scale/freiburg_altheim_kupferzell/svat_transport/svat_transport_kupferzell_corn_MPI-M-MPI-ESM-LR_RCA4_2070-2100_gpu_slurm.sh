...
python svat_crop_transport.py -b jax -d gpu --location kupferzell --land-cover-scenario corn --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2070-2100 -td "${TMPDIR}"

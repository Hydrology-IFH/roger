...
#SBATCH --output=svat_transport_freiburg_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_2080-2100
#SBATCH --error=svat_transport_freiburg_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_2080-2100
#SBATCH --export=ALL
...
python svat_crop_transport.py -b jax -d cpu -n 4 1 --location freiburg --land-cover-scenario corn_catch_crop --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2080-2100 -td "${TMPDIR}"

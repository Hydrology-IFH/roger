...
# Compares hashes
checksum_gws=$(shasum -a 256 /beegfs/work/workspace/ws/fr_rs1092-workspace-0/freiburg_altheim_kupferzell/svat/SVAT_freiburg_corn_CCCma-CanESM2_CCLM4-8-17_2080-2100.nc | cut -f 1 -d " ")
checksum_ssd=0a
cp /beegfs/work/workspace/ws/fr_rs1092-workspace-0/freiburg_altheim_kupferzell/svat/SVAT_freiburg_corn_CCCma-CanESM2_CCLM4-8-17_2080-2100.nc "${TMPDIR}"
...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_transport.py -b numpy -d cpu -n 4 1 --location freiburg --land-cover-scenario corn --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2080-2100 -td "${TMPDIR}"

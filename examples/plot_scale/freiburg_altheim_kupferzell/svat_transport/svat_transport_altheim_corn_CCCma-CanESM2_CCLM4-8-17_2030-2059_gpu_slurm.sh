...
python svat_crop_transport.py -b jax -d gpu --location altheim --land-cover-scenario corn --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2030-2059 -td "${TMPDIR}"

...
#PBS -l pmem=4000mb
#PBS -N svat_transport_freiburg_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2040-2060
#PBS -m a
...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_transport.py -b numpy -d cpu -n 4 1 --location freiburg --land-cover-scenario crop_rotation --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2040-2060 -td "${TMPDIR}"

...
#SBATCH --output=svat_transport_freiburg_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2080-2100
#SBATCH --error=svat_transport_freiburg_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2080-2100
#SBATCH --export=ALL
...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_transport.py -b jax -d cpu -n 4 1 --location freiburg --land-cover-scenario crop_rotation --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2080-2100 -td "${TMPDIR}"

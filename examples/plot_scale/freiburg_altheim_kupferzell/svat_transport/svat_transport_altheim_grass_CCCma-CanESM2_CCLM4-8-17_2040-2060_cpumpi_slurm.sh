...
mpirun --bind-to core --map-by core -report-bindings python svat_transport.py -b jax -d gpu --location altheim --land-cover-scenario grass --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2040-2060 -td "${TMPDIR}"

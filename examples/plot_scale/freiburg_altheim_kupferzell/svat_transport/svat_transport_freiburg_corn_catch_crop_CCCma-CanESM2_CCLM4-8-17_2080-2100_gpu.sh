...
mv /beegfs/work/workspace/ws/fr_rs1092-workspace-0/freiburg_altheim_kupferzell/svat_transport/freiburg_altheim_kupferzell/output/svat/SVAT_freiburg_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_2080-2100.nc "${TMPDIR}"/SVAT_freiburg_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_2080-2100.nc
# Wait for files
checksum_gws=$(shasum -a 256 /beegfs/work/workspace/ws/fr_rs1092-workspace-0/freiburg_altheim_kupferzell/svat_transport/freiburg_altheim_kupferzell/output/svat/SVAT_freiburg_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_2080-2100.nc | cut -f 1 -d " ")
...
python svat_crop_transport.py -b jax -d gpu --location freiburg --land-cover-scenario corn_catch_crop --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2080-2100 -td "${TMPDIR}"

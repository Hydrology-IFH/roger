...
#SBATCH --job-name=svat_transport_kupferzell_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2080-2100
#SBATCH --output=svat_transport_kupferzell_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2080-2100.out
#SBATCH --error=svat_transport_kupferzell_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2080-2100_err.out
#SBATCH --export=ALL
...
# Compares hashes
checksum_gws=$(shasum -a 256 /home/fr/fr_fr/fr_rs1092/roger/examples/plot_scale/freiburg_altheim_kupferzell/output/svat/SVAT_kupferzell_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2080-2100.nc | cut -f 1 -d " ")
checksum_ssd=0a
cp /home/fr/fr_fr/fr_rs1092/roger/examples/plot_scale/freiburg_altheim_kupferzell/output/svat/SVAT_kupferzell_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2080-2100.nc "${TMPDIR}"
...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_transport.py -b jax -d cpu -n 4 1 --location kupferzell --land-cover-scenario crop_rotation --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2080-2100 -td "${TMPDIR}"

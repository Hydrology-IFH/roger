...
#SBATCH --output=svat_transport_kupferzell_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_1985-2005
#SBATCH --error=svat_transport_kupferzell_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_1985-2005
#SBATCH --export=ALL

...
mpirun --bind-to core --map-by core -report-bindings python svat_transport.py -b numpy -d cpu -n 4 1 --location altheim --land-cover-scenario grass --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 1985-2005 -td "${TMPDIR}"

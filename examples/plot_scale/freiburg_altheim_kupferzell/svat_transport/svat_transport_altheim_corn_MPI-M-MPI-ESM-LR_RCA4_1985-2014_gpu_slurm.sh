...
python svat_crop_transport.py -b jax -d gpu --float-type float64 --location altheim --land-cover-scenario corn --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 1985-2014 -td "${TMPDIR}"

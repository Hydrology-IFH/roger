...
python svat_crop_transport.py -b jax -d gpu --location kupferzell --land-cover-scenario corn --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 1985-2015 -td "${TMPDIR}"

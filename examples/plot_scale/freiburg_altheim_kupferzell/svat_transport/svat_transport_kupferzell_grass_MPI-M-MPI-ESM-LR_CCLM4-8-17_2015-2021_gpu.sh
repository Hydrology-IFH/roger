...
#PBS -l pmem=4000mb
#PBS -N svat_transport_kupferzell_grass_MPI-M-MPI-ESM-LR_CCLM4-8-17_2015-2021
#PBS -m bea
...
python svat_crop_transport.py -b jax -d gpu --land-cover-scenario grass --climate-scenario MPI-M-MPI-ESM-LR_CCLM4-8-17 --period 2015-2021 -td "${TMPDIR}"

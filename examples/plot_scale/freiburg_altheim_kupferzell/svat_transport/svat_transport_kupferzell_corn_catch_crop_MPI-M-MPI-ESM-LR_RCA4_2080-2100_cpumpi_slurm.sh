...
#SBATCH --output=svat_transport_kupferzell_corn_catch_crop_MPI-M-MPI-ESM-LR_RCA4_2080-2100.out
#SBATCH --error=svat_transport_kupferzell_corn_catch_crop_MPI-M-MPI-ESM-LR_RCA4_2080-2100_err.out
#SBATCH --export=ALL
...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_transport.py -b jax -d cpu -n 4 1 --location kupferzell --land-cover-scenario corn_catch_crop --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2080-2100 -td "${TMPDIR}"

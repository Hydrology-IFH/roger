...
python svat_crop_transport.py -b jax -d gpu --location freiburg --land-cover-scenario corn --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2030-2060 -td "${TMPDIR}"

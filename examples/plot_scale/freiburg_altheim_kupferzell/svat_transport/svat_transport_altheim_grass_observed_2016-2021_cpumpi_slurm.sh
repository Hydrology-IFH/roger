...
#SBATCH --job-name=svat_transport_altheim_grass_observed_2016-2021
#SBATCH --output=svat_transport_altheim_grass_observed_2016-2021.out
#SBATCH --error=svat_transport_altheim_grass_observed_2016-2021_err.txt
#SBATCH --export=ALL
...
mpirun --bind-to core --map-by core -report-bindings python svat_transport.py -b jax -d cpu -n 4 1 --location altheim --land-cover-scenario grass --climate-scenario observed --period 2016-2021 -td "${TMPDIR}"

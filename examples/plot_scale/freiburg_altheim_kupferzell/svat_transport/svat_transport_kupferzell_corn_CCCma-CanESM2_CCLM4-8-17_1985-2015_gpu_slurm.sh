...
python svat_crop_transport.py -b jax -d gpu --location kupferzell --land-cover-scenario corn --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 1985-2015 -td "${TMPDIR}"

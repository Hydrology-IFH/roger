...
#PBS -l pmem=4000mb
#PBS -N svat_transport_altheim_grass_MPI-M-MPI-ESM-LR_RCA4_2040-2060
#PBS -m a
...
mv /beegfs/work/workspace/ws/fr_rs1092-workspace-0/freiburg_altheim_kupferzell/svat_transport/freiburg_altheim_kupferzell/output/svat/SVAT_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2040-2060.nc "${TMPDIR}"/SVAT_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2040-2060.nc
# Wait for files
checksum_gws=$(shasum -a 256 /beegfs/work/workspace/ws/fr_rs1092-workspace-0/freiburg_altheim_kupferzell/svat_transport/freiburg_altheim_kupferzell/output/svat/SVAT_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2040-2060.nc | cut -f 1 -d " ")
...
python svat_crop_transport.py -b jax -d gpu --location altheim --land-cover-scenario grass --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2040-2060 -td "${TMPDIR}"

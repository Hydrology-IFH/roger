...
#PBS -l pmem=4000mb
#PBS -N svat_transport_altheim_grass_MPI-M-MPI-ESM-LR_RCA4_2016-2021
#PBS -m a
...
python svat_crop_transport.py -b jax -d gpu --location altheim --land-cover-scenario grass --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2016-2021 -td "${TMPDIR}"

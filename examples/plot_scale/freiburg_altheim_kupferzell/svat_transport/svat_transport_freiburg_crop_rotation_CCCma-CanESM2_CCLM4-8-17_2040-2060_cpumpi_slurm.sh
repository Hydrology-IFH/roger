...
#SBATCH --job-name=svat_transport_freiburg_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2040-2060
#SBATCH --output=svat_transport_freiburg_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2040-2060.out
#SBATCH --error=svat_transport_freiburg_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2040-2060_err.out
#SBATCH --export=ALL
...
# Compares hashes
checksum_gws=$(shasum -a 256 /home/fr/fr_fr/fr_rs1092/roger/examples/plot_scale/freiburg_altheim_kupferzell/output/svat/SVAT_freiburg_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2040-2060.nc | cut -f 1 -d " ")
checksum_ssd=0a
cp /home/fr/fr_fr/fr_rs1092/roger/examples/plot_scale/freiburg_altheim_kupferzell/output/svat/SVAT_freiburg_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2040-2060.nc "${TMPDIR}"
...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_transport.py -b jax -d cpu -n 4 1 --location freiburg --land-cover-scenario crop_rotation --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2040-2060 -td "${TMPDIR}"

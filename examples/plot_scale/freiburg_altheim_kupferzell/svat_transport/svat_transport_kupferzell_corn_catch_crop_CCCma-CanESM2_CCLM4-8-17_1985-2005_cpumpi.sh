...
#PBS -l pmem=4000mb
#PBS -N svat_transport_kupferzell_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_1985-2005
#PBS -m a
...
# Compares hashes
checksum_gws=$(shasum -a 256 /beegfs/work/workspace/ws/fr_rs1092-workspace-0/freiburg_altheim_kupferzell/svat/SVAT_kupferzell_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_1985-2005.nc | cut -f 1 -d " ")
checksum_ssd=0a
cp /beegfs/work/workspace/ws/fr_rs1092-workspace-0/freiburg_altheim_kupferzell/svat/SVAT_kupferzell_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_1985-2005.nc "${TMPDIR}"
...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_transport.py -b numpy -d cpu -n 4 1 --location kupferzell --land-cover-scenario corn_catch_crop --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 1985-2005 -td "${TMPDIR}"

...
#PBS -l pmem=4000mb
#PBS -N svat_transport_kupferzell_corn_MPI-M-MPI-ESM-LR_CCLM4-8-17_2040-2060
#PBS -m bea
...
python svat_crop_transport.py -b jax -d gpu --land-cover-scenario corn --climate-scenario MPI-M-MPI-ESM-LR_CCLM4-8-17 --period 2040-2060 -td "${TMPDIR}"

...
#PBS -l pmem=4000mb
#PBS -N svat_transport_kupferzell_crop_rotation_MPI-M-MPI-ESM-LR_CCLM4-8-17_1985-2005
#PBS -m bea
...
python svat_crop_transport.py -b jax -d gpu --land-cover-scenario crop_rotation --climate-scenario MPI-M-MPI-ESM-LR_CCLM4-8-17 --period 1985-2005 -td "${TMPDIR}"

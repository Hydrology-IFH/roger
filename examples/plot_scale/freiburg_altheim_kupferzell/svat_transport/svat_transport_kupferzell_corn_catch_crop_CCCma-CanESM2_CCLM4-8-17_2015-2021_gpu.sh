...
#PBS -l pmem=4000mb
#PBS -N svat_transport_kupferzell_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_2015-2021
#PBS -m bea
...
python svat_crop_transport.py -b jax -d gpu --land-cover-scenario corn_catch_crop --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2015-2021 -td "${TMPDIR}"

...
python svat_crop_transport.py -b jax -d gpu --float-type float64 --location freiburg --land-cover-scenario crop_rotation --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2030-2059 -td "${TMPDIR}"

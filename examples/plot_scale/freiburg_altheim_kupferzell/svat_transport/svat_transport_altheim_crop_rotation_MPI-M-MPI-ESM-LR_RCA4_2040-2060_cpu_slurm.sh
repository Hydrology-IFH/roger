...
#SBATCH --job-name=svat_transport_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2040-2060
#SBATCH --output=svat_transport_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2040-2060.out
#SBATCH --error=svat_transport_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2040-2060_err.txt
#SBATCH --export=ALL
...
# Compares hashes
checksum_gws=$(shasum -a 256 /home/fr/fr_fr/fr_rs1092/roger/examples/plot_scale/freiburg_altheim_kupferzell/output/svat/SVAT_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2040-2060.nc | cut -f 1 -d " ")
checksum_ssd=0a
cp /home/fr/fr_fr/fr_rs1092/roger/examples/plot_scale/freiburg_altheim_kupferzell/output/svat/SVAT_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2040-2060.nc "${TMPDIR}"
...
python svat_crop_transport.py -b jax -d cpu --location altheim --land-cover-scenario crop_rotation --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2040-2060 -td "${TMPDIR}"

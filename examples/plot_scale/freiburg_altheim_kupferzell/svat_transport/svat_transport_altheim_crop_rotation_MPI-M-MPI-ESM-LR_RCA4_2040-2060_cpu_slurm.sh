...
#SBATCH --output=svat_transport_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2040-2060
#SBATCH --error=svat_transport_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2040-2060
#SBATCH --export=ALL
...
python svat_crop_transport.py -b jax -d cpu -n 4 1 --location altheim --land-cover-scenario crop_rotation --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2040-2060 -td "${TMPDIR}"

...
#PBS -l pmem=4000mb
#PBS -N svat_transport_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2016-2021
#PBS -m a
...
mv /beegfs/work/workspace/ws/fr_rs1092-workspace-0/freiburg_altheim_kupferzell/svat_transport/freiburg_altheim_kupferzell/output/svat/SVAT_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2016-2021.nc "${TMPDIR}"/SVAT_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2016-2021.nc
# Wait for files
checksum_gws=$(shasum -a 256 /beegfs/work/workspace/ws/fr_rs1092-workspace-0/freiburg_altheim_kupferzell/svat_transport/freiburg_altheim_kupferzell/output/svat/SVAT_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2016-2021.nc | cut -f 1 -d " ")
...
python svat_crop_transport.py -b jax -d gpu --location altheim --land-cover-scenario crop_rotation --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2016-2021 -td "${TMPDIR}"

...
#SBATCH --job-name=svat_kupferzell_corn_MPI-M-MPI-ESM-LR_RCA4_2070-2099
#SBATCH --output=svat_kupferzell_corn_MPI-M-MPI-ESM-LR_RCA4_2070-2099.out
#SBATCH --error=svat_kupferzell_corn_MPI-M-MPI-ESM-LR_RCA4_2070-2099_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location kupferzell --land-cover-scenario corn --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2070-2099 -td "${TMPDIR}"

...
#PBS -l pmem=80000mb
#PBS -N svat_kupferzell_corn_CCCma-CanESM2_CCLM4-8-17_2040-2060
#PBS -m bea
...
python svat_crop.py -b jax -d cpu --land-cover-scenario corn --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2040-2060 -td "${TMPDIR}"

...
#SBATCH --job-name=svat_altheim_grass_MPI-M-MPI-ESM-LR_RCA4_2030-2060
#SBATCH --output=svat_altheim_grass_MPI-M-MPI-ESM-LR_RCA4_2030-2060.out
#SBATCH --error=svat_altheim_grass_MPI-M-MPI-ESM-LR_RCA4_2030-2060_err.out
#SBATCH --export=ALL
#PBS -m a
...
python svat.py -b numpy -d cpu --location altheim --land-cover-scenario grass --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2030-2060 -td "${TMPDIR}"

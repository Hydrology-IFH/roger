...
#SBATCH --job-name=svat_altheim_grass_CCCma-CanESM2_CCLM4-8-17_2016-2021
#SBATCH --output=svat_altheim_grass_CCCma-CanESM2_CCLM4-8-17_2016-2021.out
#SBATCH --error=svat_altheim_grass_CCCma-CanESM2_CCLM4-8-17_2016-2021_err.out
#SBATCH --export=ALL
#PBS -m a
...
python svat.py -b numpy -d cpu --location altheim --land-cover-scenario grass --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2016-2021 -td "${TMPDIR}"

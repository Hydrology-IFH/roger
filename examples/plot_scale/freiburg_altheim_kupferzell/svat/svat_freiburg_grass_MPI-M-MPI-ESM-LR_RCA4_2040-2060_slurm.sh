...
#SBATCH --output=svat_freiburg_grass_MPI-M-MPI-ESM-LR_RCA4_2040-2060
#SBATCH --error=svat_freiburg_grass_MPI-M-MPI-ESM-LR_RCA4_2040-2060
#SBATCH --export=ALL
#PBS -m a
...
python svat.py -b numpy -d cpu --location freiburg --land-cover-scenario grass --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2040-2060 -td "${TMPDIR}"

...
#SBATCH --job-name=svat_freiburg_grass_observed_2016-2021
#SBATCH --output=svat_freiburg_grass_observed_2016-2021.out
#SBATCH --error=svat_freiburg_grass_observed_2016-2021_err.txt
#SBATCH --export=ALL
#PBS -m a
...
python svat.py -b numpy -d cpu --location freiburg --land-cover-scenario grass --climate-scenario observed --period 2016-2021 -td "${TMPDIR}"

...
#SBATCH --job-name=svat_freiburg_grass_MPI-M-MPI-ESM-LR_RCA4_2080-2100
#SBATCH --output=svat_freiburg_grass_MPI-M-MPI-ESM-LR_RCA4_2080-2100.out
#SBATCH --error=svat_freiburg_grass_MPI-M-MPI-ESM-LR_RCA4_2080-2100_err.txt
#SBATCH --export=ALL
#PBS -m a

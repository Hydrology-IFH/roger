...
#SBATCH --output=svat_freiburg_crop_rotation_observed_2016-2021
#SBATCH --error=svat_freiburg_crop_rotation_observed_2016-2021
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location freiburg --land-cover-scenario crop_rotation --climate-scenario observed --period 2016-2021 -td "${TMPDIR}"

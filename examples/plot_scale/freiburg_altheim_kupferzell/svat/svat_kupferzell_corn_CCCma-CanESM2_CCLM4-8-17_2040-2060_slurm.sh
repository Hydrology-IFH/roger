...
#SBATCH --job-name=svat_kupferzell_corn_CCCma-CanESM2_CCLM4-8-17_2040-2060
#SBATCH --output=svat_kupferzell_corn_CCCma-CanESM2_CCLM4-8-17_2040-2060.out
#SBATCH --error=svat_kupferzell_corn_CCCma-CanESM2_CCLM4-8-17_2040-2060_err.txt
#SBATCH --export=ALL

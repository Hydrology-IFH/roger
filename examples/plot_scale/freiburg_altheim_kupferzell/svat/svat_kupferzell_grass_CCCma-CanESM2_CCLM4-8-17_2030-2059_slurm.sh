...
#SBATCH --job-name=svat_kupferzell_grass_CCCma-CanESM2_CCLM4-8-17_2030-2059
#SBATCH --output=svat_kupferzell_grass_CCCma-CanESM2_CCLM4-8-17_2030-2059.out
#SBATCH --error=svat_kupferzell_grass_CCCma-CanESM2_CCLM4-8-17_2030-2059_err.out
#SBATCH --export=ALL
...
python svat.py -b numpy -d cpu --location kupferzell --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2030-2059 -td "${TMPDIR}"

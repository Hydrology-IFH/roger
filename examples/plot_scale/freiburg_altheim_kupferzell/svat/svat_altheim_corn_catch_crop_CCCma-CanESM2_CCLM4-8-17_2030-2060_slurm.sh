...
#SBATCH --job-name=svat_altheim_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_2030-2060
#SBATCH --output=svat_altheim_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_2030-2060.out
#SBATCH --error=svat_altheim_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_2030-2060_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location altheim --land-cover-scenario corn_catch_crop --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2030-2060 -td "${TMPDIR}"

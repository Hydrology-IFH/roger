...
#SBATCH --job-name=svat_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2030-2060
#SBATCH --output=svat_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2030-2060.out
#SBATCH --error=svat_altheim_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2030-2060_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location altheim --land-cover-scenario crop_rotation --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2030-2060 -td "${TMPDIR}"

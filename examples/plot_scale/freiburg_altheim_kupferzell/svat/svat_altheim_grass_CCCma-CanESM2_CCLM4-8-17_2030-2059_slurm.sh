...
#SBATCH --job-name=svat_altheim_grass_CCCma-CanESM2_CCLM4-8-17_2030-2059
...
python svat.py -b numpy -d cpu --location altheim --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2030-2059 -td "${TMPDIR}"

...
#SBATCH --job-name=svat_kupferzell_corn_CCCma-CanESM2_CCLM4-8-17_2016-2021
#SBATCH --output=svat_kupferzell_corn_CCCma-CanESM2_CCLM4-8-17_2016-2021.out
#SBATCH --error=svat_kupferzell_corn_CCCma-CanESM2_CCLM4-8-17_2016-2021_err.txt
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location kupferzell --land-cover-scenario corn --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2016-2021 -td "${TMPDIR}"

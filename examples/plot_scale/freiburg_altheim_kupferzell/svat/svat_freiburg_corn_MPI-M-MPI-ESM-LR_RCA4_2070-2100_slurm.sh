...
#SBATCH --job-name=svat_freiburg_corn_MPI-M-MPI-ESM-LR_RCA4_2070-2100
#SBATCH --output=svat_freiburg_corn_MPI-M-MPI-ESM-LR_RCA4_2070-2100.out
#SBATCH --error=svat_freiburg_corn_MPI-M-MPI-ESM-LR_RCA4_2070-2100_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location freiburg --land-cover-scenario corn --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2070-2100 -td "${TMPDIR}"

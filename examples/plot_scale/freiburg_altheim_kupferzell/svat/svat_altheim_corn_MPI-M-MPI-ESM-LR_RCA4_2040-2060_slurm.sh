...
#SBATCH --job-name=svat_altheim_corn_MPI-M-MPI-ESM-LR_RCA4_2040-2060
#SBATCH --output=svat_altheim_corn_MPI-M-MPI-ESM-LR_RCA4_2040-2060.out
#SBATCH --error=svat_altheim_corn_MPI-M-MPI-ESM-LR_RCA4_2040-2060_err.txt
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location altheim --land-cover-scenario corn --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2040-2060 -td "${TMPDIR}"

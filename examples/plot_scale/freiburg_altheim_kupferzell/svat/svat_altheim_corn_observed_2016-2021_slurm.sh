...
#SBATCH --job-name=svat_altheim_corn_observed_2016-2021
#SBATCH --output=svat_altheim_corn_observed_2016-2021.out
#SBATCH --error=svat_altheim_corn_observed_2016-2021_err.txt
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location altheim --land-cover-scenario corn --climate-scenario observed --period 2016-2021 -td "${TMPDIR}"

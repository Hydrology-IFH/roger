...
#SBATCH --output=svat_kupferzell_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2080-2100
#SBATCH --error=svat_kupferzell_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2080-2100
#SBATCH --export=ALL

...
#SBATCH --job-name=svat_freiburg_corn_CCCma-CanESM2_CCLM4-8-17_1985-2014
#SBATCH --output=svat_freiburg_corn_CCCma-CanESM2_CCLM4-8-17_1985-2014.out
#SBATCH --error=svat_freiburg_corn_CCCma-CanESM2_CCLM4-8-17_1985-2014_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location freiburg --land-cover-scenario corn --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 1985-2014 -td "${TMPDIR}"

...
#SBATCH --job-name=svat_kupferzell_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2070-2100
#SBATCH --output=svat_kupferzell_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2070-2100.out
#SBATCH --error=svat_kupferzell_crop_rotation_MPI-M-MPI-ESM-LR_RCA4_2070-2100_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location kupferzell --land-cover-scenario crop_rotation --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2070-2100 -td "${TMPDIR}"

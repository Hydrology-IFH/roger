...
#SBATCH --job-name=svat_kupferzell_corn_MPI-M-MPI-ESM-LR_RCA4_1985-2014
#SBATCH --output=svat_kupferzell_corn_MPI-M-MPI-ESM-LR_RCA4_1985-2014.out
#SBATCH --error=svat_kupferzell_corn_MPI-M-MPI-ESM-LR_RCA4_1985-2014_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location kupferzell --land-cover-scenario corn --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 1985-2014 -td "${TMPDIR}"

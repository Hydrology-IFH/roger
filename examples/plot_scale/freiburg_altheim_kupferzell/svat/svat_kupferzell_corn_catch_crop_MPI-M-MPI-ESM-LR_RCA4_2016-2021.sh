...
#PBS -l pmem=80000mb
#PBS -N svat_kupferzell_corn_catch_crop_MPI-M-MPI-ESM-LR_RCA4_2016-2021
#PBS -m bea
...
python svat_crop.py -b numpy -d cpu --land-cover-scenario corn_catch_crop --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2016-2021 -td "${TMPDIR}"

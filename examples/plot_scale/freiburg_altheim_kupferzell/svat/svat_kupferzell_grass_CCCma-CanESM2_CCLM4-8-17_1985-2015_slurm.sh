...
#SBATCH --job-name=svat_kupferzell_grass_CCCma-CanESM2_CCLM4-8-17_1985-2015
#SBATCH --output=svat_kupferzell_grass_CCCma-CanESM2_CCLM4-8-17_1985-2015.out
#SBATCH --error=svat_kupferzell_grass_CCCma-CanESM2_CCLM4-8-17_1985-2015_err.out
#SBATCH --export=ALL
#PBS -m a
...
python svat.py -b numpy -d cpu --location kupferzell --land-cover-scenario grass --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 1985-2015 -td "${TMPDIR}"

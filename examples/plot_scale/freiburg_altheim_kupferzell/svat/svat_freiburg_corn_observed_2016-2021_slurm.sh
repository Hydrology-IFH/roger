...
#SBATCH --job-name=svat_freiburg_corn_observed_2016-2021
#SBATCH --output=svat_freiburg_corn_observed_2016-2021.out
#SBATCH --error=svat_freiburg_corn_observed_2016-2021_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location freiburg --land-cover-scenario corn --climate-scenario observed --period 2016-2021 -td "${TMPDIR}"

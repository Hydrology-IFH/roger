...
#SBATCH --job-name=svat_freiburg_corn_CCCma-CanESM2_CCLM4-8-17_2070-2099
#SBATCH --output=svat_freiburg_corn_CCCma-CanESM2_CCLM4-8-17_2070-2099.out
#SBATCH --error=svat_freiburg_corn_CCCma-CanESM2_CCLM4-8-17_2070-2099_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location freiburg --land-cover-scenario corn --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2070-2099 -td "${TMPDIR}"

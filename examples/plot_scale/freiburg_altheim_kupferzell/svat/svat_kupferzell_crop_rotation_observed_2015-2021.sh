...
#PBS -l pmem=80000mb
#PBS -N svat_kupferzell_crop_rotation_observed_2015-2021
#PBS -m bea
...
python svat_crop.py -b jax -d cpu --land-cover-scenario crop_rotation --climate-scenario observed --period 2015-2021 -td "${TMPDIR}"

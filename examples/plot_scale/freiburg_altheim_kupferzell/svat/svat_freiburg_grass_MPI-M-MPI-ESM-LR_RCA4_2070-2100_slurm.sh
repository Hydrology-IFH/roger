...
#SBATCH --job-name=svat_freiburg_grass_MPI-M-MPI-ESM-LR_RCA4_2070-2100
#SBATCH --output=svat_freiburg_grass_MPI-M-MPI-ESM-LR_RCA4_2070-2100.out
#SBATCH --error=svat_freiburg_grass_MPI-M-MPI-ESM-LR_RCA4_2070-2100_err.out
#SBATCH --export=ALL
#PBS -m a
...
python svat.py -b numpy -d cpu --location freiburg --land-cover-scenario grass --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2070-2100 -td "${TMPDIR}"

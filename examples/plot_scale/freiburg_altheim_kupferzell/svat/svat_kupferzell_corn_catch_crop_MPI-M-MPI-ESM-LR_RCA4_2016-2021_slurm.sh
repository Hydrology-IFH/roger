...
#SBATCH --output=svat_kupferzell_corn_catch_crop_MPI-M-MPI-ESM-LR_RCA4_2016-2021
#SBATCH --error=svat_kupferzell_corn_catch_crop_MPI-M-MPI-ESM-LR_RCA4_2016-2021
#SBATCH --export=ALL

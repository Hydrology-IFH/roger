...
#SBATCH --job-name=svat_freiburg_grass_CCCma-CanESM2_CCLM4-8-17_1985-2005
#SBATCH --output=svat_freiburg_grass_CCCma-CanESM2_CCLM4-8-17_1985-2005.out
#SBATCH --error=svat_freiburg_grass_CCCma-CanESM2_CCLM4-8-17_1985-2005_err.out
#SBATCH --export=ALL
#PBS -m a
...
python svat.py -b numpy -d cpu --location freiburg --land-cover-scenario grass --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 1985-2005 -td "${TMPDIR}"

...
#SBATCH --job-name=svat_freiburg_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_2030-2059
#SBATCH --output=svat_freiburg_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_2030-2059.out
#SBATCH --error=svat_freiburg_corn_catch_crop_CCCma-CanESM2_CCLM4-8-17_2030-2059_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location freiburg --land-cover-scenario corn_catch_crop --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2030-2059 -td "${TMPDIR}"

...
#SBATCH --job-name=svat_freiburg_corn_CCCma-CanESM2_CCLM4-8-17_2080-2100
#SBATCH --output=svat_freiburg_corn_CCCma-CanESM2_CCLM4-8-17_2080-2100.out
#SBATCH --error=svat_freiburg_corn_CCCma-CanESM2_CCLM4-8-17_2080-2100_err.txt
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location freiburg --land-cover-scenario corn --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2080-2100 -td "${TMPDIR}"

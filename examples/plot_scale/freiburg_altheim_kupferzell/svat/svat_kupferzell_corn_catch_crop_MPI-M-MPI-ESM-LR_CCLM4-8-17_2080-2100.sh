...
#PBS -l pmem=80000mb
#PBS -N svat_kupferzell_corn_catch_crop_MPI-M-MPI-ESM-LR_CCLM4-8-17_2080-2100
#PBS -m bea
...
python svat_crop.py -b jax -d cpu --land-cover-scenario corn_catch_crop --climate-scenario MPI-M-MPI-ESM-LR_CCLM4-8-17 --period 2080-2100 -td "${TMPDIR}"

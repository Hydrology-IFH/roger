...
#SBATCH --job-name=svat_kupferzell_grass_MPI-M-MPI-ESM-LR_RCA4_1985-2014
#SBATCH --output=svat_kupferzell_grass_MPI-M-MPI-ESM-LR_RCA4_1985-2014.out
#SBATCH --error=svat_kupferzell_grass_MPI-M-MPI-ESM-LR_RCA4_1985-2014_err.out
#SBATCH --export=ALL
#PBS -m a
...
python svat.py -b numpy -d cpu --location kupferzell --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 1985-2014 -td "${TMPDIR}"

...
#PBS -l pmem=80000mb
#PBS -N svat_kupferzell_crop_rotation_MPI-M-MPI-ESM-LR_CCLM4-8-17_2040-2060
#PBS -m bea
...
python svat_crop.py -b jax -d cpu --land-cover-scenario crop_rotation --climate-scenario MPI-M-MPI-ESM-LR_CCLM4-8-17 --period 2040-2060 -td "${TMPDIR}"

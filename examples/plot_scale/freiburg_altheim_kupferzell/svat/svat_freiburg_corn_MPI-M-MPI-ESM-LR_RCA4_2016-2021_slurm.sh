...
#SBATCH --job-name=svat_freiburg_corn_MPI-M-MPI-ESM-LR_RCA4_2016-2021
#SBATCH --output=svat_freiburg_corn_MPI-M-MPI-ESM-LR_RCA4_2016-2021.out
#SBATCH --error=svat_freiburg_corn_MPI-M-MPI-ESM-LR_RCA4_2016-2021_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location freiburg --land-cover-scenario corn --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2016-2021 -td "${TMPDIR}"

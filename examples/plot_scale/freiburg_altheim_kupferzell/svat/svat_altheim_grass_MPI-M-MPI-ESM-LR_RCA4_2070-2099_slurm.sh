...
#SBATCH --job-name=svat_altheim_grass_MPI-M-MPI-ESM-LR_RCA4_2070-2099
...
python svat.py -b numpy -d cpu --location altheim --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2070-2099 -td "${TMPDIR}"

...
#SBATCH --output=svat_altheim_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2016-2021
#SBATCH --error=svat_altheim_crop_rotation_CCCma-CanESM2_CCLM4-8-17_2016-2021
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location altheim --land-cover-scenario crop_rotation --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2016-2021 -td "${TMPDIR}"

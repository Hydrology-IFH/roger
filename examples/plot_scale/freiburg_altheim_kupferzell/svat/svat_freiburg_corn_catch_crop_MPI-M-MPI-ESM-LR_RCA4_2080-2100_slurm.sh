...
#SBATCH --job-name=svat_freiburg_corn_catch_crop_MPI-M-MPI-ESM-LR_RCA4_2080-2100
#SBATCH --output=svat_freiburg_corn_catch_crop_MPI-M-MPI-ESM-LR_RCA4_2080-2100.out
#SBATCH --error=svat_freiburg_corn_catch_crop_MPI-M-MPI-ESM-LR_RCA4_2080-2100_err.txt
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location freiburg --land-cover-scenario corn_catch_crop --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2080-2100 -td "${TMPDIR}"

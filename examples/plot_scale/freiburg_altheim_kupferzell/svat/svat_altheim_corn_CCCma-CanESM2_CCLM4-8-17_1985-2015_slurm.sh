...
#SBATCH --job-name=svat_altheim_corn_CCCma-CanESM2_CCLM4-8-17_1985-2015
#SBATCH --output=svat_altheim_corn_CCCma-CanESM2_CCLM4-8-17_1985-2015.out
#SBATCH --error=svat_altheim_corn_CCCma-CanESM2_CCLM4-8-17_1985-2015_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location altheim --land-cover-scenario corn --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 1985-2015 -td "${TMPDIR}"

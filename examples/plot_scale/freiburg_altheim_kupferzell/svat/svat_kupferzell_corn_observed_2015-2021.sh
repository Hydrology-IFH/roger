...
#PBS -l pmem=80000mb
#PBS -N svat_kupferzell_corn_observed_2015-2021
#PBS -m bea
...
python svat_crop.py -b jax -d cpu --land-cover-scenario corn --climate-scenario observed --period 2015-2021 -td "${TMPDIR}"

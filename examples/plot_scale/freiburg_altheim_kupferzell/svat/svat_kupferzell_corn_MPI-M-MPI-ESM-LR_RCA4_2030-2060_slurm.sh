...
#SBATCH --job-name=svat_kupferzell_corn_MPI-M-MPI-ESM-LR_RCA4_2030-2060
#SBATCH --output=svat_kupferzell_corn_MPI-M-MPI-ESM-LR_RCA4_2030-2060.out
#SBATCH --error=svat_kupferzell_corn_MPI-M-MPI-ESM-LR_RCA4_2030-2060_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location kupferzell --land-cover-scenario corn --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 2030-2060 -td "${TMPDIR}"

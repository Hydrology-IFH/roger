...
#SBATCH --job-name=svat_freiburg_corn_MPI-M-MPI-ESM-LR_RCA4_1985-2015
#SBATCH --output=svat_freiburg_corn_MPI-M-MPI-ESM-LR_RCA4_1985-2015.out
#SBATCH --error=svat_freiburg_corn_MPI-M-MPI-ESM-LR_RCA4_1985-2015_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location freiburg --land-cover-scenario corn --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 1985-2015 -td "${TMPDIR}"

...
#SBATCH --job-name=svat_kupferzell_grass_CCCma-CanESM2_CCLM4-8-17_2040-2060
#SBATCH --output=svat_kupferzell_grass_CCCma-CanESM2_CCLM4-8-17_2040-2060.out
#SBATCH --error=svat_kupferzell_grass_CCCma-CanESM2_CCLM4-8-17_2040-2060_err.out
#SBATCH --export=ALL
#PBS -m a
...
python svat.py -b numpy -d cpu --location kupferzell --land-cover-scenario grass --climate-scenario CCCma-CanESM2_CCLM4-8-17 --period 2040-2060 -td "${TMPDIR}"

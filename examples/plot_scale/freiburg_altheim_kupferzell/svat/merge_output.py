...
for location in locations:
    for climate_scenario in climate_scenarios:
        for period in periods:
            path = str(base_path / "output" / "svat" / f"SVAT_{location}_grass_{climate_scenario}_{period}.*.nc")
            output_hm_file = base_path / "output" / "svat" / f"SVAT_{location}_grass_{climate_scenario}_{period}.nc"

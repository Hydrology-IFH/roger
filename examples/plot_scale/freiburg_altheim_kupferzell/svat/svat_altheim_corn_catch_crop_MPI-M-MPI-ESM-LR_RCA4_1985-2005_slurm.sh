...
#SBATCH --job-name=svat_altheim_corn_catch_crop_MPI-M-MPI-ESM-LR_RCA4_1985-2005
#SBATCH --output=svat_altheim_corn_catch_crop_MPI-M-MPI-ESM-LR_RCA4_1985-2005.out
#SBATCH --error=svat_altheim_corn_catch_crop_MPI-M-MPI-ESM-LR_RCA4_1985-2005_err.out
#SBATCH --export=ALL
...
python svat_crop.py -b numpy -d cpu --location altheim --land-cover-scenario corn_catch_crop --climate-scenario MPI-M-MPI-ESM-LR_RCA4 --period 1985-2005 -td "${TMPDIR}"

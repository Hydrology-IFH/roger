...
#PBS -l pmem=80000mb
#PBS -N svat_kupferzell_grass_observed_2015-2021
#PBS -m bea
...
python svat.py -b jax -d cpu --land-cover-scenario grass --climate-scenario observed --period 2015-2021 -td "${TMPDIR}"

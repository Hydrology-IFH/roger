...
#PBS -l pmem=80000mb
#PBS -N svat_kupferzell_grass_MPI-M-MPI-ESM-LR_CCLM4-8-17_2080-2100
#PBS -m bea
...
python svat.py -b jax -d cpu --land-cover-scenario grass --climate-scenario MPI-M-MPI-ESM-LR_CCLM4-8-17 --period 2080-2100 -td "${TMPDIR}"

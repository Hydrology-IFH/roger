    ...
    for land_cover_scenario in land_cover_scenarios:
        ...
        for period in periods:
            ...
            for climate_scenario in climate_scenarios:
                ...
                ds_conc_ages = xr.open_dataset(output_tm_file, engine="h5netcdf")
                # assign date
                days = (ds_conc_ages['Time'].values / onp.timedelta64(24 * 60 * 60, "s"))
                date = num2date(days, units=f"days since {ds_conc_ages['Time'].attrs['time_origin']}", calendar='standard', only_use_cftime_datetimes=False)
                ...
                print(f"SVATTRANSPORT_{location}_{land_cover_scenario}_{climate_scenario}_{period}.nc")

...
def main():
    ...
    class ONEDSetup(RogerSetup):
        ...
        def set_forcing(self, state):
            ...
            vs.ta = update(vs.ta, at[2:-2, 2:-2], 10)
        ...
        def set_diagnostics(self, state):
            ...
            diagnostics["maximum"].output_variables = ["z0", "theta", "S_s", "S_int_top", "S_int_ground", "S_int_top_tot", "S_int_ground_tot", "S_snow", "swe", "swe_top", "swe_ground", "swe_top_tot"]

...
def main(tmp_dir):
    ...
    for lys_experiment in lys_experiments:
        # load .txt-file
        file = base_path / "output" / "svat_monte_carlo" / f"params_eff_{lys_experiment}_bulk_samples.txt"
    ...
    file = base_path / "output" / "svat_monte_carlo" / "KGE_bulk_samples.csv"
    ...
    for lys_experiment in lys_experiments:
        ...
        # load simulation
        path_sim = base_path_output / f"SVAT_{lys_experiment}.nc"
        ...
        path_sim = base_path_output / f"SVAT_{lys_experiment}.nc"
        path_sim_1 = base_path_output / f"SVAT_{lys_experiment}_best_simulation.nc"
        ...
        # write states of best model run
        path_sim = base_path_output / f"SVAT_{lys_experiment}.nc"
        path_sim_100 = base_path_output / f"SVAT_{lys_experiment}_best_100_simulations.nc"

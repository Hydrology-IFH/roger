...
def main(tmp_dir):
    ...
    for lys_experiment in lys_experiments:
        ...
        if not os.path.exists(base_path_output):
            os.mkdir(base_path_output)
        # directory of figures
        base_path_figs = base_path / "figures" / "svat_monte_carlo"
        if not os.path.exists(base_path_figs):
            os.mkdir(base_path_figs)

        # load simulation
        states_hm_mc_file = base_path / f"SVAT_{lys_experiment}.nc"
        ...
        states_hm_mc_file = base_path / f"SVAT_{lys_experiment}.nc"
        states_hm_file = base_path / f"SVAT_{lys_experiment}_best_simulation.nc"

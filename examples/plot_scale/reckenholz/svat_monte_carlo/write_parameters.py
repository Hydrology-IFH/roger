...
def main(nsamples):
    ...
    df_params = df_params.loc[:, ["lu_id", "z_soil", "dmpv", "lmpv", "theta_ac", "theta_ufc", "theta_pwp", "ks", "kf", "clay"]]

    # write parameters to csv
    df_params.columns = [
        ["", "[mm]", "[1/m2]", "[mm]", "[-]", "[-]", "[-]", "[mm/hour]", "[mm/hour]", "[-]"],
        ["lu_id", "z_soil", "dmpv", "lmpv", "theta_ac", "theta_ufc", "theta_pwp", "ks", "kf", "clay"],
    ]

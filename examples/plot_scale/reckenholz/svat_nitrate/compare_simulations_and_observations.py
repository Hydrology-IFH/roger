...
base_path_figs = base_path.parent / "figures" / "svat_nitrate"
...
for lys_experiment in lys_experiments:
    for tm_structure in tm_structures:
        # load simulations
        sim_file = base_path.parent / "output" / "svat_crop" / f"SVAT_{lys_experiment}.nc"
        ds_water_sim = xr.open_dataset(sim_file, engine="h5netcdf")

        sim_file = base_path.parent / "output" / "svat_crop_nitrate" / f"SVATNITRATE_{tm_structure}_{lys_experiment}.nc"

...
#SBATCH --job-name=transport_mcr_lys9_n
#SBATCH --nodes=1
#SBATCH --ntasks=40
#SBATCH --mem=180000mb
...
mpirun --bind-to core --map-by core -report-bindings python svat_transport_nitrate.py lys9
...
# sbatch ./roger_nitrate_lys9_batch.sh
# chmod +x roger_nitrate_lys9_batch.sh

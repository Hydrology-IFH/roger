...
def main():
    ...
    for lys_experiment in lys_experiments:
        path = str(Path("/Volumes/LaCie/roger/examples/plot_scale/reckenholz") / "output" / "svat_crop_monte_carlo" / f"SVATCROP_{lys_experiment}.*.nc")
        output_hm_file = Path("/Volumes/LaCie/roger/examples/plot_scale/reckenholz") / "output" / "svat_crop_monte_carlo" / f"SVATCROP_{lys_experiment}.nc"

...
# Compares hashes
checksum_gws=$(shasum -a 256 /pfs/10/work/fr_rs1092-workspace/reckenholz/svat_crop_nitrate_monte_carlo/SVATCROP_lys8_bootstrap.nc | cut -f 1 -d " ")
checksum_ssd=0a
cp /pfs/10/work/fr_rs1092-workspace/reckenholz/svat_crop_nitrate_monte_carlo/SVATCROP_lys8_bootstrap.nc "${TMPDIR}"

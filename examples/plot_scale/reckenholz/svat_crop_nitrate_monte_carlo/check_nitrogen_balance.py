...
def main(tmp_dir):
    ...
    base_path_figs = base_path.parent / "figures" / "svat_crop_nitrate_monte_carlo"
    ...
    for lys_experiment in lys_experiments:
        ...
        df_params_metrics = pd.read_csv(base_path_output / "output" / "svat_crop_nitrate_monte_carlo" / f"params_metrics_{lys_experiment}_advection-dispersion-power.txt", sep="\t")
        ...
        # load simulation
        sim_file = base_path_output / "output" / "svat_crop_nitrate_monte_carlo" / f"SVATCROPNITRATE_advection-dispersion-power_{lys_experiment}.nc"

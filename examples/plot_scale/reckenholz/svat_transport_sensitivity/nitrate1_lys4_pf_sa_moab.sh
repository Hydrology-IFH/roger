...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_transport_nitrate1.py -b numpy -d cpu -n 32 1 -lys lys4 -tms preferential -td "${TMPDIR}"

...
#PBS -l pmem=4000mb
#PBS -N nitrate1_lys8_pft_svat_sa
#PBS -m bea
...
mpirun --bind-to core --map-by core -report-bindings python svat_transport_nitrate1.py -b numpy -d cpu -n 32 1 -lys lys8 -tms time-variant_preferential -td "${TMPDIR}"

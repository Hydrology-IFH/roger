...
#PBS -l pmem=4000mb
#PBS -N bromide_lys9_bromide_pft_sa
#PBS -m bea
...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_transport_bromide.py -b numpy -d cpu -n 32 1 -lys lys9_bromide -tms time-variant_preferential -td "${TMPDIR}"

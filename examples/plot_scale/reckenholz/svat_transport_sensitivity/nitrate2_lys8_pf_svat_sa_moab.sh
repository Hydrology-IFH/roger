...
#PBS -l pmem=4000mb
#PBS -N nitrate2_lys8_pf_svat_sa
#PBS -m bea
...
mpirun --bind-to core --map-by core -report-bindings python svat_transport_nitrate2.py -b numpy -d cpu -n 32 1 -lys lys8 -tms preferential -td "${TMPDIR}"

...
#PBS -l pmem=4000mb
#PBS -N svat_crop_nitrate_adt_mc-scs_lys3
#PBS -m bea
...
# Compares hashes
checksum_gws=$(shasum -a 256 /beegfs/work/workspace/ws/fr_rs1092-workspace-0/reckenholz/svat_crop_nitrate_monte_carlo_semi-crop-specific/SVATCROP_lys3_bootstrap.nc | cut -f 1 -d " ")
checksum_ssd=0a
cp /beegfs/work/workspace/ws/fr_rs1092-workspace-0/reckenholz/svat_crop_nitrate_monte_carlo_semi-crop-specific/SVATCROP_lys3_bootstrap.nc "${TMPDIR}"

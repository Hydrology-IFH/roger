...
def main(tmp_dir):
    ...
    base_path_output = base_path / "output" / "svat_crop_nitrate_monte_carlo_crop-specific"
    if not os.path.exists(base_path_output):
        os.mkdir(base_path_output)
    # directory of figures
    base_path_figs = Path(__file__).parent.parent / "figures" / "svat_crop_nitrate_monte_carlo_crop-specific"
    ...
    #         fig, axs = plt.subplots(5, 1, sharey=False, sharex=False, figsize=(8, 6))
    ...
    lys_experiments = ["lys2", "lys3", "lys8"]
    fig, axs = plt.subplots(3, 1, sharey=True, sharex=True, figsize=(8, 6))

...
for lys_experiment in lys_experiments:
    ...
    for tm_structure in tm_structures:
        ...
        states_tm_file = base_path / "output" / "svat_crop_nitrate_monte_carlo_semi-crop-specific" / f"SVATCROPNITRATE_{tms}_{lys_experiment}.nc"
        ...
        # write to .txt
        file = base_path / "output" / "svat_crop_nitrate_monte_carlo_semi-crop-specific" / f"params_metrics_{lys_experiment}_{tm_structure}.txt"
        df_params_metrics.to_csv(file, header=True, index=False, sep="\t")

        file = base_path / "output" / "svat_crop_nitrate_monte_carlo_semi-crop-specific" / f"params_metrics_{lys_experiment}_{tm_structure}.csv"
        df_params_metrics.to_csv(file, header=True, index=False, sep=";")

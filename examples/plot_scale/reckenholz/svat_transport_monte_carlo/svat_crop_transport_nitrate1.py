...
def main(nsamples, lys_experiment, transport_model_structure, sas_solver, crop_partitioning):
    ...
    class SVATCROPTRANSPORTSetup(RogerSetup):
        ...
        def set_diagnostics(self, state):
            ...
            diagnostics["constant"].output_variables = ["alpha_q", "km_denit_rz",
    ...
    if sas_solver in ['RK4', 'Euler']:
        identifier = f'SVATCROPTRANSPORT_{lys_experiment}_{tms}_{sas_solver}_nitrate1'
    else:
        identifier = f'SVATCROPTRANSPORT_{lys_experiment}_{tms}_nitrate1'

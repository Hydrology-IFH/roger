...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_transport_nitrate2.py -b numpy -d cpu -n 32 1 -lys lys4 -tms complete-mixing_+_advection-dispersion -td "${TMPDIR}"

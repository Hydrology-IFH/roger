...
#SBATCH --job-name=transport_sar_lys2_n
#SBATCH --nodes=1
#SBATCH --ntasks=32
#SBATCH --mem=180000mb
...
mpirun --bind-to core --map-by core -report-bindings python svat_transport_nitrate.py lys2
...
# sbatch ./roger_nitrate_lys2_batch.sh
# chmod +x roger_nitrate_lys2_batch.sh

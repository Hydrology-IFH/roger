...
class SVATCROPTRANSPORTSetup(RogerSetup):
    ...
    def set_settings(self, state):
        ...
        settings.nx, settings.ny, settings.nz = self._get_nx(self._base_path, 'states_hm_sensitivity.nc', group=self._lys), 1, 1
    ...
    def set_parameters_setup(self, state):
        ...
        vs.S_PWP_RZ = update(vs.S_PWP_RZ, at[2:-2, 2:-2, :], self._read_var_from_nc("S_pwp_rz", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.S_PWP_SS = update(vs.S_PWP_SS, at[2:-2, 2:-2, :], self._read_var_from_nc("S_pwp_ss", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.S_SAT_RZ = update(vs.S_SAT_RZ, at[2:-2, 2:-2, :], self._read_var_from_nc("S_sat_rz", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.S_SAT_SS = update(vs.S_SAT_SS, at[2:-2, 2:-2, :], self._read_var_from_nc("S_sat_ss", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        ...
        vs.alpha_transp = update(vs.alpha_transp, at[2:-2, 2:-2], self._read_var_from_nc("alpha_transp", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
        vs.alpha_q = update(vs.alpha_q, at[2:-2, 2:-2], self._read_var_from_nc("alpha_q", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
        vs.km_denit_rz = update(vs.km_denit_rz, at[2:-2, 2:-2], self._read_var_from_nc("km_denit_rz", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
        vs.km_denit_ss = update(vs.km_denit_ss, at[2:-2, 2:-2], self._read_var_from_nc("km_denit_ss", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
        vs.dmax_denit_rz = update(vs.dmax_denit_rz, at[2:-2, 2:-2], self._read_var_from_nc("dmax_denit_rz", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
        vs.dmax_denit_ss = update(vs.dmax_denit_ss, at[2:-2, 2:-2], self._read_var_from_nc("dmax_denit_ss", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
        vs.km_nit_rz = update(vs.km_nit_rz, at[2:-2, 2:-2], self._read_var_from_nc("km_nit_rz", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
        vs.km_nit_ss = update(vs.km_nit_ss, at[2:-2, 2:-2], self._read_var_from_nc("km_nit_ss", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
        vs.dmax_nit_rz = update(vs.dmax_nit_rz, at[2:-2, 2:-2], self._read_var_from_nc("dmax_nit_rz", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
        vs.dmax_nit_ss = update(vs.dmax_nit_ss, at[2:-2, 2:-2], self._read_var_from_nc("dmax_nit_ss", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
        vs.kmin_rz = update(vs.kmin_rz, at[2:-2, 2:-2], self._read_var_from_nc("kmin_rz", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
        vs.kmin_ss = update(vs.kmin_ss, at[2:-2, 2:-2], self._read_var_from_nc("kmin_ss", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
        ...
        if settings.tm_structure == "complete-mixing":
            ...
            vs.sas_params_evap_soil = update(vs.sas_params_evap_soil, at[2:-2, 2:-2, 0], 21)
            vs.sas_params_cpr_rz = update(vs.sas_params_cpr_rz, at[2:-2, 2:-2, 0], 21)
            vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, :], self._read_var_from_nc("sas_params_transp", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
            vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, :], self._read_var_from_nc("sas_params_q_rz", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
            vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, :], self._read_var_from_nc("sas_params_q_ss", self._base_path, 'tm_nitrate_params.nc', group=self._lys, subgroup=settings.tm_structure))
            vs.sas_params_re_rg = update(vs.sas_params_re_rg, at[2:-2, 2:-2, 0], 21)
            vs.sas_params_re_rl = update(vs.sas_params_re_rl, at[2:-2, 2:-2, 0], 22)
    ...
    def set_initial_conditions_setup(self, state):
        ...
        vs.S_RZ = update(vs.S_RZ, at[2:-2, 2:-2, :], self._read_var_from_nc("S_rz", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.S_SS = update(vs.S_SS, at[2:-2, 2:-2, :], self._read_var_from_nc("S_ss", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
    ...
    def set_forcing_setup(self, state):
        ...
        vs.TA = update(vs.TA, at[2:-2, 2:-2, :], self._read_var_from_nc("ta", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.PREC = update(vs.PREC, at[2:-2, 2:-2, :], self._read_var_from_nc("prec", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.INF_MAT_RZ = update(vs.INF_MAT_RZ, at[2:-2, 2:-2, :], self._read_var_from_nc("inf_mat_rz", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.INF_PF_RZ = update(vs.INF_PF_RZ, at[2:-2, 2:-2, :], self._read_var_from_nc("inf_mp_rz", self._base_path, 'states_hm_sensitivity.nc', group=self._lys) + self._read_var_from_nc("inf_sc_rz", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.INF_PF_SS = update(vs.INF_PF_SS, at[2:-2, 2:-2, :], self._read_var_from_nc("inf_ss", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.TRANSP = update(vs.TRANSP, at[2:-2, 2:-2, :], self._read_var_from_nc("transp", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.EVAP_SOIL = update(vs.EVAP_SOIL, at[2:-2, 2:-2, :], self._read_var_from_nc("evap_soil", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.CPR_RZ = update(vs.CPR_RZ, at[2:-2, 2:-2, :], self._read_var_from_nc("cpr_rz", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.Q_RZ = update(vs.Q_RZ, at[2:-2, 2:-2, :], self._read_var_from_nc("q_rz", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.Q_SS = update(vs.Q_SS, at[2:-2, 2:-2, :], self._read_var_from_nc("q_ss", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.RE_RG = update(vs.RE_RG, at[2:-2, 2:-2, :], self._read_var_from_nc("re_rg", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
        vs.RE_RL = update(vs.RE_RL, at[2:-2, 2:-2, :], self._read_var_from_nc("re_rl", self._base_path, 'states_hm_sensitivity.nc', group=self._lys))
...
def set_nitrate_input_kernel(state, nn_rain, nn_sol):
    ...
    for i in range(nn_sol):
        ...
        input_itt = onp.NaNargmin(npx.where(rain_idx - sol_idx[i] < 0, onp.NaN, rain_idx - sol_idx[i]))

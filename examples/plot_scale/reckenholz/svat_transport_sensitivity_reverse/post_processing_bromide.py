...
for lys_experiment in lys_experiments:
    for tm_structure in tm_structures:
        ...
        states_tm_file = base_path / "states_tm_sensitivity_rev_bromide.nc"
        ...
        with h5netcdf.File(states_tm_file, 'a', decode_vlen_strings=False) as f:
            ...
            f.attrs.update(
                ...
                title='RoGeR bromide transport model Saltelli simulations reverse at Reckenholz lysimeter site',

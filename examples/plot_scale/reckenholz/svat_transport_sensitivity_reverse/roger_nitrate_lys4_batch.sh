...
#SBATCH --job-name=transport_sar_lys4_n
#SBATCH --nodes=1
#SBATCH --ntasks=32
#SBATCH --mem=180000mb
...
mpirun --bind-to core --map-by core -report-bindings python svat_transport_nitrate.py lys4
...
# sbatch ./roger_nitrate_lys4_batch.sh
# chmod +x roger_nitrate_lys4_batch.sh

...
def main(nsamples, lys_experiment, tmp_dir):
    ...
    class SVATSetup(RogerSetup):
        ...
        file_path = _base_path / "param_bounds_svat.yml"
        ...
        def set_diagnostics(self, state, base_path=tmp_dir):
            ...
            diagnostics["rate"].output_variables = ["prec", "transp", "evap_soil", "inf_mat_rz", "inf_mp_rz", "inf_sc_rz", "inf_ss", "q_rz", "q_ss", "cpr_rz"]

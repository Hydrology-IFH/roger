...
def main(lys_experiment, transport_model_structure, tmp_dir):
    ...
    class SVATCROPNITRATESetup(RogerSetup):
        ...
        def set_settings(self, state):
            ...
            settings.identifier = f"SVATNITRATE_{transport_model_structure}_{lys_experiment}"
        ...
        def set_parameters_setup(self, state):
            ...
            vs.alpha_transp = update(vs.alpha_transp, at[2:-2, 2:-2], self._read_var_from_nc("alpha_transp", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
            vs.alpha_q = update(vs.alpha_q, at[2:-2, 2:-2], self._read_var_from_nc("alpha_q", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
            # denitrification parameters
            vs.km_denit_rz = update(vs.km_denit_rz, at[2:-2, 2:-2], self._read_var_from_nc("km_denit", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
            vs.km_denit_ss = update(vs.km_denit_ss, at[2:-2, 2:-2], self._read_var_from_nc("km_denit", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
            # nitrification parameters
            vs.dmax_denit_rz = update(vs.dmax_denit_rz, at[2:-2, 2:-2], self._read_var_from_nc("dmax_denit", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
            vs.dmax_denit_ss = update(vs.dmax_denit_ss, at[2:-2, 2:-2], self._read_var_from_nc("dmax_denit", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
            vs.km_nit_rz = update(vs.km_nit_rz, at[2:-2, 2:-2], self._read_var_from_nc("km_nit", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
            vs.km_nit_ss = update(vs.km_nit_ss, at[2:-2, 2:-2], 0)
            vs.dmax_nit_rz = update(vs.dmax_nit_rz, at[2:-2, 2:-2], self._read_var_from_nc("dmax_nit", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
            ...
            if settings.tm_structure == "complete-mixing":
                ...
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 1], self._read_var_from_nc("k_transp", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 0], 6)
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 1], self._read_var_from_nc("k_q", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 0], 6)
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 1], self._read_var_from_nc("k_q", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
                ...
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 3], self._read_var_from_nc("c1_transp", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
                vs.sas_params_transp = update(vs.sas_params_transp, at[2:-2, 2:-2, 4], self._read_var_from_nc("c2_transp", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
                ...
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 3], self._read_var_from_nc("c1_q", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
                vs.sas_params_q_rz = update(vs.sas_params_q_rz, at[2:-2, 2:-2, 4], self._read_var_from_nc("c2_q", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
                ...
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 3], self._read_var_from_nc("c1_q", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
                vs.sas_params_q_ss = update(vs.sas_params_q_ss, at[2:-2, 2:-2, 4], self._read_var_from_nc("c2_q", self._base_path, f"parameters_for_{transport_model_structure}_{lys_experiment}.nc"))
        ...
        def set_forcing(self, state):
            ...
            vs.nup = update(
                vs.nup,
                at[2:-2, 2:-2],
                0.5 * settings.dx * settings.dy * 100 * vs.alpha_transp[2:-2, 2:-2],
            )

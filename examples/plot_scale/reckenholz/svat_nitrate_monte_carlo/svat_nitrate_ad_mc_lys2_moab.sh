...
mpirun --bind-to core --map-by core -report-bindings python svat_nitrate.py -b jax -d cpu -n 25 1 -lys lys2 -tms advection-dispersion-power -td "${TMPDIR}"

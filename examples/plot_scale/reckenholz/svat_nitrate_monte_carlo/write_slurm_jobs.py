...
def main():
    ...
    for lys in lysimeters:
        for tm in transport_models:
            script_name = f'SVATCROPN_{tm}_{lys}_mc'
            lines = []
            ...
            lines.append('mpirun --bind-to core --map-by core -report-bindings python svat_nitrate.py -lys %s -tms %s -ecp False -td "${TMPDIR}"\n' % (lys, tm))

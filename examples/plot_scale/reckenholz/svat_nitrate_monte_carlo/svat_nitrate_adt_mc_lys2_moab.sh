...
#PBS -l pmem=4000mb
#PBS -N svat_nitrate_adt_mc_lys2
#PBS -m bea
...
mpirun --bind-to core --map-by core -report-bindings python svat_nitrate.py -b jax -d cpu -n 25 1 -lys lys2 -tms time-variant_advection-dispersion-power -td "${TMPDIR}"

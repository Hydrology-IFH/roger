...
def main():
    ...
    for lys_experiment in lys_experiments:
        path = str(base_path / "output" / "svat_crop_monte_carlo_crop-specific" / f"SVATCROP_{lys_experiment}.*.nc")
        output_hm_file = base_path / "output" / "svat_crop_monte_carlo_crop-specific" / f"SVATCROP_{lys_experiment}.nc"

...
def main(tmp_dir):
    ...
    base_path_output = base_path / "output" / "svat_crop_nitrate_monte_carlo_sas"
    if not os.path.exists(base_path_output):
        os.mkdir(base_path_output)
    # directory of figures
    base_path_figs = Path(__file__).parent.parent / "figures" / "svat_crop_nitrate_monte_carlo_sas"

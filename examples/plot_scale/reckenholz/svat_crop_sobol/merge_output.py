...
def main():
    ...
    for lys_experiment in lys_experiments:
        path = str(base_path.parent / "output" / "svat_crop_sobol" / f"SVATCROP_{lys_experiment}.*.nc")
        output_hm_file = base_path.parent / "output" / "svat_crop_sobol" / f"SVATCROP_{lys_experiment}.nc"

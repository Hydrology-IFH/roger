...
def main(job_type):
    ...
    base_path_binac = '/home/fr/fr_fr/fr_rs1092/roger/examples/plot_scale/reckenholz/svat_crop_nitrate_monte_carlo_nitrogen-crop-specific'
    ...
    for lys in lysimeters:
        for tm in transport_models:
            if job_type == 'single-node':
                ...
                tms = tm.replace(" ", "_")
                script_name = f'svat_crop_{tracer}_{tm1}_mc-ncs_{lys}'
                output_path_ws = base_path_ws / 'reckenholz' / 'svat_crop_nitrate_monte_carlo_nitrogen-crop-specific'
                lines = []

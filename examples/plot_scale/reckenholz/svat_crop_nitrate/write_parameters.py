...
def main():
    ...
    for i in range(3):
        ...
        df_params.loc[df_params.index[i], "km_denit"] = _VALS["km_denit"][0] + (_VALS["km_denit"][1] - _VALS["km_denit"][0]) * (1 - c_clay) * c_soil_fertility
        df_params.loc[df_params.index[i], "dmax_denit"] = _VALS["dmax_denit"][0] + (_VALS["dmax_denit"][1] - _VALS["dmax_denit"][0]) * c_clay * c_soil_fertility

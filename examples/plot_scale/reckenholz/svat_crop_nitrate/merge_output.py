                ...
                if diag_files:
                    with h5netcdf.File(output_tm_file, "w", decode_vlen_strings=False) as f:
                        ...
                        f.attrs.update(
                            ...
                            title=f"RoGeR nitrate transport simulations at Reckenholz lysimeter site, Switzerland ({lys_experiment})",
                            institution="University of Freiburg, Chair of Hydrology",
                            references="",
                            comment="First timestep (t=0) contains initial values. Simulations start are written from second timestep (t=1) to last timestep (t=N).",
                            model_structure=f"SVAT model with free drainage, crop phenology and with SAS parameters representing ({tm_structure1})",

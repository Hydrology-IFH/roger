...
def main(tmp_dir):
    ...
    for lys_experiment in lys_experiments:
        ...
        df_params_metrics["E_multi"] = 0.5 * df_params_metrics["KGE_q_ss_perc_pet_2011-2017"] + 0.5 * (1 - ((1 - df_params_metrics["r_S_perc_pet_2011-2017"])**2 + (1 - df_params_metrics["KGE_alpha_S_perc_pet_2011-2017"])**2)**(0.5))

...
def main(job_type):
    ...
    base_path_binac = '/home/fr/fr_fr/fr_rs1092/roger/examples/plot_scale/reckenholz/svat_crop_monte_carlo'
    ...
    for lys in lysimeters:
        ...
        output_path_ws = base_path_ws / 'reckenholz' / 'svat_crop_monte_carlo_reference'
        lines = []

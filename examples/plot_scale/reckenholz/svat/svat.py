...
@click.option("-td", "--tmp-dir", type=str, default=Path(__file__).parent.parent / "output" / "svat")
@roger_base_cli
def main(lys_experiment, tmp_dir):
    ...
    class SVATSetup(RogerSetup):
        ...
        def set_settings(self, state):
            ...
            settings.identifier = f'SVAT_{lys_experiment}'
        ...
        def set_diagnostics(self, state, base_path=tmp_dir):
            ...
            diagnostics["rate"].output_variables = ["prec", "aet", "transp", "evap_soil", "inf_mat_rz", "inf_mp_rz", "inf_sc_rz", "inf_ss", "q_rz", "q_ss", "cpr_rz"]

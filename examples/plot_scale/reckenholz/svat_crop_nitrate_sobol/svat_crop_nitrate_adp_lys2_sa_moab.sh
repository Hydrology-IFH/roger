...
# Compares hashes
checksum_gws=$(shasum -a 256 /beegfs/work/workspace/ws/fr_rs1092-workspace-0/reckenholz/reckenholz/svat_crop_nitrate_sobol/SVATCROP_lys2.nc | cut -f 1 -d " ")
checksum_ssd=0a
cp /beegfs/work/workspace/ws/fr_rs1092-workspace-0/reckenholz/reckenholz/svat_crop_nitrate_sobol/SVATCROP_lys2.nc "${TMPDIR}"
...
mpirun --bind-to core --map-by core -report-bindings python svat_crop_nitrate.py -b jax -d cpu -n 20 1 -lys lys2 -td "${TMPDIR}"

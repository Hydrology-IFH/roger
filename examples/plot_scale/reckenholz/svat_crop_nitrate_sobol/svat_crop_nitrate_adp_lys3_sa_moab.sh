...
sleep 10
checksum_ssd=$(shasum -a 256 "${TMPDIR}"/SVATCROP_lys3.nc | cut -f 1 -d " ")
done
echo "Copying was successful"
# adapt command to your available scheduler / MPI implementation
mpirun --bind-to core --map-by core -report-bindings python svat_crop_nitrate.py -b jax -d cpu -n 16 1 -lys lys3 -td "${TMPDIR}"

...
for lys_experiment in lys_experiments:
    ...
    states_hm_file = base_path / "output" / "svat_crop_monte_carlo_nitrogen" / f"SVATCROP_{lys_experiment}_bootstrap.nc"
    ...
    for tm_structure in tm_structures:
        ...
        states_tm_file = base_path / "output" / "svat_crop_nitrate_monte_carlo_nitrogen" / f"SVATCROPNITRATE_{tms}_{lys_experiment}.nc"
        ...
        # write to .txt
        file = base_path / "output" / "svat_crop_nitrate_monte_carlo_nitrogen" / f"params_metrics_{lys_experiment}_{tm_structure}.txt"
        df_params_metrics.to_csv(file, header=True, index=False, sep="\t")

        file = base_path / "output" / "svat_crop_nitrate_monte_carlo_nitrogen" / f"params_metrics_{lys_experiment}_{tm_structure}.csv"
        df_params_metrics.to_csv(file, header=True, index=False, sep=";")

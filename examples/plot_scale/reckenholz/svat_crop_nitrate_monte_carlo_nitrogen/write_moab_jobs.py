...
def main(job_type, sas_solver):
    ...
    base_path_binac = '/home/fr/fr_fr/fr_rs1092/roger/examples/plot_scale/reckenholz/svat_crop_nitrate_monte_carlo_nitrogen'
    ...
    for lys in lysimeters:
        for tm in transport_models:
            if job_type == 'single-node':
                ...
                output_path_ws = base_path_ws / 'reckenholz' / 'svat_crop_nitrate_monte_carlo_nitrogen'
                lines = []

...
for x in [0, 1]:
    states_hm_file = base_path / f"states_hm{x}.nc"
    with h5netcdf.File(states_hm_file, 'w', decode_vlen_strings=False) as f:
        f.attrs.update(
            date_created=datetime.datetime.today().isoformat(),
            title='RoGeR simulation at Rietholzbach Lysimeter site with input data from St. Gallen (MeteoSwiss)',

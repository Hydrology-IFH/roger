...
@click.command("main")
def main(crop_rotation_scenario):
    ...
    file = base_path / "output" / f"nitrate_leaching_thuenen_{crop_rotation_scenario}.csv"   
    df_nitrate_leaching.to_csv(file, sep=";", index=True)

    file = base_path / "output" / f"nitrate_leaching_avg_thuenen_{crop_rotation_scenario}.csv"   

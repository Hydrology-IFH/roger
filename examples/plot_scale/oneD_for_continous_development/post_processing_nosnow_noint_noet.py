...
for meteo_station in meteo_stations:
    path = str(base_path / f"ONED_nosnow_noint_noet_{meteo_station}.*.nc")
    diag_files = glob.glob(path)
    ONED_file = base_path / "ONED_nosnow_noint_noet.nc"
...
file = base_path_output / "grid0_nosnow_noint_noet.csv"

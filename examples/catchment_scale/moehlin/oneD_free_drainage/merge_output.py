...
base_path_output = Path("/Volumes/LaCie/roger/examples/catchment_scale/StressRes/Moehlin") / "output" / "polygons" / "oneD_free_drainage"
...
if not os.path.exists(states_hm_file):
    with h5netcdf.File(states_hm_file, "w", decode_vlen_strings=False) as f:
        f.attrs.update(
            ...
            title="RoGeR simulations for the Moehlin catchment, Germany",

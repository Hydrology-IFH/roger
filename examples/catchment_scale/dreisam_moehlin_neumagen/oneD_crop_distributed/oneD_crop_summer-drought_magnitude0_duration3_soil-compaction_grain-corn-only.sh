...
#SBATCH --job-name=oneD_crop_summer-drought_magnitude0_duration3_soil-compaction_grain-corn-only
#SBATCH --output=oneD_crop_summer-drought_magnitude0_duration3_soil-compaction_grain-corn-only.out
#SBATCH --error=oneD_crop_summer-drought_magnitude0_duration3_soil-compaction_grain-corn-only_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo summer-drought --stress-test-meteo-magnitude 0 --stress-test-meteo-duration 3 --soil-compaction soil-compaction --grain-corn-only grain-corn-only

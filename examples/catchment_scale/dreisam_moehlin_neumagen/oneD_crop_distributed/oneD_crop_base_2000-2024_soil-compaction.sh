...
#SBATCH --output=oneD_crop_base_2000-2024_soil-compaction.out
#SBATCH --error=oneD_crop_base_2000-2024_soil-compaction_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo base_2000-2024 --soil-compaction soil-compaction

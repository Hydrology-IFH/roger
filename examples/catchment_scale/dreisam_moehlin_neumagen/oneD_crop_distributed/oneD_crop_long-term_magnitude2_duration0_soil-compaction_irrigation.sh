...
#SBATCH --job-name=oneD_crop_long-term_magnitude2_duration0_soil-compaction_irrigation
#SBATCH --output=oneD_crop_long-term_magnitude2_duration0_soil-compaction_irrigation.out
#SBATCH --error=oneD_crop_long-term_magnitude2_duration0_soil-compaction_irrigation_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo long-term --stress-test-meteo-magnitude 2 --stress-test-meteo-duration 0 --soil-compaction soil-compaction --irrigation irrigation

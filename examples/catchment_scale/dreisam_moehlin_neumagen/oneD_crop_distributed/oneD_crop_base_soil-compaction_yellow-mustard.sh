...
#SBATCH --job-name=oneD_crop_base_soil-compaction_yellow-mustard
#SBATCH --output=oneD_crop_base_soil-compaction_yellow-mustard.out
#SBATCH --error=oneD_crop_base_soil-compaction_yellow-mustard_err.out
#SBATCH --export=ALL

...
#SBATCH --job-name=oneD_crop_spring-drought_magnitude2_duration3_no-irrigation_soil-compaction_no-yellow-mustard
#SBATCH --output=oneD_crop_spring-drought_magnitude2_duration3_no-irrigation_soil-compaction_no-yellow-mustard.out
#SBATCH --error=oneD_crop_spring-drought_magnitude2_duration3_no-irrigation_soil-compaction_no-yellow-mustard_err.out
#SBATCH --export=ALL

...
#SBATCH --job-name=write_roger_data_base_2000-2024_yellow-mustard
#SBATCH --output=write_roger_data_base_2000-2024_yellow-mustard.out
#SBATCH --error=write_roger_data_base_2000-2024_yellow-mustard_err.out
#SBATCH --export=ALL

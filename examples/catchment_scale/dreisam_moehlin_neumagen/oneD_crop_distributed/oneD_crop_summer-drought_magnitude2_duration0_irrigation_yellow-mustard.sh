...
#SBATCH --job-name=oneD_crop_summer-drought_magnitude2_duration0_irrigation_yellow-mustard
#SBATCH --output=oneD_crop_summer-drought_magnitude2_duration0_irrigation_yellow-mustard.out
#SBATCH --error=oneD_crop_summer-drought_magnitude2_duration0_irrigation_yellow-mustard_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo summer-drought --stress-test-meteo-magnitude 2 --stress-test-meteo-duration 0 --soil-compaction no-soil-compaction --irrigation irrigation --yellow-mustard yellow-mustard

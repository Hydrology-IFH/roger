...
#SBATCH --job-name=oneD_crop_base_no-irrigation_soil-compaction_no-yellow-mustard
#SBATCH --output=oneD_crop_base_no-irrigation_soil-compaction_no-yellow-mustard.out
#SBATCH --error=oneD_crop_base_no-irrigation_soil-compaction_no-yellow-mustard_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo base  --soil-compaction  -td "${TMPDIR}"

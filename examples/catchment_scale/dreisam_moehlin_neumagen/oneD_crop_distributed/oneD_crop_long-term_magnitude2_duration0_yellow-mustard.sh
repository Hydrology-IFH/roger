...
#SBATCH --job-name=oneD_crop_long-term_magnitude2_duration0_yellow-mustard
#SBATCH --output=oneD_crop_long-term_magnitude2_duration0_yellow-mustard.out
#SBATCH --error=oneD_crop_long-term_magnitude2_duration0_yellow-mustard_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo long-term --stress-test-meteo-magnitude 2 --stress-test-meteo-duration 0 --soil-compaction no-soil-compaction --yellow-mustard yellow-mustard

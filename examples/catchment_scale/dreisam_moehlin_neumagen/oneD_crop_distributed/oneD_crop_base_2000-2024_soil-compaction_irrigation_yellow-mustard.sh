...
#SBATCH --job-name=oneD_crop_base_2000-2024_soil-compaction_irrigation_yellow-mustard
#SBATCH --output=oneD_crop_base_2000-2024_soil-compaction_irrigation_yellow-mustard.out
#SBATCH --error=oneD_crop_base_2000-2024_soil-compaction_irrigation_yellow-mustard_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo base_2000-2024 --soil-compaction soil-compaction --irrigation irrigation --yellow-mustard yellow-mustard

...
#SBATCH --job-name=oneD_crop_spring-drought_magnitude2_duration3_soil-compaction_yellow-mustard
#SBATCH --output=oneD_crop_spring-drought_magnitude2_duration3_soil-compaction_yellow-mustard.out
#SBATCH --error=oneD_crop_spring-drought_magnitude2_duration3_soil-compaction_yellow-mustard_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo spring-drought --stress-test-meteo-magnitude 2 --stress-test-meteo-duration 3 --soil-compaction soil-compaction --yellow-mustard yellow-mustard

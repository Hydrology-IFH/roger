...
#SBATCH --job-name=oneD_crop_spring-drought_magnitude2_duration3_no-irrigation_no-soil-compaction_no-yellow-mustard
#SBATCH --output=oneD_crop_spring-drought_magnitude2_duration3_no-irrigation_no-soil-compaction_no-yellow-mustard.out
#SBATCH --error=oneD_crop_spring-drought_magnitude2_duration3_no-irrigation_no-soil-compaction_no-yellow-mustard_err.out
#SBATCH --export=ALL
...
mv "${TMPDIR}"/output/ONEDCROP_*.nc /pfs/10/work/fr_rs1092-workspace/roger/examples/catchment_scale/dreisam_moehlin_neumagen/oneD_crop_distributed/output

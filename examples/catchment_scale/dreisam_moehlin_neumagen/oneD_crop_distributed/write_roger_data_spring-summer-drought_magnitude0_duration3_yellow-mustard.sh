...
#SBATCH --job-name=write_roger_data_spring-summer-drought_magnitude0_duration3_yellow-mustard
#SBATCH --output=write_roger_data_spring-summer-drought_magnitude0_duration3_yellow-mustard.out
#SBATCH --error=write_roger_data_spring-summer-drought_magnitude0_duration3_yellow-mustard_err.out
#SBATCH --export=ALL

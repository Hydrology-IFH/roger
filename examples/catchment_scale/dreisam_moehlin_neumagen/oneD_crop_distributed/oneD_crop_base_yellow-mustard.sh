...
#SBATCH --job-name=oneD_crop_base_yellow-mustard
#SBATCH --output=oneD_crop_base_yellow-mustard.out
#SBATCH --error=oneD_crop_base_yellow-mustard_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo base --soil-compaction no-soil-compaction --yellow-mustard yellow-mustard

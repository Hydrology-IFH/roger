...
#SBATCH --job-name=oneD_crop_spring-drought_magnitude0_duration3_soil-compaction_irrigation_yellow-mustard
#SBATCH --output=oneD_crop_spring-drought_magnitude0_duration3_soil-compaction_irrigation_yellow-mustard.out
#SBATCH --error=oneD_crop_spring-drought_magnitude0_duration3_soil-compaction_irrigation_yellow-mustard_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo spring-drought --stress-test-meteo-magnitude 0 --stress-test-meteo-duration 3 --soil-compaction soil-compaction --irrigation irrigation --yellow-mustard yellow-mustard

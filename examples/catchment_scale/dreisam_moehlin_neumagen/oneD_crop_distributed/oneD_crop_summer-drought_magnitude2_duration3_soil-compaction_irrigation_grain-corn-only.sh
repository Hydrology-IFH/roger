...
#SBATCH --job-name=oneD_crop_summer-drought_magnitude2_duration3_soil-compaction_irrigation_grain-corn-only
#SBATCH --output=oneD_crop_summer-drought_magnitude2_duration3_soil-compaction_irrigation_grain-corn-only.out
#SBATCH --error=oneD_crop_summer-drought_magnitude2_duration3_soil-compaction_irrigation_grain-corn-only_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo summer-drought --stress-test-meteo-magnitude 2 --stress-test-meteo-duration 3 --soil-compaction soil-compaction --irrigation irrigation --grain-corn-only grain-corn-only

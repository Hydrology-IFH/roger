...
#SBATCH --job-name=oneD_crop_base_soil-compaction_irrigation
#SBATCH --output=oneD_crop_base_soil-compaction_irrigation.out
#SBATCH --error=oneD_crop_base_soil-compaction_irrigation_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo base --soil-compaction soil-compaction --irrigation irrigation

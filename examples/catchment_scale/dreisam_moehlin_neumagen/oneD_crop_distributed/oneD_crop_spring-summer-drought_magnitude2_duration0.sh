...
#SBATCH --job-name=oneD_crop_spring-summer-drought_magnitude2_duration0
#SBATCH --output=oneD_crop_spring-summer-drought_magnitude2_duration0.out
#SBATCH --error=oneD_crop_spring-summer-drought_magnitude2_duration0_err.out
#SBATCH --export=ALL
...
python oneD_crop.py -b jax -d gpu --stress-test-meteo spring-summer-drought --stress-test-meteo-magnitude 2 --stress-test-meteo-duration 0 --soil-compaction no-soil-compaction

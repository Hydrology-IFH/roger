...
@roger_base_cli
def main(irrigation, yellow_mustard, soil_compaction, tmp_dir):
    ...
    class ONEDCROPSetup(RogerSetup):
        ...
        _ncr = 5 * 2  # number of crop rotations
        _file_crop_rotations = _base_path / "input" / "crop_rotations.nc"
        ...
        def set_settings(self, state):
            ...
            settings.identifier = f"ONEDCROP_{self._irrig}_{self._yellow_mustard}_{self._soil_compaction}"

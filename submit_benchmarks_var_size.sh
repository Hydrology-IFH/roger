...
python run_benchmarks.py --sizes 100. --sizes 1000. --sizes 10000. --backends numpy --backends jax --backends numpy-mpi --backends jax-mpi --backends jax-gpu --nproc 4 --pmem 32000 --only SVATOXYGEN18_benchmark.py --timesteps 20 --debug

# -*- coding: utf-8 -*-
#
# RoGeR documentation build configuration file, created by
...
project = u'RoGeR'
copyright = u'2018-2024, The RoGeR Team, University of Freiburg'
author = u'The RoGeR Team, University of Freiburg'
...
version = roger_version
# The full version, including alpha/beta/rc tags.
release = roger_version
...
latex_documents = [
    (master_doc, 'roger.tex', u'RoGeR Documentation',
     u'The RoGeR Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'RoGeR', u'RoGeR Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RoGeR', u'RoGeR Documentation',
     author, 'RoGeR', 'Runoff Generation Research in pure Python',
     'Miscellaneous'),
]

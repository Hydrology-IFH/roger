...
- `565`: intensive summer grass (growing only)
- `566`: intensive winter grass (growing only)
- `567`: clover
- `568`: winter phacelia
- `569`: winter green manure (Aug)
- `570`: winter green manure (Sep)
- `571`: summer grass (growing only; no fertilisation)
- `572`: winter grass (growing only; no fertilisation)
- `573`: summer grass (continued; no fertilisation)
- `574`: winter grass (continued; no fertilisation)
...
- `592`: extensive summer grass (growing only)
- `593`: extensive winter grass (growing only)
- `594`: extensive summer grass (continued)
- `595`: extensive winter grass (continued)
- `596`: intensive summer grass (continued)
- `597`: intensive winter grass (continued)
- `598`: no crop
- `599`: bare
- `6`: vineyard
- `7`: orchard

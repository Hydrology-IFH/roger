...
python run_benchmarks.py --sizes 1000. --sizes 10000. --sizes 100000. --sizes 1000000. --backends numpy --backends jax --backends numpy-mpi --backends jax-mpi --backends jax-gpu --nproc 25 --pmem 4000 --debug

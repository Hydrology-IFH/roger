...
python run_benchmarks.py --sizes 10000. --backends numpy --backends jax --backends numpy-mpi --backends jax-mpi --backends jax-gpu  --nproc 28 --pmem 4000 --only oneD_benchmark.py --debug

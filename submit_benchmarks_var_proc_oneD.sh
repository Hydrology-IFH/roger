...
python run_benchmarks.py --sizes 1000000. --backends numpy-mpi --backends jax-mpi --nproc 24 --pmem 4000 --only oneD_benchmark.py --debug
python run_benchmarks.py --sizes 1000000. --backends numpy-mpi --backends jax-mpi --nproc 96 --pmem 4000 --only oneD_benchmark.py --debug
python run_benchmarks.py --sizes 1000000. --backends numpy-mpi --backends jax-mpi --nproc 192 --pmem 4000 --only oneD_benchmark.py --debug

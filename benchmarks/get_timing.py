...
def get_timings(benchmark_type, infolder, infiles):
    ...
    for infile in infiles:
        ...
        with open(base_path / "benchmark_{}.json".format(time.time()), "w") as f:
